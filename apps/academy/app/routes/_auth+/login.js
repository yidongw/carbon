    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    if (_c) {
                        throw (0, react_router_1.redirect)(path_1.path.to.root);
                    }
                    return [2 /*return*/, {
                            hasOutlookAuth: !!auth_1.SUPABASE_AUTH_EXTERNAL_AZURE_CLIENT_ID,
                            hasGoogleAuth: !!auth_1.SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID
                        }];
            }
        });
    });
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var ip, ratelimit, success, _c, _d, validation, _e, _f, _g, email, redirectTo, user, magicLink, _h, _j, pkceHeader, _k, _l;
        var _m;
        var request = _b.request;
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    ...
                    ip = (_m = request.headers.get("x-forwarded-for")) !== null && _m !== void 0 ? _m : "127.0.0.1";
                ...
                case 2: return [2 /*return*/, _c.apply(void 0, _d.concat([_o.sent()]))];
                case 3:
                    _f = (_e = (0, form_1.validator)(auth_1.magicLinkValidator)).validate;
                ...
                case 5:
                    ...
                    _g = validation.data, email = _g.email, redirectTo = _g.redirectTo;
                    return [4 /*yield*/, (0, users_server_1.getUserByEmail)(email)];
                case 6:
                    user = _o.sent();
                    if (!(user.data && user.data.active)) return [3 /*break*/, 11];
                    return [4 /*yield*/, (0, auth_server_1.sendMagicLink)(email, redirectTo)];
                case 7:
                    magicLink = _o.sent();
                    if (!magicLink.error) return [3 /*break*/, 9];
                    _h = react_router_1.data;
                    _j = [(0, auth_1.error)(null, "Failed to send magic link")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to send magic link"))];
                case 8: return [2 /*return*/, _h.apply(void 0, _j.concat([_o.sent()]))];
                case 9: return [4 /*yield*/, (0, session_server_1.setPkceCookie)(magicLink.pkceEntry)];
                case 10:
                    pkceHeader = _o.sent();
                    return [2 /*return*/, (0, react_router_1.data)({ success: true }, { headers: [["Set-Cookie", pkceHeader]] })];
                case 11:
                    _k = react_router_1.data;
                    _l = [(0, auth_1.error)(user, "User record not found")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(user.error, "User record not found"))];
                case 12: return [2 /*return*/, _k.apply(void 0, _l.concat([_o.sent()]))];
            }
        });
    });
}
function LoginRoute() {
    var _this = this;
    var _a, _b, _c, _d, _e;
    var _f = (0, react_router_1.useLoaderData)(), hasOutlookAuth = _f.hasOutlookAuth, hasGoogleAuth = _f.hasGoogleAuth;
    ...
    return (<>
      ...
      <div className="rounded-lg md:bg-card md:border md:border-border md:shadow-lg p-8 w-[380px]">
        {((_b = fetcher.data) === null || _b === void 0 ? void 0 : _b.success) === true ? (<>
            <react_1.VStack spacing={4} className="items-center justify-center">
              <react_1.Heading size="h3">Check your email</react_1.Heading>
              <p className="text-muted-foreground tracking-tight text-sm">
                We've sent you a magic link to sign in to your account.
              </p>
            </react_1.VStack>
          </>) : (<form_1.ValidatedForm fetcher={fetcher} validator={auth_1.magicLinkValidator} defaultValues={{ redirectTo: redirectTo }} method="post">
            ...
            <react_1.VStack spacing={2}>
              {((_c = fetcher.data) === null || _c === void 0 ? void 0 : _c.success) === false && ((_d = fetcher.data) === null || _d === void 0 ? void 0 : _d.message) && (<react_1.Alert variant="destructive">
                  ...
                  <react_1.AlertTitle>Authentication Error</react_1.AlertTitle>
                  <react_1.AlertDescription>{(_e = fetcher.data) === null || _e === void 0 ? void 0 : _e.message}</react_1.AlertDescription>
                </react_1.Alert>)}
              ...
              {(hasGoogleAuth || hasOutlookAuth) && (<div className="py-3 w-full">
                  <react_1.Separator />
                </div>)}

              <form_1.Input name="email" label="" placeholder="Email Address"/>
