...
exports.meta = exports.links = exports.headers = exports.clientMiddleware = exports.middleware = void 0;
...
var styles_css_url_1 = require("sonner/dist/styles.css?url");
var NavigationProgress_1 = require("~/components/NavigationProgress");
var lingui_server_1 = require("~/services/lingui.server");
...
exports.middleware = [flash_server_1.flashMiddleware, session_server_1.cookieDomainMigrationMiddleware];
...
var headers = function (_a) {
    ...
    var merged = new Headers(loaderHeaders);
...
var links = function () {
    return [
        { href: tailwind_css_url_1.default, rel: "stylesheet" },
        { href: background_css_url_1.default, rel: "stylesheet" },
        { href: nprogress_css_url_1.default, rel: "stylesheet" },
        { href: styles_css_url_1.default, rel: "stylesheet" },
        {
            rel: "icon",
            type: "image/svg+xml",
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, AUTH_PROVIDERS, CARBON_EDITION, CARBON_API_URL, CLOUDFLARE_TURNSTILE_SITE_KEY, CONTROLLED_ENVIRONMENT, ERP_URL, GOOGLE_PLACES_API_KEY, JIRA_CLIENT_ID, MES_URL, ONSHAPE_CLIENT_ID, POSTHOG_API_HOST, POSTHOG_PROJECT_PUBLIC_KEY, QUICKBOOKS_CLIENT_ID, SUPABASE_ANON_KEY, SUPABASE_URL, DEFAULT_LANGUAGE, VERCEL_ENV, VERCEL_URL, XERO_CLIENT_ID, preferences, appLanguage, linguiCatalog;
        var _d;
        var request = _b.request, context = _b.context;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _c = (0, auth_1.getBrowserEnv)(), AUTH_PROVIDERS = _c.AUTH_PROVIDERS, CARBON_EDITION = _c.CARBON_EDITION, CARBON_API_URL = _c.CARBON_API_URL, CLOUDFLARE_TURNSTILE_SITE_KEY = _c.CLOUDFLARE_TURNSTILE_SITE_KEY, CONTROLLED_ENVIRONMENT = _c.CONTROLLED_ENVIRONMENT, ERP_URL = _c.ERP_URL, GOOGLE_PLACES_API_KEY = _c.GOOGLE_PLACES_API_KEY, JIRA_CLIENT_ID = _c.JIRA_CLIENT_ID, MES_URL = _c.MES_URL, ONSHAPE_CLIENT_ID = _c.ONSHAPE_CLIENT_ID, POSTHOG_API_HOST = _c.POSTHOG_API_HOST, POSTHOG_PROJECT_PUBLIC_KEY = _c.POSTHOG_PROJECT_PUBLIC_KEY, QUICKBOOKS_CLIENT_ID = _c.QUICKBOOKS_CLIENT_ID, SUPABASE_ANON_KEY = _c.SUPABASE_ANON_KEY, SUPABASE_URL = _c.SUPABASE_URL, DEFAULT_LANGUAGE = _c.DEFAULT_LANGUAGE, VERCEL_ENV = _c.VERCEL_ENV, VERCEL_URL = _c.VERCEL_URL, XERO_CLIENT_ID = _c.XERO_CLIENT_ID;
                    preferences = (0, utils_1.getPreferenceHeaders)(request);
                    appLanguage = (0, locale_1.resolveLanguage)(preferences.locale);
                    return [4 /*yield*/, (0, lingui_server_1.loadLinguiCatalogForRequest)(request, appLanguage)];
                case 1:
                    linguiCatalog = _e.sent();
...
function Document(_a) {
    var children = _a.children, _b = _a.title, title = _b === void 0 ? "Carbon" : _b, _c = _a.lang, lang = _c === void 0 ? "en" : _c, _d = _a.mode, mode = _d === void 0 ? "light" : _d, _e = _a.theme, theme = _e === void 0 ? "zinc" : _e;
    ...
    var themeStyle = __assign(__assign({}, (mode === "light" ? lightVars : darkVars)), { "--radius": "0.675rem" });
    return (<html lang={lang} className={"".concat(mode, " h-full overflow-x-hidden")} style={themeStyle}>
      <head>
        <exports.meta charSet="utf-8"/>
        <exports.meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"/>
        <react_router_1.Meta />
        <title>{title}</title>
...
function App() {
    ...
    var linguiCatalog = loaderData === null || loaderData === void 0 ? void 0 : loaderData.linguiCatalog;
    var appLanguage = (0, locale_1.resolveLanguage)(prefs.locale);
    ...
    (0, react_1.useMount)(function () {
        ...
        var result = loaderData === null || loaderData === void 0 ? void 0 : loaderData.result;
        if ((result === null || result === void 0 ? void 0 : result.success) === true) {
            react_1.toast.success(result.message);
        }
        else if ((result === null || result === void 0 ? void 0 : result.success) === false && (result === null || result === void 0 ? void 0 : result.message)) {
            react_1.toast.error(result.message);
        }
        if (!window.clientCache) {
            window.clientCache = new react_query_1.QueryClient({
                defaultOptions: {
                    queries: {
                        gcTime: Infinity,
    ...
    return (<react_1.OperatingSystemContextProvider platform={prefs.platform}>
      <locale_1.LocaleProvider locale={appLanguage} catalog={linguiCatalog}>
        <i18n_1.I18nProvider locale={prefs.locale}>
          <react_1.TooltipProvider delayDuration={200}>
            <Document mode={mode} theme={theme} lang={appLanguage}>
              <NavigationProgress_1.NavigationProgress />
