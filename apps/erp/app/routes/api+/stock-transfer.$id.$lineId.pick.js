...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, url, type, id, lineId, updateQuantityUrl, _c, stockTransferLine, stockTransfer, _d, _e, _f, _g, _h, _j, formData, result, data, _k, _l, _m, _o;
            ...
            switch (_y.label) {
                ...
                case 1:
                    ...
                    if (type && ["serial", "batch"].includes(type)) {
                        throw (0, react_router_1.redirect)(path_1.path.to.stockTransferScan(id, lineId));
                    }
                ...
                case 2:
                    _c = _y.sent(), stockTransferLine = _c[0], stockTransfer = _c[1];
                ...
                case 3: throw _d.apply(void 0, _e.concat([_y.sent()]));
                case 4:
                ...
                case 5: throw _f.apply(void 0, _g.concat([_y.sent()]));
                case 6:
                ...
                case 7: throw _h.apply(void 0, _j.concat([_y.sent()]));
                case 8:
                    formData = new FormData();
                    formData.append("id", lineId);
                    formData.append("quantity", (_u = (_t = (_s = stockTransferLine.data) === null || _s === void 0 ? void 0 : _s.quantity) === null || _t === void 0 ? void 0 : _t.toString()) !== null && _u !== void 0 ? _u : "1");
                    formData.append("locationId", (_w = (_v = stockTransfer.data) === null || _v === void 0 ? void 0 : _v.locationId) !== null && _w !== void 0 ? _w : "");
                ...
                case 12:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(data === null || data === void 0 ? void 0 : data.message, (_x = data === null || data === void 0 ? void 0 : data.message) !== null && _x !== void 0 ? _x : "Failed to pick line"))];
                case 13: throw _m.apply(void 0, _o.concat([_y.sent()]));
            }
        });
    });
}
