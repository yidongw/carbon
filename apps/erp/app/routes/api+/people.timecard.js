...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, intent, result, clockOutTime, note, result;
        var _d, _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    clockOutTime = formData.get("clockOut");
                    note = formData.get("note");
                    return [4 /*yield*/, (0, people_1.clockOut)(client, {
                            employeeId: userId,
                            companyId: companyId,
                            updatedBy: userId,
                            clockOut: clockOutTime !== null && clockOutTime !== void 0 ? clockOutTime : undefined,
                ...
                case 6: return [2 /*return*/, { success: false, error: "Unknown intent" }];
            }
        });
    });
}
