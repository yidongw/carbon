...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, withOperations, quote, methodTrees, methodTree, flattenedMethods, makeMethodIds, quoteOperations, operationsByMakeMethodId, bomOperationsByKey, _i, _d, _e, key, ops, batchSizesByItemId, rootQuoteNode, firstQuantity, computedCosts, bomIds, result;
        var _f, _g, _h;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 2:
                    quote = _j.sent();
                    if (quote.error) {
                        return [2 /*return*/, { data: [], error: "Failed to load quote line" }];
                    }
                    return [4 /*yield*/, (0, sales_1.getQuoteMethodTrees)(client, (_f = quote.data) === null || _f === void 0 ? void 0 : _f.quoteId)];
                case 3:
                    methodTrees = _j.sent();
                    if (methodTrees.error) {
                        return [2 /*return*/, { data: [], error: methodTrees.error }];
                    }
                ...
                case 4:
                    ...
                    firstQuantity = (_h = (_g = quote.data) === null || _g === void 0 ? void 0 : _g.quantity) === null || _h === void 0 ? void 0 : _h[0];
                    ...
                    result = flattenedMethods.map(function (node, index) {
                        var _a, _b;
                        ...
                        return __assign(__assign({}, bomItem), { operations: operations.map(function (operation) {
                                ...
                                return __assign({ description: operation.description, process: operation.processName, workCenter: operation.workCenterName, operationType: operation.operationType, setupTime: operation.setupTime, setupUnit: operation.setupUnit, laborTime: operation.laborTime, laborUnit: operation.laborUnit, machineTime: operation.machineTime, machineUnit: operation.machineUnit }, durations);
                            }) });
                    });
