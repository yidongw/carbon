...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, companyGroupId, userId, reportId, _d, report, reportError, viewClient, job, result;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    _c = _e.sent(), client = _c.client, companyId = _c.companyId, companyGroupId = _c.companyGroupId, userId = _c.userId;
                    ...
                    return [4 /*yield*/, client
                            ...
                            .single()];
                case 2:
                    _d = _e.sent(), report = _d.data, reportError = _d.error;
                ...
                case 5:
                    _e.sent();
                    return [4 /*yield*/, (0, production_1.createOutsideProcessingPoFromSupplierReport)(client, {
                            reportId: reportId,
                            companyId: companyId,
                ...
                case 6:
                    ...
                    return [2 /*return*/, __assign({}, result.data)];
            }
        });
    });
}
