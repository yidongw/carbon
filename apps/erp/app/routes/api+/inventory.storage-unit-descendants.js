        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, inventory_1.getStorageUnitDescendants)(client, id)];
                case 2:
                    result = _d.sent();
                    if (result.error) {
                    ...
                    return [2 /*return*/, {
                            data: ((_c = result.data) !== null && _c !== void 0 ? _c : []).map(function (row) { return ({ id: row.id }); }),
                            error: null
                        }];
            }
        });
