        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, production_1.listJobOperationSupplierQuantityReportLines)(client, {
                            reportId: reportId,
                            companyId: companyId,
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, reportId, _d, report, reportError, viewClient, job, body, parsed, result;
        var _e, _f;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 6:
                    body = _g.sent();
                    parsed = production_1.replaceJobOperationSupplierQuantityReportLinesValidator.safeParse(body);
                    if (!parsed.success) {
