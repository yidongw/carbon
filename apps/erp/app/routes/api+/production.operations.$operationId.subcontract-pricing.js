...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, operationId, url, supplierProcessId, _d, operation, operationError, result;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    supplierProcessId = url.searchParams.get("supplierProcessId");
                    if (!supplierProcessId) {
                        return [2 /*return*/, (0, react_router_1.data)({ error: "supplierProcessId is required" }, { status: 400 })];
                    }
                    return [4 /*yield*/, client
                            ...
                            .single()];
                case 2:
                    _d = _e.sent(), operation = _d.data, operationError = _d.error;
                    ...
                    return [4 /*yield*/, (0, production_1.getSubcontractPricingPreview)(client, {
                            companyId: companyId,
                ...
                case 3:
                    ...
                    return [2 /*return*/, { pricing: result.data }];
            }
        });
    });
}
