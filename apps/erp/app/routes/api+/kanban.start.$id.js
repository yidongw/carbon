...
function handleKanbanStart(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var kanban, operation, setupTime, laborTime, machineTime, type;
        var _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            data: path_1.path.to.external.mesJobOperationStart(operation.id, type),
                            error: null
                        }];
            }
        });
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, handleKanbanStart({ client: client, companyId: companyId, id: id })];
