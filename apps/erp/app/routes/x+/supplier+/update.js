...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, formData, ids, field, value, _d;
        var _e;
            ...
            switch (_f.label) {
                ...
                case 2:
                    ...
                    switch (_d) {
                        ...
                        case "fax": return [3 /*break*/, 5];
                        case "website": return [3 /*break*/, 5];
                        case "currencyCode": return [3 /*break*/, 5];
                        case "supplierTypeId": return [3 /*break*/, 5];
                        case "supplierStatus": return [3 /*break*/, 5];
                        case "accountManagerId": return [3 /*break*/, 5];
                        case "purchasingContactId": return [3 /*break*/, 5];
                    }
                    return [3 /*break*/, 7];
                case 3:
                ...
                case 7: return [2 /*return*/, { error: { message: "Invalid field" }, data: null }];
            }
        });
    });
}
