...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, supplierTypes;
        var _d;
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, inventory_1.getShippingTermsList)(client, companyId)
                        ])];
                case 2:
                    supplierTypes = (_e.sent())[0];
                    return [2 /*return*/, {
                            supplierTypes: (_d = supplierTypes.data) !== null && _d !== void 0 ? _d : []
