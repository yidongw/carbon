        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 2:
                    ...
                    if (!(!status || !purchasing_1.purchasingRfqStatusType.includes(status))) return [3 /*break*/, 4];
                ...
                case 4: return [4 /*yield*/, (0, purchasing_1.updatePurchasingRFQStatus)(client, {
                        id: id,
                        status: status,
                ...
                case 7:
                    ...
                    _j = [path_1.path.to.purchasingRfqDetails(id)];
