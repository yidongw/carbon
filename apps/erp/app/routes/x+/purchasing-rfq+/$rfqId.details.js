...
exports.default = PurchasingRFQDetailsRoute;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, purchasing_1.getPurchasingRFQ)(client, rfqId)];
                case 2:
                    rfq = _g.sent();
                    if (!rfq.error) return [3 /*break*/, 4];
                    _c = react_router_1.redirect;
                    _d = [path_1.path.to.purchasingRfqs];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var viewClient, _c, client, companyId, userId, id, rfq, formData, validation, _d, rfqId, d, update, _e, _f, _g, _h;
        var _j;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, purchasing_1.getPurchasingRFQ)(viewClient, id)];
                case 3:
                    rfq = _k.sent();
                    return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                            request: request,
                            isLocked: (0, purchasing_1.isRfqLocked)((_j = rfq.data) === null || _j === void 0 ? void 0 : _j.status),
                            redirectTo: path_1.path.to.purchasingRfq(id),
                ...
                case 5:
                    formData = _k.sent();
                    return [4 /*yield*/, (0, form_1.validator)(purchasing_1.purchasingRfqValidator).validate(formData)];
                case 6:
                    validation = _k.sent();
                    if (validation.error) {
                    ...
                    if (!rfqId)
                        throw new Error("Could not find rfqId");
                    return [4 /*yield*/, (0, purchasing_1.upsertPurchasingRFQ)(client, __assign(__assign({ id: id, rfqId: rfqId }, d), { companyId: companyId, customFields: (0, form_2.setCustomFields)(formData), updatedBy: userId }))];
                case 7:
                    update = _k.sent();
                    if (!update.error) return [3 /*break*/, 9];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.purchasingRfq(id)];
                ...
                case 9:
                    ...
                    _h = [path_1.path.to.purchasingRfq(id)];
...
function PurchasingRFQDetailsRoute() {
    var _a, _b, _c;
    ...
    return (<react_1.VStack spacing={2}>
      <SupplierInteractionState_1.default currentRfq={{
            id: rfqData.rfqSummary.id,
            rfqId: (_a = rfqData.rfqSummary.rfqId) !== null && _a !== void 0 ? _a : undefined,
            status: (_b = rfqData.rfqSummary.status) !== null && _b !== void 0 ? _b : undefined
        }} linkedQuotes={(_c = rfqData.linkedQuotes) !== null && _c !== void 0 ? _c : []}/>
      <SupplierInteraction_1.SupplierInteractionNotes key={"notes-".concat(rfqId)} id={rfqData.rfqSummary.id} table="purchasingRfq" title={t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Notes"], ["Notes"])))} internalNotes={internalNotes}/>
      <components_1.DeferredFiles key={"documents-".concat(rfqId)} resolve={rfqData.files}>
        {function (resolvedFiles) { return (<SupplierInteraction_1.SupplierInteractionDocuments interactionId={rfqId} attachments={resolvedFiles} id={rfqId} type="Purchasing Request for Quote"/>); }}
