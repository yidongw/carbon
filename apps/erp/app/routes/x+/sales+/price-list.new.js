...
exports.default = NewPriceOverrideRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var url, customerId, customerTypeId, initialScope;
        var _c, _d, _e, _f;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    customerId = (_c = url.searchParams.get("customerId")) !== null && _c !== void 0 ? _c : undefined;
                    customerTypeId = (_d = url.searchParams.get("customerTypeId")) !== null && _d !== void 0 ? _d : undefined;
                    initialScope = customerId
                        ? "customer"
                        : customerTypeId
                            ? "customerType"
                            : undefined;
                    return [2 /*return*/, {
                            initial: {
                                ...
                                itemId: (_e = url.searchParams.get("itemId")) !== null && _e !== void 0 ? _e : "",
                                validFrom: (_f = url.searchParams.get("validFrom")) !== null && _f !== void 0 ? _f : (0, date_1.today)((0, date_1.getLocalTimeZone)()).toString()
                            },
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, validation, breaksRaw, breaksParsed, breaksResult, breaks, _d, customerId, customerTypeId, itemId, active, applyRulesOnTop, notes, validFrom, validTo, result, _e, _f, _g, _h;
        var _j, _k;
        var request = _b.request;
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to create price override"))];
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Price override created"))];
                case 7: throw _g.apply(void 0, _h.concat([_l.sent()]));
            }
        });
    });
}
function NewPriceOverrideRoute() {
    var _a = (0, react_router_1.useLoaderData)(), initial = _a.initial, initialScope = _a.initialScope;
    var navigate = (0, react_router_1.useNavigate)();
    return (<PriceOverrideForm_1.default initialValues={{
        ...
        }} initialBreaks={[{ quantity: 1, overridePrice: 0, active: true }]} initialScope={initialScope} onClose={function () { return navigate(-1); }}/>);
}
