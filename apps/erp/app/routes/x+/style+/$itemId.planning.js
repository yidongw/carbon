...
exports.default = StylePlanningRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, locationId, userDefaults, _d, _e, locations, _f, _g, stylePlanning, _h, _j;
        var _k, _l, _m;
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 10:
                    stylePlanning = _o.sent();
                    if (!(stylePlanning.error || !stylePlanning.data)) return [3 /*break*/, 12];
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.style(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(stylePlanning.error, "Failed to load style planning"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, itemId, formData, validation, updateStylePlanning, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    updateStylePlanning = _h.sent();
                    if (!updateStylePlanning.error) return [3 /*break*/, 6];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.style(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateStylePlanning.error, "Failed to update style planning"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.stylePlanningLocation(itemId, validation.data.locationId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated style planning"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function StylePlanningRoute() {
    var _a;
    var sharedStylesData = (0, hooks_1.useRouteData)(path_1.path.to.styleRoot);
    var _b = (0, react_router_1.useLoaderData)(), stylePlanning = _b.stylePlanning, locationId = _b.locationId;
    if (!sharedStylesData)
        throw new Error("Could not load shared styles data");
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.ItemPlanningForm key={stylePlanning.itemId} initialValues={__assign(__assign({}, stylePlanning), (0, form_2.getCustomFields)(stylePlanning.customFields))} locations={(_a = sharedStylesData.locations) !== null && _a !== void 0 ? _a : []} type="Style"/>
      <ItemPlanningChart_1.ItemPlanningChart itemId={stylePlanning.itemId} locationId={locationId}/>
    </react_1.VStack>);
}
