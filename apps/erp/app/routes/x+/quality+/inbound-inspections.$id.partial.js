        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to mark partial"))];
                case 3: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 4:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.inboundInspection(id)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Lot marked partial"))];
