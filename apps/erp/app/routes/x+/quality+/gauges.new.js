...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, validation, _d, _id, d, gaugeCalibrationStatus, result, _e, _f, _g, _h;
        var request = _b.request;
                    ...
                    gaugeCalibrationStatus = d.nextCalibrationDate
                        ? (0, date_1.parseDate)(d.nextCalibrationDate) < (0, date_1.today)((0, date_1.getLocalTimeZone)())
                            ...
                            : d.lastCalibrationDate
                                ...
                                : "Pending"
                        : "Pending";
                    return [4 /*yield*/, (0, quality_1.insertGauge)(client, __assign(__assign({}, d), { gaugeId: d.gaugeId || undefined, gaugeCalibrationStatus: gaugeCalibrationStatus, companyId: companyId, createdBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 4:
                    result = _j.sent();
                    if (!(result.error || !result.data)) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.gauges];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to insert gauge"))];
                case 5: throw _e.apply(void 0, _f.concat([_j.sent()]));
                case 6:
                    _g = react_router_1.redirect;
                    _h = ["".concat(path_1.path.to.gauges, "?").concat((0, path_1.getParams)(request))];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Gauge ".concat(result.data.gaugeId, " created")))];
                case 7: throw _g.apply(void 0, _h.concat([_j.sent()]));
            }
        });
    });
}
function GaugeNewRoute() {
    var _a, _b;
    ...
    var initialValues = {
        ...
        gaugeTypeId: "",
        gaugeCalibrationStatus: "Pending",
        gaugeStatus: "Active",
        gaugeRole: "Standard",
        lastCalibrationDate: "",
        nextCalibrationDate: "",
    ...
    return (<GaugeForm_1.default initialValues={initialValues} gaugeTypes={(_b = routeData === null || routeData === void 0 ? void 0 : routeData.gaugeTypes) !== null && _b !== void 0 ? _b : []} onClose={function () { return navigate(-1); }}/>);
}
