...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, companyId, userId, id, result, _d, _e, _f, _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to accept lot"))];
                case 3: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 4:
                    _f = react_router_1.redirect;
                    _g = ["".concat(path_1.path.to.inboundInspections, "?").concat((0, path_1.getParams)(request))];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Lot accepted"))];
