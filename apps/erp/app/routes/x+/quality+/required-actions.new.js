...
exports.default = NewRequiredActionRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, validation, _d, name, active, createResult, _e, _f, _g, _h;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 4:
                    ...
                    if (!createResult.error) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.requiredActions];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(createResult.error, "Failed to create required action"))];
                case 5: return [2 /*return*/, _e.apply(void 0, _f.concat([_j.sent()]))];
                case 6:
                    _g = react_router_1.redirect;
                    _h = [path_1.path.to.requiredActions];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Required action created successfully"))];
                case 7: return [2 /*return*/, _g.apply(void 0, _h.concat([_j.sent()]))];
            }
        });
    });
}
function NewRequiredActionRoute() {
    var navigate = (0, react_router_1.useNavigate)();
    var onClose = function () { return navigate(path_1.path.to.requiredActions); };
    return (<RequiredActions_1.RequiredActionForm type="modal" initialValues={{
            name: "",
            active: true
        }} onClose={onClose}/>);
}
