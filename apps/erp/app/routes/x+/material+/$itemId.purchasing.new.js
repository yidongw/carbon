...
exports.default = NewMaterialSupplierRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, formData, validation, _d, id, d, createMaterialSupplier, newSupplierPartId, priceBreaksRaw, priceBreaks;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    createMaterialSupplier = _f.sent();
                    ...
                    newSupplierPartId = (_e = createMaterialSupplier.data) === null || _e === void 0 ? void 0 : _e.id;
                ...
                case 5:
                    _f.sent();
                    _f.label = 6;
                case 6: return [2 /*return*/, { success: true, message: "Material supplier created" }];
            }
        });
    });
}
function NewMaterialSupplierRoute() {
    var _a, _b;
    var itemId = (0, react_router_1.useParams)().itemId;
    if (!itemId)
        throw new Error("itemId not found");
    var routeData = (0, react_1.useRouteData)(path_1.path.to.material(itemId));
    var initialValues = {
        itemId: itemId,
        supplierId: "",
        supplierMaterialId: "",
    ...
    var onClose = function () { return navigate(path_1.path.to.materialPurchasing(itemId)); };
    return (<Item_1.SupplierPartForm type="Material" initialValues={initialValues} unitOfMeasureCode={(_b = (_a = routeData === null || routeData === void 0 ? void 0 : routeData.materialSummary) === null || _a === void 0 ? void 0 : _a.unitOfMeasureCode) !== null && _b !== void 0 ? _b : ""} onClose={onClose}/>);
}
