...
exports.default = EditMaterialSupplierRoute;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 6:
                    ...
                    _f = [path_1.path.to.materialPurchasing(itemId)];
...
function EditMaterialSupplierRoute() {
    ...
    return (<Item_1.SupplierPartForm type="Material" initialValues={initialValues} unitOfMeasureCode={(_h = (_g = routeData === null || routeData === void 0 ? void 0 : routeData.materialSummary) === null || _g === void 0 ? void 0 : _g.unitOfMeasureCode) !== null && _h !== void 0 ? _h : ""} priceBreaks={priceBreaks} purchasingHistory={purchasingHistory} onClose={onClose}/>);
}
