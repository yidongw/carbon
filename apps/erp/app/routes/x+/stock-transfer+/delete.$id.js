...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, id, viewClient, transfer, mutation, _c, _d, _e, _f;
        var _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    _h.sent();
                    return [4 /*yield*/, (0, inventory_1.deleteStockTransfer)(client, id)];
                case 5:
                    mutation = _h.sent();
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(mutation.error, "Failed to delete stock transfer"))];
                case 6: return [2 /*return*/, _c.apply(void 0, _d.concat([_h.sent()]))];
                case 7:
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.stockTransfers];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Successfully deleted stock transfer"))];
