...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, id, lineId, viewClient, transfer, mutation, _c, _d, _e, _f;
        var _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    ...
                    if (!lineId)
                        throw new Error("lineId is not found");
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                            request: request,
                            isLocked: (0, inventory_1.isStockTransferLocked)((_g = transfer.data) === null || _g === void 0 ? void 0 : _g.status),
                            redirectTo: path_1.path.to.stockTransfer(id),
                            message: "Cannot modify a locked stock transfer. Reopen it first."
                        })];
                case 4:
                    _h.sent();
                    return [4 /*yield*/, (0, inventory_1.deleteStockTransferLine)(client, lineId)];
                case 5:
                    mutation = _h.sent();
                    if (!mutation.error) return [3 /*break*/, 7];
                    _c = react_router_1.data;
                    _d = [{
                            success: false
                        }];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(mutation.error, "Failed to delete line"))];
                case 6: return [2 /*return*/, _c.apply(void 0, _d.concat([_h.sent()]))];
                case 7:
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.stockTransfer(id)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Successfully deleted line"))];
