...
exports.default = ViewDocumentRoute;
var auth_1 = require("@carbon/auth");
var auth_server_1 = require("@carbon/auth/auth.server");
var session_server_1 = require("@carbon/auth/session.server");
var react_router_1 = require("react-router");
var documents_1 = require("~/modules/documents");
var DocumentView_1 = require("~/modules/documents/ui/Documents/DocumentView");
...
function ViewDocumentRoute() {
    var document = (0, react_router_1.useLoaderData)().document;
    var name = document.name;
    if (name)
        name = name.split(".").slice(0, -1).join(".");
    return (<DocumentView_1.default key={document.id} bucket={"private"} document={document}/>);
}
