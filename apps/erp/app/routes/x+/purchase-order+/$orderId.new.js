...
exports.default = NewPurchaseOrderLineRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var orderId, viewClient, purchaseOrder, _c, _d, _e, client, companyId, userId, formData, validation, _f, id, d, createPurchaseOrderLine, _g, _h;
        var _j;
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 4: return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                        request: request,
                        isLocked: (0, purchasing_1.isPurchaseOrderLocked)((_j = purchaseOrder.data) === null || _j === void 0 ? void 0 : _j.status),
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, purchasing_1.upsertPurchaseOrderLine)(client, __assign(__assign({}, d), { companyId: companyId, createdBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 9:
                    createPurchaseOrderLine = _k.sent();
                    if (!createPurchaseOrderLine.error) return [3 /*break*/, 11];
                    _g = react_router_1.redirect;
                    _h = [path_1.path.to.purchaseOrderDetails(orderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(createPurchaseOrderLine.error, "Failed to create purchase order line."))];
                case 10: throw _g.apply(void 0, _h.concat([_k.sent()]));
                case 11: throw (0, react_router_1.redirect)(path_1.path.to.purchaseOrderDetails(orderId));
            }
        });
    });
}
function NewPurchaseOrderLineRoute() {
    ...
    return <PurchaseOrder_1.PurchaseOrderLineForm initialValues={initialValues}/>;
}
