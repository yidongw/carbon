...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, orderId, viewClient, purchaseOrder, _d, _e, formData, currencyCode, currency, update, _f, _g;
        var _h;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 1:
                    _c = _j.sent(), client = _c.client, companyGroupId = _c.companyGroupId;
                ...
                case 3:
                    purchaseOrder = _j.sent();
                    if (!purchaseOrder.error) return [3 /*break*/, 5];
                ...
                case 5: return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                        request: request,
                        isLocked: (0, purchasing_1.isPurchaseOrderLocked)((_h = purchaseOrder.data) === null || _h === void 0 ? void 0 : _h.status),
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, purchasing_1.updatePurchaseOrderExchangeRate)(client, {
                            id: orderId,
