...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var orderId, viewClient, purchaseOrder, _c, _d, _e, client, userId, formData, validation, updatePurchaseOrderDelivery, _f, _g, _h, _j;
        var _k;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 7:
                    formData = _l.sent();
                    return [4 /*yield*/, (0, form_1.validator)(purchasing_1.purchaseOrderDeliveryValidator).validate(formData)];
                case 8:
                    validation = _l.sent();
                    if (validation.error) {
                        return [2 /*return*/, (0, form_1.validationError)(validation.error)];
                    }
                    return [4 /*yield*/, (0, purchasing_1.upsertPurchaseOrderDelivery)(client, __assign(__assign({}, validation.data), { id: orderId, updatedBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 9:
                    updatePurchaseOrderDelivery = _l.sent();
                    if (!updatePurchaseOrderDelivery.error) return [3 /*break*/, 11];
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.purchaseOrderDetails(orderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updatePurchaseOrderDelivery.error, "Failed to update purchase order delivery"))];
                case 10: throw _f.apply(void 0, _g.concat([_l.sent()]));
                case 11:
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.purchaseOrderDetails(orderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated purchase order delivery"))];
