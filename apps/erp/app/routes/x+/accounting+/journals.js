...
exports.default = JournalEntriesRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, url, searchParams, search, status, _d, limit, offset, sorts, filters, entries;
        var _e, _f;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, accounting_1.getJournalEntries)(client, companyId, {
                            search: search,
                            status: status,
                            limit: limit,
                            offset: offset,
                ...
                case 2:
                    entries = _g.sent();
                    return [2 /*return*/, {
                            data: (_e = entries.data) !== null && _e !== void 0 ? _e : [],
                            count: (_f = entries.count) !== null && _f !== void 0 ? _f : 0
                        }];
            }
        });
    });
...
function NewJournalEntry() {
    ...
    return (<fetcher.Form method="post" action="new">
...
function JournalEntriesRoute() {
    ...
    return (<react_1.VStack spacing={0} className="h-full">
      <JournalEntries_1.JournalEntriesTable data={data} count={count} primaryAction={permissions.can("create", "accounting") && <NewJournalEntry />}/>
