...
exports.default = MasterWorkOrderLayoutRoute;
var auth_server_1 = require("@carbon/auth/auth.server");
var macro_1 = require("@lingui/core/macro");
var react_router_1 = require("react-router");
var Layout_1 = require("~/components/Layout");
var production_1 = require("~/modules/production");
var MasterWorkOrderHeader_1 = require("~/modules/production/ui/MasterWorkOrders/MasterWorkOrderHeader");
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, masterWorkOrderId, masterWorkOrder, jobId, _d, cuttingOperationId, job, tags;
        var _e, _f, _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    masterWorkOrder = _h.sent();
                    if (masterWorkOrder.error || !masterWorkOrder.data) {
                        throw (0, react_router_1.redirect)(path_1.path.to.masterWorkOrders);
                    }
                    jobId = (_e = masterWorkOrder.data.jobId) !== null && _e !== void 0 ? _e : "";
                    return [4 /*yield*/, Promise.all([
                            jobId ? (0, production_1.getMasterCuttingOperationId)(client, jobId, companyId) : null,
                            jobId ? (0, production_1.getJob)(client, jobId) : null,
                            (0, shared_1.getTagsList)(client, companyId, "job")
                        ])];
                case 3:
                    _d = _h.sent(), cuttingOperationId = _d[0], job = _d[1], tags = _d[2];
                    return [2 /*return*/, {
...
function MasterWorkOrderLayoutRoute() {
    var _a = (0, react_router_1.useLoaderData)(), jobId = _a.jobId, job = _a.job, tags = _a.tags, trackedEntities = _a.trackedEntities;
    return (<Layout_1.PanelProvider>
      <div className="flex flex-col h-[calc(100dvh-49px)] overflow-hidden w-full">
        <MasterWorkOrderHeader_1.default />
        <div className="flex h-[calc(100dvh-99px)] overflow-hidden w-full">
          <div className="flex flex-1 min-h-0 h-full overflow-hidden">
            <Layout_1.ResizablePanels content={<react_router_1.Outlet />} properties={job ? (<Jobs_1.JobProperties jobId={jobId} validItemTypes={["Part", "Tool", "Style"]} readOnlyItem routeData={{
