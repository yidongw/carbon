...
exports.default = EditConsumableSupplierRoute;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 6:
                    ...
                    _f = [path_1.path.to.consumablePurchasing(itemId)];
...
function EditConsumableSupplierRoute() {
    ...
    return (<Item_1.SupplierPartForm type="Consumable" initialValues={initialValues} unitOfMeasureCode={(_h = (_g = routeData === null || routeData === void 0 ? void 0 : routeData.consumableSummary) === null || _g === void 0 ? void 0 : _g.unitOfMeasureCode) !== null && _h !== void 0 ? _h : ""} priceBreaks={priceBreaks} purchasingHistory={purchasingHistory} onClose={onClose}/>);
}
