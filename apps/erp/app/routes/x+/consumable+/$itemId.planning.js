...
exports.default = ConsumablePlanningRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, consumablePlanning, _h, _j;
        var _k, _l, _m, _o;
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 10:
                    consumablePlanning = _p.sent();
                    if (!(consumablePlanning.error || !consumablePlanning.data)) return [3 /*break*/, 12];
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.consumable(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(consumablePlanning.error, "Failed to load consumable planning"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, itemId, formData, validation, updateConsumablePlanning, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    updateConsumablePlanning = _h.sent();
                    if (!updateConsumablePlanning.error) return [3 /*break*/, 6];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.consumable(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateConsumablePlanning.error, "Failed to update consumable planning"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.consumablePlanningLocation(itemId, validation.data.locationId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated consumable planning"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function ConsumablePlanningRoute() {
    var _a, _b;
    var sharedConsumablesData = (0, hooks_1.useRouteData)(path_1.path.to.consumableRoot);
    var _c = (0, react_router_1.useLoaderData)(), consumablePlanning = _c.consumablePlanning, locationId = _c.locationId;
    ...
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.ItemPlanningForm key={consumablePlanning.itemId} initialValues={__assign(__assign({}, consumablePlanning), (0, form_2.getCustomFields)(consumablePlanning.customFields))} locations={(_a = sharedConsumablesData.locations) !== null && _a !== void 0 ? _a : []} type="Consumable"/>
      <ItemPlanningChart_1.ItemPlanningChart itemId={consumablePlanning.itemId} locationId={locationId} safetyStock={consumablePlanning.reorderingPolicy === "Demand-Based Reorder"
            ? ((_b = consumablePlanning.demandAccumulationSafetyStock) !== null && _b !== void 0 ? _b : 0)
            : undefined}/>
    </react_1.VStack>);
}
