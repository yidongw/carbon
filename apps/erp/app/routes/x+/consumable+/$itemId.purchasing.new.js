...
exports.default = NewConsumableSupplierRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, formData, validation, _d, id, d, createConsumableSupplier, newSupplierPartId, priceBreaksRaw, priceBreaks;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    createConsumableSupplier = _f.sent();
                    ...
                    newSupplierPartId = (_e = createConsumableSupplier.data) === null || _e === void 0 ? void 0 : _e.id;
                ...
                case 5:
                    _f.sent();
                    _f.label = 6;
                case 6: return [2 /*return*/, { success: true, message: "Consumable supplier created" }];
            }
        });
    });
}
function NewConsumableSupplierRoute() {
    var _a, _b;
    var itemId = (0, react_router_1.useParams)().itemId;
    if (!itemId)
        throw new Error("itemId not found");
    var routeData = (0, react_1.useRouteData)(path_1.path.to.consumable(itemId));
    var navigate = (0, react_router_1.useNavigate)();
    var onClose = function () { return navigate(path_1.path.to.consumablePurchasing(itemId)); };
    var initialValues = {
        itemId: itemId,
        supplierId: "",
    ...
    return (<Item_1.SupplierPartForm type="Consumable" initialValues={initialValues} unitOfMeasureCode={(_b = (_a = routeData === null || routeData === void 0 ? void 0 : routeData.consumableSummary) === null || _a === void 0 ? void 0 : _a.unitOfMeasureCode) !== null && _b !== void 0 ? _b : ""} onClose={onClose}/>);
}
