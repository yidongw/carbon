...
exports.default = ConsumableCostingRoute;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(itemCost.error, "Failed to load consumable costing"))];
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateItemCost.error, "Failed to update consumable costing"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.consumableCosting(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated consumable costing"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function ConsumableCostingRoute() {
    var _a, _b;
