...
exports.default = ConsumableInventoryRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, consumableInventory, insertPickMethod, _h, _j, _k, _l, quantities, _m, _o, itemStorageUnitQuantities, _p, _q, trackedEntityIds, _r, shelfLife, bomHasShelfLifeManagedInput, trackedEntityExpirations, rulesData;
        var _s, _t, _u, _v;
        ...
        return __generator(this, function (_w) {
            switch (_w.label) {
                ...
                case 2:
                    ...
                    _e = [path_1.path.to.consumable(itemId)];
                ...
                case 10:
                    consumableInventory = (_w.sent())[0];
                    if (!(consumableInventory.error || !consumableInventory.data)) return [3 /*break*/, 16];
                ...
                case 11:
                    ...
                    _j = [path_1.path.to.consumable(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(insertPickMethod.error, "Failed to insert consumable inventory"))];
                ...
                case 14:
                    consumableInventory = _w.sent();
                    if (!(consumableInventory.error || !consumableInventory.data)) return [3 /*break*/, 16];
                    _k = react_router_1.redirect;
                    _l = [path_1.path.to.consumable(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(consumableInventory.error, "Failed to load consumable inventory"))];
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(quantities, "Failed to load consumable quantities"))];
                ...
                case 20:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(itemStorageUnitQuantities, "Failed to load consumable quantities"))];
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 6:
                    ...
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.consumable(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(err_1, "Failed to update consumable inventory"))];
                case 7: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 8:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.consumableInventoryLocation(itemId, pickMethodFields.locationId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated consumable inventory"))];
                case 9: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function ConsumableInventoryRoute() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    var sharedConsumablesData = (0, hooks_1.useRouteData)(path_1.path.to.consumableRoot);
    var _k = (0, react_router_1.useLoaderData)(), consumableInventory = _k.consumableInventory, itemStorageUnitQuantities = _k.itemStorageUnitQuantities, quantities = _k.quantities, shelfLife = _k.shelfLife, bomHasShelfLifeManagedInput = _k.bomHasShelfLifeManagedInput, trackedEntityExpirations = _k.trackedEntityExpirations, itemId = _k.itemId, ruleAssignments = _k.ruleAssignments, ruleLibrary = _k.ruleLibrary;
    var consumableData = (0, hooks_1.useRouteData)(path_1.path.to.consumable(itemId));
    if (!consumableData)
        throw new Error("Could not find consumable data");
    var itemUnitOfMeasureCode = (_a = consumableData === null || consumableData === void 0 ? void 0 : consumableData.consumableSummary) === null || _a === void 0 ? void 0 : _a.unitOfMeasureCode;
    var initialValues = __assign(__assign(__assign({}, consumableInventory), { defaultStorageUnitId: (_b = consumableInventory.defaultStorageUnitId) !== null && _b !== void 0 ? _b : undefined, shelfLifeMode: shelfLife === null || shelfLife === void 0 ? void 0 : shelfLife.mode, shelfLifeDays: (_c = shelfLife === null || shelfLife === void 0 ? void 0 : shelfLife.days) !== null && _c !== void 0 ? _c : undefined, shelfLifeTriggerProcessId: (_d = shelfLife === null || shelfLife === void 0 ? void 0 : shelfLife.triggerProcessId) !== null && _d !== void 0 ? _d : undefined, shelfLifeTriggerTiming: (_e = shelfLife === null || shelfLife === void 0 ? void 0 : shelfLife.triggerTiming) !== null && _e !== void 0 ? _e : undefined, shelfLifeCalculateFromBom: (_f = shelfLife === null || shelfLife === void 0 ? void 0 : shelfLife.calculateFromBom) !== null && _f !== void 0 ? _f : false }), (0, form_2.getCustomFields)((_g = consumableInventory.customFields) !== null && _g !== void 0 ? _g : {}));
    var storageUnits = (0, StorageUnit_1.useStorageUnits)(consumableInventory === null || consumableInventory === void 0 ? void 0 : consumableInventory.locationId);
    ...
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.PickMethodForm key={"".concat(initialValues.itemId, "-").concat(itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory")} initialValues={initialValues} locations={(_j = sharedConsumablesData === null || sharedConsumablesData === void 0 ? void 0 : sharedConsumablesData.locations) !== null && _j !== void 0 ? _j : []} storageUnits={storageUnits.options} type="Part" itemTrackingType={itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory"} replenishmentSystem={replenishmentSystem} bomHasShelfLifeManagedInput={bomHasShelfLifeManagedInput}/>
