...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, quoteId, viewClient, quote, formData, currencyCode, currency, update, _d, _e;
        var _f, _g;
            ...
            switch (_h.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                            request: request,
                            isLocked: (0, sales_1.isQuoteLocked)((_f = quote.data) === null || _f === void 0 ? void 0 : _f.status),
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, sales_1.updateQuoteExchangeRate)(client, {
                            id: quoteId,
                ...
                case 7:
                    ...
                    _e = [(_g = (0, path_1.requestReferrer)(request)) !== null && _g !== void 0 ? _g : path_1.path.to.quoteDetails(quoteId)];
