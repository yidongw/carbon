        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, sales_1.insertQuote)(client, __assign(__assign({}, data), { quoteId: data.quoteId || undefined, companyId: companyId, companyGroupId: companyGroupId, createdBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 4:
                    result = _g.sent();
                    if (!(result.error || !result.data)) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.quotes];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to insert quote"))];
                case 5: throw _e.apply(void 0, _f.concat([_g.sent()]));
                case 6: throw (0, react_router_1.redirect)(path_1.path.to.quote(result.data.id));
            }
        });
    });
}
function QuoteNewRoute() {
    var _a;
    ...
    return (<div className="max-w-4xl w-full p-2 sm:p-0 mx-auto mt-0 md:mt-8">
      <Quotes_1.QuoteForm initialValues={initialValues}/>
    </div>);
}
