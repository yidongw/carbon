...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, quoteId, viewClient, quote, formData, validation, updateQuoteShipment, _d, _e, _f, _g;
        var _h;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 5:
                    formData = _j.sent();
                    return [4 /*yield*/, (0, form_1.validator)(sales_1.quoteShipmentValidator).validate(formData)];
                case 6:
                    validation = _j.sent();
                    if (validation.error) {
                        return [2 /*return*/, (0, form_1.validationError)(validation.error)];
                    }
                    return [4 /*yield*/, (0, sales_1.upsertQuoteShipment)(client, __assign(__assign({}, validation.data), { id: quoteId, updatedBy: userId }))];
                case 7:
                    updateQuoteShipment = _j.sent();
                    if (!updateQuoteShipment.error) return [3 /*break*/, 9];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.quoteDetails(quoteId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateQuoteShipment.error, "Failed to update quote shipment"))];
                case 8: throw _d.apply(void 0, _e.concat([_j.sent()]));
                case 9:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.quoteDetails(quoteId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated quote shipment"))];
