...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, companyId, userId, formData, type, serviceRole, validation, _d, quoteId, quoteLineId, itemId, lineMethod, validation, makeMethod;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    _d = validation.data.sourceId.split(":"), quoteId = _d[0], quoteLineId = _d[1];
                    itemId = validation.data.targetId;
                    return [4 /*yield*/, (0, sales_1.upsertMakeMethodFromQuoteLine)(serviceRole, {
                            quoteId: quoteId,
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, sales_1.upsertMakeMethodFromQuoteMethod)(serviceRole, __assign(__assign({}, validation.data), { companyId: companyId, userId: userId, parts: {
                                billOfMaterial: validation.data.billOfMaterial,
                                billOfProcess: validation.data.billOfProcess,
                                parameters: validation.data.parameters,
                                tools: validation.data.tools,
