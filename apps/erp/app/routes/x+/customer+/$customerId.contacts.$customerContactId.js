...
exports.default = EditCustomerContactRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, customerId, customerContactId, contact, _c, _d;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    customerId = params.customerId, customerContactId = params.customerContactId;
                    if (!customerId)
                        throw (0, auth_1.notFound)("customerId not found");
                    if (!customerContactId)
                        throw (0, auth_1.notFound)("customerContactId not found");
                    return [4 /*yield*/, (0, sales_1.getCustomerContact)(client, customerContactId)];
                case 2:
                    contact = _e.sent();
                    if (!contact.error) return [3 /*break*/, 4];
                    _c = react_router_1.redirect;
                    _d = [path_1.path.to.customerContacts(customerId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(contact.error, "Failed to get customer contact"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, customerId, customerContactId, formData, validation, _c, id, contactId, customerLocationId, contact, update, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
            ...
            switch (_h.label) {
                ...
                case 3:
                    ...
                    if (id !== customerContactId)
                        throw (0, auth_1.badRequest)("customerContactId does not match id from form data");
                    if (contactId === undefined)
                        throw (0, auth_1.badRequest)("contactId is undefined from form data");
                    return [4 /*yield*/, (0, sales_1.updateCustomerContact)(client, {
                            contactId: contactId,
                            contact: contact,
                ...
                case 4:
                    ...
                    _e = [path_1.path.to.customerContacts(customerId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(update.error, "Failed to update customer contact"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.customerContacts(customerId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Customer contact updated"))];
...
function EditCustomerContactRoute() {
