...
exports.default = CustomersNewRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, modal, validation, _d, id, rest, createCustomer, _e, _f, _g, _h, _j, customerId;
        var _k;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, sales_1.upsertCustomer)(client, __assign(__assign({}, rest), { companyId: companyId, customFields: (0, form_2.setCustomFields)(formData), createdBy: userId }))];
                case 4:
                    createCustomer = _l.sent();
                    if (!createCustomer.error) return [3 /*break*/, 9];
                    if (!modal) return [3 /*break*/, 6];
                    _f = react_router_1.data;
                    _g = [createCustomer];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(createCustomer.error, "Failed to insert customer"))];
                case 5:
                    _e = _f.apply(void 0, _g.concat([_l.sent()]));
                    return [3 /*break*/, 8];
                case 6:
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.customers];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(createCustomer.error, "Failed to insert customer"))];
                case 7:
                ...
                case 9:
                    customerId = (_k = createCustomer.data) === null || _k === void 0 ? void 0 : _k.id;
                    return [2 /*return*/, modal ? createCustomer : (0, react_router_1.redirect)(path_1.path.to.customer(customerId))];
            }
        });
    });
}
function CustomersNewRoute() {
    var _a;
    ...
    return (<div className="max-w-4xl w-full p-2 sm:p-0 mx-auto mt-0 md:mt-8">
      <Customer_1.CustomerForm initialValues={initialValues}/>
    </div>);
}
