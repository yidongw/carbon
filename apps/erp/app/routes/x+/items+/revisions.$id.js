...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, id, formData, validation, result;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, items_service_1.updateRevision)(client, {
                            id: id,
                ...
                case 4:
                    ...
                    return [2 /*return*/, {
                            success: true,
                            link: "/x/items/".concat(id) // Redirect back to the item
                        }];
            }
        });
    });
