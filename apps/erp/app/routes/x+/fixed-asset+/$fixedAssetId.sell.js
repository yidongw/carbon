...
exports.default = SellFixedAssetRoute;
...
var sellAssetValidator = zod_1.z.object({
    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 4:
                    if (!!["Active", "Fully Depreciated"].includes(asset.data.status)) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.fixedAsset(fixedAssetId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Only active assets can be sold"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, companyGroupId, userId, fixedAssetId, formData, validation, customerId, _d, asset, defaults, _e, _f, locationId, newSO, _g, _h, salesOrderId, nbv, _j, _k;
        var _l, _m, _o, _p;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_q) {
            switch (_q.label) {
                ...
                case 1:
                    _c = _q.sent(), client = _c.client, companyId = _c.companyId, companyGroupId = _c.companyGroupId, userId = _c.userId;
                    fixedAssetId = params.fixedAssetId;
                    if (!fixedAssetId)
                        throw (0, auth_1.notFound)("fixedAssetId not found");
                ...
                case 2:
                    formData = _q.sent();
                    return [4 /*yield*/, (0, form_1.validator)(sellAssetValidator).validate(formData)];
                case 3:
                    validation = _q.sent();
                    if (validation.error) {
                ...
                case 4:
                    _d = _q.sent(), asset = _d[0], defaults = _d[1];
                    if (!(asset.error || !asset.data)) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.fixedAssets];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(asset.error, "Failed to get fixed asset"))];
                case 5: throw _e.apply(void 0, _f.concat([_q.sent()]));
                case 6:
                    ...
                    return [4 /*yield*/, (0, sales_1.insertSalesOrder)(client, {
                            customerId: customerId,
                            locationId: locationId !== null && locationId !== void 0 ? locationId : "",
                            status: "Draft",
                            companyId: companyId,
                ...
                case 7:
                    newSO = _q.sent();
                    if (!(newSO.error || !newSO.data)) return [3 /*break*/, 9];
                    _g = react_router_1.redirect;
                    _h = [path_1.path.to.fixedAsset(fixedAssetId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(newSO.error, "Failed to create sales order"))];
                ...
                case 9:
                    ...
                    return [4 /*yield*/, client.from("salesOrderLine").insert({
                            ...
                            saleQuantity: 1,
                            unitPrice: nbv,
                            locationId: (_p = asset.data.locationId) !== null && _p !== void 0 ? _p : "",
                            taxPercent: 0,
                            exchangeRate: 1,
                            companyId: companyId,
                            createdBy: userId
                ...
                case 10:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Sales order created"))];
                case 11: throw _j.apply(void 0, _k.concat([_q.sent()]));
            }
        });
    });
}
function SellFixedAssetRoute() {
    ...
    return (<react_1.Modal open onOpenChange={function (open) {
      ...
      <react_1.ModalContent>
        <form_1.ValidatedForm validator={sellAssetValidator} method="post">
          <react_1.ModalHeader>
            <react_1.ModalTitle>Sell Asset</react_1.ModalTitle>
          </react_1.ModalHeader>
          <react_1.ModalBody>
            <react_1.VStack spacing={4}>
              <Form_1.Customer name="customerId" label="Customer"/>
            </react_1.VStack>
          </react_1.ModalBody>
          <react_1.ModalFooter>
            <react_1.HStack>
              <Form_1.Submit isDisabled={!permissions.can("create", "sales")}>
                Create Sales Order
              </Form_1.Submit>
