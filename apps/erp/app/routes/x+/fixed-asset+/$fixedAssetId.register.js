...
exports.default = RegisterFixedAssetRoute;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Only Draft assets can be registered"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, fixedAssetId, formData, validation, result, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    formData = _h.sent();
                    return [4 /*yield*/, (0, form_1.validator)(accounting_1.fixedAssetRegisterValidator).validate(formData)];
                case 3:
                    validation = _h.sent();
                    if (validation.error) {
                    ...
                    return [4 /*yield*/, client
                            .from("fixedAsset")
                            .update(__assign(__assign({}, validation.data), { status: "Active", updatedBy: userId }))
                            .eq("id", fixedAssetId)
                            .eq("status", "Draft")];
                case 4:
                    result = _h.sent();
                    ...
                    _e = [path_1.path.to.fixedAsset(fixedAssetId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to register asset"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.fixedAsset(fixedAssetId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Asset registered successfully"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function RegisterFixedAssetRoute() {
    var navigate = (0, react_router_1.useNavigate)();
    return <FixedAssets_1.FixedAssetRegisterForm onClose={function () { return navigate(-1); }}/>;
}
