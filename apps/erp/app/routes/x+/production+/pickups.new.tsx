...
export async function action({ request }: ActionFunctionArgs) {
  ...
  if (insert.error) {
    return data(
      ...
      await flash(
        request,
        error(insert.error, "Failed to create process pickup")
      )
    );
  }
...
export default function NewPickupRoute() {
  ...
  return (
    <PickupForm
      initialValues={{
        jobId: loaderData.jobId ?? undefined,
        jobOperationId: loaderData.jobOperationId,
        actorKind: loaderData.defaultActorKind,
        employeeId:
          loaderData.seededActor?.actorKind === "employee"
            ? loaderData.seededActor.employeeId
            : undefined,
        supplierProcessId:
          loaderData.seededActor?.actorKind === "supplier"
      ...
      supplierId={loaderData.supplierId ?? undefined}
    />
  );
}
