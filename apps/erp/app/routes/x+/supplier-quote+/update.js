...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, userId, formData, ids, field, value, quotes, lockedError, _d, currencyCode, supplier, currency;
        var _e;
        var _f, _g;
            ...
            switch (_h.label) {
                ...
                case 3:
                    ...
                    lockedError = (0, lockedGuard_server_1.requireUnlockedBulk)({
                        ...
                        checkFn: purchasing_1.isSupplierQuoteLocked,
                    ...
                    _d = field;
                    switch (_d) {
                        case "supplierId": return [3 /*break*/, 4];
                        case "currencyCode": return [3 /*break*/, 9];
                        case "supplierContactId": return [3 /*break*/, 12];
                        case "supplierLocationId": return [3 /*break*/, 12];
                        case "supplierReference": return [3 /*break*/, 12];
                        case "quotedDate": return [3 /*break*/, 12];
                        case "expirationDate": return [3 /*break*/, 14];
                    }
                    return [3 /*break*/, 16];
                case 4:
                    currencyCode = void 0;
                ...
                case 5:
                    supplier = _h.sent();
                    if (!((_g = supplier.data) === null || _g === void 0 ? void 0 : _g.currencyCode)) return [3 /*break*/, 7];
                ...
                case 14: return [4 /*yield*/, client
                        .from("supplierQuote")
                        .update({
                        status: value
                            ? (0, date_1.today)((0, date_1.getLocalTimeZone)()).toString() > value
                                ? "Expired"
                                : "Active"
                            : "Active",
                ...
                case 16: return [2 /*return*/, { error: { message: "Invalid field" }, data: null }];
            }
        });
    });
}
