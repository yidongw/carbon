            ...
            switch (_g.label) {
                ...
                case 2:
                    ...
                    switch (_d) {
                        ...
                        case "departmentId": return [3 /*break*/, 5];
                        case "locationId": return [3 /*break*/, 5];
                        case "requiredAbilityId": return [3 /*break*/, 5];
                        case "defaultStandardFactor": return [3 /*break*/, 5];
                        case "laborRate": return [3 /*break*/, 7];
                        case "machineRate": return [3 /*break*/, 7];
                        case "overheadRate": return [3 /*break*/, 7];
                        case "active": return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 3:
                    if (!value) {
                        return [2 /*return*/, { error: { message: "Name is required" }, data: null }];
                    }
                    return [4 /*yield*/, run({ name: value })];
                case 4: return [2 /*return*/, _g.sent()];
                case 5: return [4 /*yield*/, run((_e = {}, _e[field] = value ? value : null, _e))];
                case 6: return [2 /*return*/, _g.sent()];
                case 7: return [4 /*yield*/, run((_f = {}, _f[field] = value ? Number(value) : 0, _f))];
                case 8: return [2 /*return*/, _g.sent()];
                case 9: return [4 /*yield*/, run({ active: value === "on" || value === "true" })];
