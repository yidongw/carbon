...
exports.default = EmployeesUpdateRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, ids, field, value, _d;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    _d = field;
                    switch (_d) {
                        case "firstName": return [3 /*break*/, 3];
                        case "lastName": return [3 /*break*/, 3];
                        case "employeeTypeId": return [3 /*break*/, 5];
                        case "locationId": return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 3:
                    if (!value) {
                    ...
                    return [4 /*yield*/, client
                            .from("user")
                            .update((_e = {}, _e[field] = value, _e))
                            .in("id", ids)];
                case 4: return [2 /*return*/, _f.sent()];
                case 5:
                    if (!value) {
                        return [2 /*return*/, { error: { message: "Employee type is required" }, data: null }];
                    }
                    return [4 /*yield*/, client
                            .from("employee")
