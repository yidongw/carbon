...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, validation, _d, _e, url, searchParams, supplierRedirect, _f, id, supplier, result, _g, _h, location, ip, _j, company, user, invitee, _k, _l, _m, _o, _p;
        var _q;
        ...
        return __generator(this, function (_z) {
            switch (_z.label) {
                ...
                case 1:
                    ...
                    _e = (_d = (0, form_1.validator)(users_1.createSupplierAccountValidator)).validate;
                ...
                case 3:
                    ...
                    supplierRedirect = searchParams.get("supplier");
                    _f = validation.data, id = _f.id, supplier = _f.supplier;
                    return [4 /*yield*/, (0, users_server_1.createSupplierAccount)(client, {
                            id: id,
                            supplierId: supplier,
                            companyId: companyId,
                            createdBy: userId
                ...
                case 4:
                    ...
                    _h = [path_1.path.to.supplierAccounts];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result, (_r = result.message) !== null && _r !== void 0 ? _r : "Failed to create supplier account"))];
                ...
                case 9:
                    _z.sent();
                    if (!supplierRedirect) return [3 /*break*/, 11];
                    _l = react_router_1.redirect;
                    _m = [path_1.path.to.supplierContacts(supplierRedirect)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Supplier invited"))];
                case 10: throw _l.apply(void 0, _m.concat([_z.sent()]));
                case 11:
                    _o = react_router_1.redirect;
                    _p = [path_1.path.to.supplierAccounts];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Supplier invited"))];
...
function default_1() {
    return <users_1.CreateSupplierModal />;
}
