...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, userId, formData, ids, field, value, salesInvoices, dateFields, lockedError, _d, currencyCode, customer, currency, paymentTerms, currency;
        var _e, _f;
        var _g, _h, _j, _k, _l;
            ...
            switch (_m.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, client
                            ...
                            .in("id", ids)];
                case 3:
                    salesInvoices = _m.sent();
                    dateFields = ["dateIssued", "dateDue", "datePaid"];
                    if (!dateFields.includes(field)) {
                        lockedError = (0, lockedGuard_server_1.requireUnlockedBulk)({
                            statuses: ((_g = salesInvoices.data) !== null && _g !== void 0 ? _g : []).map(function (si) { return si.status; }),
                            checkFn: invoicing_1.isSalesInvoiceLocked,
                    ...
                    _d = field;
                    switch (_d) {
                        case "invoiceCustomerId": return [3 /*break*/, 4];
                        case "dateIssued": return [3 /*break*/, 10];
                        case "currencyCode": return [3 /*break*/, 16];
                        case "customerId": return [3 /*break*/, 19];
                        case "invoiceCustomerContactId": return [3 /*break*/, 19];
                        case "invoiceCustomerLocationId": return [3 /*break*/, 19];
                        case "locationId": return [3 /*break*/, 19];
                        case "customerReference": return [3 /*break*/, 19];
                ...
                case 5:
                    customer = _m.sent();
                    if (!((_h = customer.data) === null || _h === void 0 ? void 0 : _h.currencyCode)) return [3 /*break*/, 8];
                ...
                case 6:
                    ...
                    return [4 /*yield*/, client
                            .from("salesInvoice")
                            .update({
                            invoiceCustomerId: value !== null && value !== void 0 ? value : undefined,
                            ...
                            exchangeRate: (_k = (_j = currency.data) === null || _j === void 0 ? void 0 : _j.exchangeRate) !== null && _k !== void 0 ? _k : 1,
                            updatedBy: userId,
                ...
                case 17:
                    ...
                    return [4 /*yield*/, client
                            ...
                            .update({
                            currencyCode: value,
                            exchangeRate: (_l = currency.data.exchangeRate) !== null && _l !== void 0 ? _l : 1,
                            updatedBy: userId,
                            updatedAt: new Date().toISOString()
                        })
                            .in("id", ids)];
                ...
                case 19: return [4 /*yield*/, client
                        ...
                        _f))
                        .in("id", ids)];
                case 20: return [2 /*return*/, _m.sent()];
