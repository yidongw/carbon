...
exports.default = EditPartSupplierRoute;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 6:
                    ...
                    _f = [path_1.path.to.partPurchasing(itemId)];
...
function EditPartSupplierRoute() {
    ...
    return (<Item_1.SupplierPartForm type="Part" initialValues={initialValues} unitOfMeasureCode={(_h = (_g = routeData === null || routeData === void 0 ? void 0 : routeData.partSummary) === null || _g === void 0 ? void 0 : _g.unitOfMeasureCode) !== null && _h !== void 0 ? _h : ""} priceBreaks={priceBreaks} purchasingHistory={purchasingHistory} onClose={onClose}/>);
}
