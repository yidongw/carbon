...
exports.default = PartInventoryRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, partInventory, insertPickMethod, _h, _j, _k, _l, _m, quantities, itemStorageUnitQuantities, shelfLife, bomHasShelfLifeManagedInput, rulesData, _o, _p, _q, _r, trackedEntityIds, trackedEntityExpirations;
        var _s, _t, _u, _v;
        ...
        return __generator(this, function (_w) {
            switch (_w.label) {
                ...
                case 10:
                    partInventory = (_w.sent())[0];
                    if (!(partInventory.error || !partInventory.data)) return [3 /*break*/, 16];
                ...
                case 14:
                    partInventory = _w.sent();
                    if (!(partInventory.error || !partInventory.data)) return [3 /*break*/, 16];
                    _k = react_router_1.redirect;
                    _l = [path_1.path.to.part(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(partInventory.error, "Failed to load part inventory"))];
                ...
                case 17:
                    _m = _w.sent(), quantities = _m[0], itemStorageUnitQuantities = _m[1], shelfLife = _m[2], bomHasShelfLifeManagedInput = _m[3], rulesData = _m[4];
                ...
                case 18: throw _o.apply(void 0, _p.concat([_w.sent()]));
                case 19:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(itemStorageUnitQuantities, "Failed to load part quantities"))];
                case 20: throw _q.apply(void 0, _r.concat([_w.sent()]));
                case 21:
                ...
                case 22:
                    trackedEntityExpirations = _w.sent();
                    return [2 /*return*/, {
...
function PartInventoryRoute() {
    ...
    var storageUnits = (0, StorageUnit_1.useStorageUnits)(partInventory === null || partInventory === void 0 ? void 0 : partInventory.locationId);
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.PickMethodForm key={"".concat(initialValues.itemId, "-").concat(itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory")} initialValues={initialValues} locations={(_j = sharedPartsData === null || sharedPartsData === void 0 ? void 0 : sharedPartsData.locations) !== null && _j !== void 0 ? _j : []} storageUnits={storageUnits.options} type="Part" itemTrackingType={itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory"} replenishmentSystem={replenishmentSystem} bomHasShelfLifeManagedInput={bomHasShelfLifeManagedInput}/>
