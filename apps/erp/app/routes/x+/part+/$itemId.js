...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, itemId, _d, partSummary, supplierParts, pickMethods, tags, _e, _f, url, requestedMethodId, methodTree;
        var _this = this;
        var _g, _h, _j, _k;
            ...
            switch (_l.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            (0, items_1.getPart)(client, itemId, companyId),
                ...
                case 2:
                    _d = _l.sent(), partSummary = _d[0], supplierParts = _d[1], pickMethods = _d[2], tags = _d[3];
                    if (((_g = partSummary.data) === null || _g === void 0 ? void 0 : _g.companyId) !== companyId) {
                        throw (0, react_router_1.redirect)(path_1.path.to.items);
                    }
                    if (!partSummary.error) return [3 /*break*/, 4];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.items];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(partSummary.error, "Failed to load part summary"))];
                case 3: throw _e.apply(void 0, _f.concat([_l.sent()]));
                case 4:
                    url = new URL(request.url);
                    requestedMethodId = url.searchParams.get("methodId");
                    methodTree = (0, items_1.getMakeMethods)(client, itemId, companyId).then(function (makeMethods) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_j.label) {
                                case 0:
                                    makeMethod = requestedMethodId
                                        ? ((_d = (_b = (_a = makeMethods.data) === null || _a === void 0 ? void 0 : _a.find(function (m) { return m.id === requestedMethodId; })) !== null && _b !== void 0 ? _b : (_c = makeMethods.data) === null || _c === void 0 ? void 0 : _c.find(function (m) { return m.status === "Active"; })) !== null && _d !== void 0 ? _d : (_e = makeMethods.data) === null || _e === void 0 ? void 0 : _e[0])
                                        : ((_g = (_f = makeMethods.data) === null || _f === void 0 ? void 0 : _f.find(function (m) { return m.status === "Active"; })) !== null && _g !== void 0 ? _g : (_h = makeMethods.data) === null || _h === void 0 ? void 0 : _h[0]);
                                    if (!makeMethod)
                    ...
                    return [2 /*return*/, {
                            ...
                            supplierParts: (_h = supplierParts.data) !== null && _h !== void 0 ? _h : [],
                            pickMethods: (_j = pickMethods.data) !== null && _j !== void 0 ? _j : [],
...
function PartRoute() {
    ...
    if (!itemId)
        throw new Error("Could not find itemId");
    var partData = (0, react_1.useRouteData)(path_1.path.to.part(itemId));
    if (!partData)
        throw new Error("Could not find part data");
    var _b = (0, react_router_1.useLoaderData)(), usedIn = _b.usedIn, methodTree = _b.methodTree;
    var isManufactured = ((_a = partData.partSummary) === null || _a === void 0 ? void 0 : _a.replenishmentSystem) !== "Buy";
    var _c = (0, react_2.useState)(""), filterText = _c[0], setFilterText = _c[1];
    return (<Layout_1.PanelProvider key={itemId}>
            ...
            <Layout_1.ResizablePanels explorer={<div className="flex flex-col h-full">
                  {isManufactured ? (<react_1.Tabs defaultValue="manufacturing" className="flex flex-col h-full">
                    ...
                    return resolved ? (<div className="w-full p-2">
                                    <Item_1.BoMExplorer itemType="Part" makeMethod={resolved.makeMethod} 
                    // @ts-ignore
                    methods={resolved.methods} methodId={resolved.makeMethod.id} filterText={filterText} hideSearch/>
                                  </div>) : null;
                }}
                            </react_router_1.Await>
                          </react_2.Suspense>
                    ...
                    return (<UsedIn_1.UsedInTree tree={tree} revisions={(_a = partData.partSummary) === null || _a === void 0 ? void 0 : _a.revisions} itemReadableId={(_c = (_b = partData.partSummary) === null || _b === void 0 ? void 0 : _b.readableId) !== null && _c !== void 0 ? _c : ""} itemReadableIdWithRevision={(_e = (_d = partData.partSummary) === null || _d === void 0 ? void 0 : _d.readableIdWithRevision) !== null && _e !== void 0 ? _e : ""} filterText={filterText} hideSearch/>);
                }}
                            </react_router_1.Await>
                          </react_2.Suspense>
                        </react_1.TabsContent>
                ...
                </div>} properties={<Parts_1.PartProperties key={itemId}/>}/>
          </div>
        </div>
      </div>
