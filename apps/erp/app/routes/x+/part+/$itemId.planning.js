...
exports.default = PartPlanningRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, partPlanning, _h, _j;
        var _k, _l, _m, _o;
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 10:
                    partPlanning = _p.sent();
                    if (!(partPlanning.error || !partPlanning.data)) return [3 /*break*/, 12];
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.part(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(partPlanning.error, "Failed to load part planning"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, itemId, formData, validation, updatePartPlanning, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    updatePartPlanning = _h.sent();
                    if (!updatePartPlanning.error) return [3 /*break*/, 6];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.part(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updatePartPlanning.error, "Failed to update part planning"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.partPlanningLocation(itemId, validation.data.locationId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated part planning"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function PartPlanningRoute() {
    var _a, _b;
    var sharedPartsData = (0, hooks_1.useRouteData)(path_1.path.to.partRoot);
    var _c = (0, react_router_1.useLoaderData)(), partPlanning = _c.partPlanning, locationId = _c.locationId;
    if (!sharedPartsData)
        throw new Error("Could not load shared parts data");
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.ItemPlanningForm key={partPlanning.itemId} initialValues={__assign(__assign({}, partPlanning), (0, form_2.getCustomFields)(partPlanning.customFields))} locations={(_a = sharedPartsData.locations) !== null && _a !== void 0 ? _a : []} type="Part"/>
      <ItemPlanningChart_1.ItemPlanningChart itemId={partPlanning.itemId} locationId={locationId} safetyStock={partPlanning.reorderingPolicy === "Demand-Based Reorder"
            ? ((_b = partPlanning.demandAccumulationSafetyStock) !== null && _b !== void 0 ? _b : 0)
            : undefined}/>
    </react_1.VStack>);
}
