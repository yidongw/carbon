...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var rfqId, viewClient, rfq, _c, client, companyId, userId, formData, validation, _d, id, d, insertLine, _e, _f, lineId, _g, _h;
        var _j, _k;
            ...
            switch (_l.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                            ...
                            redirectTo: path_1.path.to.salesRfq(rfqId),
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, sales_1.upsertSalesRFQLine)(client, __assign(__assign({}, d), { companyId: companyId, createdBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 7:
                    insertLine = _l.sent();
                    if (!insertLine.error) return [3 /*break*/, 9];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.salesRfq(rfqId)];
                ...
                case 9:
                    ...
                    _h = [path_1.path.to.salesRfq(rfqId)];
                ...
                case 11: throw (0, react_router_1.redirect)(path_1.path.to.salesRfqLine(rfqId, lineId));
            }
        });
    });
}
