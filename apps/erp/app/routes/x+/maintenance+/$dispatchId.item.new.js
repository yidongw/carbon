...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, dispatchId, viewClient, dispatch, formData, validation, _d, itemId, quantity, unitOfMeasureCode, unitCost, result;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 6:
                    ...
                    _d = validation.data, itemId = _d.itemId, quantity = _d.quantity, unitOfMeasureCode = _d.unitOfMeasureCode, unitCost = _d.unitCost;
                    return [4 /*yield*/, (0, resources_1.upsertMaintenanceDispatchItem)(client, {
