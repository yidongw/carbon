...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, userId, companyId, dispatchId, itemId, viewClient, dispatch, serviceRole, result, _d, _e, _f, _g;
        var _h, _j, _k;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 1:
                    ...
                    dispatchId = params.dispatchId, itemId = params.itemId;
                    if (!dispatchId)
                ...
                case 6:
                    ...
                    _e = [(_j = (0, path_1.requestReferrer)(request)) !== null && _j !== void 0 ? _j : path_1.path.to.maintenanceDispatch(dispatchId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to remove item"))];
                case 7: throw _d.apply(void 0, _e.concat([_l.sent()]));
                case 8:
                    _f = react_router_1.redirect;
                    _g = [(_k = (0, path_1.requestReferrer)(request)) !== null && _k !== void 0 ? _k : path_1.path.to.maintenanceDispatch(dispatchId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Item removed and returned to inventory"))];
