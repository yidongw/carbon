...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, invoiceId, viewClient, purchaseInvoice, _d, _e, formData, currencyCode, currency, update, _f, _g;
        var _h, _j;
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 3:
                    ...
                    if (!purchaseInvoice.error) return [3 /*break*/, 5];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.purchaseInvoiceDetails(invoiceId)];
                ...
                case 5: return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                        request: request,
                        isLocked: (0, invoicing_1.isPurchaseInvoiceLocked)((_h = purchaseInvoice.data) === null || _h === void 0 ? void 0 : _h.status),
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, invoicing_1.updatePurchaseInvoiceExchangeRate)(client, {
                            id: invoiceId,
                ...
                case 9:
                    ...
                    _g = [(_j = (0, path_1.requestReferrer)(request)) !== null && _j !== void 0 ? _j : path_1.path.to.purchaseInvoiceDetails(invoiceId)];
