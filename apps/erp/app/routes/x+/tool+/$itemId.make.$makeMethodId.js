...
exports.default = ToolMakeMethodPage;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, itemId, makeMethodId, _d, makeMethod, methodMaterials, methodOperations, tags, _e, _f, _g, _h, _j, _k;
        var _l, _m, _o, _p, _q;
        ...
        return __generator(this, function (_r) {
            switch (_r.label) {
                ...
                case 2:
                    _d = _r.sent(), makeMethod = _d[0], methodMaterials = _d[1], methodOperations = _d[2], tags = _d[3];
                    if (!makeMethod.error) return [3 /*break*/, 4];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.toolDetails(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(makeMethod.error, "Failed to load make method"))];
                case 3: throw _e.apply(void 0, _f.concat([_r.sent()]));
                case 4:
                    if (!methodOperations.error) return [3 /*break*/, 6];
                    _g = react_router_1.redirect;
                    _h = [path_1.path.to.toolDetails(itemId)];
                ...
                case 6:
                    ...
                    _k = [path_1.path.to.toolDetails(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(methodMaterials.error, "Failed to load method materials"))];
                case 7: throw _j.apply(void 0, _k.concat([_r.sent()]));
                case 8: return [2 /*return*/, {
                        makeMethod: makeMethod.data,
                        methodMaterials: (_m = (_l = methodMaterials.data) === null || _l === void 0 ? void 0 : _l.map(function (m) {
                            var _a, _b, _c;
                        ...
                        methodOperations: (_p = (_o = methodOperations.data) === null || _o === void 0 ? void 0 : _o.map(function (operation) {
                        ...
                        makeMethods: (0, items_1.getMakeMethods)(client, makeMethod.data.itemId, companyId),
                        tags: (_q = tags.data) !== null && _q !== void 0 ? _q : []
                    }];
            }
        });
    });
}
function ToolMakeMethodPage() {
    var _a;
    var t = (0, macro_1.useLingui)().t;
    var loaderData = (0, react_router_1.useLoaderData)();
    var permissions = (0, usePermissions_1.usePermissions)();
    var makeMethod = loaderData.makeMethod, makeMethods = loaderData.makeMethods, methodMaterials = loaderData.methodMaterials, methodOperations = loaderData.methodOperations, tags = loaderData.tags;
      ...
      <react_2.Suspense fallback={<react_1.Menubar />}>
        <react_router_1.Await resolve={makeMethods}>
          {function (makeMethods) {
            var _a;
            return (<Item_1.MakeMethodTools itemId={makeMethod.itemId} makeMethods={(_a = makeMethods.data) !== null && _a !== void 0 ? _a : []} type="Tool" currentMethodId={makeMethod.id}/>);
        }}
    ...
    materials={methodMaterials} operations={methodOperations} replenishmentSystem={(_a = toolData === null || toolData === void 0 ? void 0 : toolData.toolSummary) === null || _a === void 0 ? void 0 : _a.replenishmentSystem}/>
    ...
    // @ts-expect-error
    operations={methodOperations} tags={tags}/>
