...
exports.default = NewToolSupplierRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, formData, validation, _d, id, d, createToolSupplier, newSupplierPartId, priceBreaksRaw, priceBreaks;
        var _e;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    newSupplierPartId = (_e = createToolSupplier.data) === null || _e === void 0 ? void 0 : _e.id;
                ...
                case 5:
                    _f.sent();
                    _f.label = 6;
                case 6: return [2 /*return*/, { success: true, message: "Tool supplier created" }];
            }
        });
    });
}
function NewToolSupplierRoute() {
    var _a, _b;
    ...
    return (<Item_1.SupplierPartForm type="Tool" initialValues={initialValues} unitOfMeasureCode={(_b = (_a = routeData === null || routeData === void 0 ? void 0 : routeData.toolSummary) === null || _a === void 0 ? void 0 : _a.unitOfMeasureCode) !== null && _b !== void 0 ? _b : ""} onClose={onClose}/>);
}
