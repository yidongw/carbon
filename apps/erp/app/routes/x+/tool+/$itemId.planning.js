...
exports.default = ToolPlanningRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, toolPlanning, _h, _j;
        var _k, _l, _m, _o;
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 10:
                    toolPlanning = _p.sent();
                    if (!(toolPlanning.error || !toolPlanning.data)) return [3 /*break*/, 12];
                    _h = react_router_1.redirect;
                    _j = [path_1.path.to.tool(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(toolPlanning.error, "Failed to load tool planning"))];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, itemId, formData, validation, updateToolPlanning, _d, _e, _f, _g;
        var request = _b.request, params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    updateToolPlanning = _h.sent();
                    if (!updateToolPlanning.error) return [3 /*break*/, 6];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.tool(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateToolPlanning.error, "Failed to update tool planning"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.toolPlanningLocation(itemId, validation.data.locationId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated tool planning"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function ToolPlanningRoute() {
    var _a;
    var sharedToolsData = (0, hooks_1.useRouteData)(path_1.path.to.toolRoot);
    var _b = (0, react_router_1.useLoaderData)(), toolPlanning = _b.toolPlanning, locationId = _b.locationId;
    if (!sharedToolsData)
        throw new Error("Could not load shared tools data");
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.ItemPlanningForm key={toolPlanning.itemId} initialValues={__assign(__assign({}, toolPlanning), (0, form_2.getCustomFields)(toolPlanning.customFields))} locations={(_a = sharedToolsData.locations) !== null && _a !== void 0 ? _a : []} type="Tool"/>
      <ItemPlanningChart_1.ItemPlanningChart itemId={toolPlanning.itemId} locationId={locationId}/>
    </react_1.VStack>);
}
