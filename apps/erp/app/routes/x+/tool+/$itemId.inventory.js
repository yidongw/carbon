...
exports.default = ToolInventoryRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, itemId, url, searchParams, locationId, userDefaults, _d, _e, locations, _f, _g, toolInventory, insertPickMethod, _h, _j, _k, _l, quantities, _m, _o, itemStorageUnitQuantities, _p, _q, trackedEntityIds, _r, shelfLife, bomHasShelfLifeManagedInput, trackedEntityExpirations, rulesData;
        var _s, _t, _u, _v;
        ...
        return __generator(this, function (_w) {
            switch (_w.label) {
                ...
                case 10:
                    toolInventory = (_w.sent())[0];
                    if (!(toolInventory.error || !toolInventory.data)) return [3 /*break*/, 16];
                ...
                case 11:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(insertPickMethod.error, "Failed to insert tool inventory"))];
                ...
                case 14:
                    toolInventory = _w.sent();
                    if (!(toolInventory.error || !toolInventory.data)) return [3 /*break*/, 16];
                    _k = react_router_1.redirect;
                    _l = [path_1.path.to.tool(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(toolInventory.error, "Failed to load tool inventory"))];
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(quantities, "Failed to load tool quantities"))];
                ...
                case 20:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(itemStorageUnitQuantities, "Failed to load tool quantities"))];
...
function ToolInventoryRoute() {
    ...
    var storageUnits = (0, StorageUnit_1.useStorageUnits)(toolInventory === null || toolInventory === void 0 ? void 0 : toolInventory.locationId);
    return (<react_1.VStack spacing={2} className="p-2">
      <Item_1.PickMethodForm key={"".concat(initialValues.itemId, "-").concat(itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory")} initialValues={initialValues} locations={(_j = sharedToolsData === null || sharedToolsData === void 0 ? void 0 : sharedToolsData.locations) !== null && _j !== void 0 ? _j : []} storageUnits={storageUnits.options} type="Part" itemTrackingType={itemTrackingType !== null && itemTrackingType !== void 0 ? itemTrackingType : "Inventory"} replenishmentSystem={replenishmentSystem} bomHasShelfLifeManagedInput={bomHasShelfLifeManagedInput}/>
