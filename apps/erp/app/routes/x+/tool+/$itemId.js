...
exports.handle = {
    breadcrumb: (0, macro_1.msg)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Tools"], ["Tools"]))),
    to: path_1.path.to.tools,
    module: "items"
};
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, itemId, _d, toolSummary, supplierParts, pickMethods, tags, _e, _f, url, requestedMethodId, methodTree;
        var _this = this;
        var _g, _h, _j;
            ...
            switch (_k.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            (0, items_1.getTool)(client, itemId, companyId),
                            (0, items_1.getSupplierParts)(client, itemId, companyId),
                            (0, items_1.getPickMethods)(client, itemId, companyId),
                            (0, shared_1.getTagsList)(client, companyId, "tool")
                        ])];
                case 2:
                    _d = _k.sent(), toolSummary = _d[0], supplierParts = _d[1], pickMethods = _d[2], tags = _d[3];
                    if (!toolSummary.error) return [3 /*break*/, 4];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.items];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(toolSummary.error, "Failed to load tool summary"))];
...
function ToolRoute() {
    ...
    if (!itemId)
        throw new Error("Could not find itemId");
    var toolData = (0, react_1.useRouteData)(path_1.path.to.tool(itemId));
    if (!toolData)
        throw new Error("Could not find tool data");
    var _b = (0, react_router_1.useLoaderData)(), usedIn = _b.usedIn, methodTree = _b.methodTree;
    var isManufactured = ((_a = toolData.toolSummary) === null || _a === void 0 ? void 0 : _a.replenishmentSystem) !== "Buy";
            ...
            <Layout_1.ResizablePanels explorer={<div className="flex flex-col h-full">
                  {isManufactured ? (<react_1.Tabs defaultValue="manufacturing" className="flex flex-col h-full">
                    ...
                    return resolved ? (<div className="w-full p-2">
                                    <Item_1.BoMExplorer itemType="Tool" makeMethod={resolved.makeMethod} 
                    // @ts-ignore
                    ...
                    return (<UsedIn_1.UsedInTree tree={tree} revisions={(_a = toolData.toolSummary) === null || _a === void 0 ? void 0 : _a.revisions} itemReadableId={(_c = (_b = toolData.toolSummary) === null || _b === void 0 ? void 0 : _b.readableId) !== null && _c !== void 0 ? _c : ""} itemReadableIdWithRevision={(_e = (_d = toolData.toolSummary) === null || _d === void 0 ? void 0 : _d.readableIdWithRevision) !== null && _e !== void 0 ? _e : ""} jobMaterialUsage={jobMaterialUsage} filterText={filterText} hideSearch/>);
                }}
                            </react_router_1.Await>
                          </react_2.Suspense>
                        </react_1.TabsContent>
                ...
                </div>} properties={<Tools_1.ToolProperties key={itemId}/>}/>
          </div>
        </div>
      </div>
