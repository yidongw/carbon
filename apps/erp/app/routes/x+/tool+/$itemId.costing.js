...
exports.default = ToolCostingRoute;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(itemCost.error, "Failed to load tool costing"))];
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateItemCost.error, "Failed to update tool costing"))];
                case 5: throw _d.apply(void 0, _e.concat([_h.sent()]));
                case 6:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.toolCosting(itemId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated tool costing"))];
                case 7: throw _f.apply(void 0, _g.concat([_h.sent()]));
            }
        });
    });
}
function ToolCostingRoute() {
    var _a, _b;
