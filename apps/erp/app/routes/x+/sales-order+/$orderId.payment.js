...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var orderId, viewClient, salesOrder, _c, client, userId, formData, validation, updateSalesOrderPayment, _d, _e, _f, _g;
        var _h;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 5:
                    formData = _j.sent();
                    return [4 /*yield*/, (0, form_1.validator)(sales_1.salesOrderPaymentValidator).validate(formData)];
                case 6:
                    validation = _j.sent();
                    if (validation.error) {
                        return [2 /*return*/, (0, form_1.validationError)(validation.error)];
                    }
                    return [4 /*yield*/, (0, sales_1.upsertSalesOrderPayment)(client, __assign(__assign({}, validation.data), { id: orderId, updatedBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 7:
                    updateSalesOrderPayment = _j.sent();
                    if (!updateSalesOrderPayment.error) return [3 /*break*/, 9];
                    _d = react_router_1.redirect;
                    _e = [path_1.path.to.salesOrderDetails(orderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(updateSalesOrderPayment.error, "Failed to update sales order payment"))];
                case 8: throw _d.apply(void 0, _e.concat([_j.sent()]));
                case 9:
                    _f = react_router_1.redirect;
                    _g = [path_1.path.to.salesOrderDetails(orderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Updated sales order payment"))];
