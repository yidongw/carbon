...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, userId, formData, ids, field, value, salesOrders, lockedError, _d, currencyCode, customer, currency, currency;
        var _e, _f, _g;
        var _h, _j, _k, _l;
            ...
            switch (_m.label) {
                ...
                case 3:
                    ...
                    lockedError = (0, lockedGuard_server_1.requireUnlockedBulk)({
                        statuses: ((_h = salesOrders.data) !== null && _h !== void 0 ? _h : []).map(function (o) { return o.status; }),
                        checkFn: sales_1.isSalesOrderLocked,
                    ...
                    switch (_d) {
                        ...
                        case "currencyCode": return [3 /*break*/, 10];
                        case "customerContactId": return [3 /*break*/, 13];
                        case "customerEngineeringContactId": return [3 /*break*/, 13];
                        case "customerLocationId": return [3 /*break*/, 13];
                        case "customerReference": return [3 /*break*/, 13];
                        case "exchangeRate": return [3 /*break*/, 13];
                        case "expirationDate": return [3 /*break*/, 13];
                        case "locationId": return [3 /*break*/, 13];
                        case "orderDate": return [3 /*break*/, 13];
                        case "salesPersonId": return [3 /*break*/, 13];
                        case "shippingMethodId": return [3 /*break*/, 15];
                        case "receiptPromisedDate": return [3 /*break*/, 15];
                        case "receiptRequestedDate": return [3 /*break*/, 15];
                        case "paymentTermId": return [3 /*break*/, 17];
                    }
                    return [3 /*break*/, 19];
                case 4:
                    currencyCode = void 0;
                ...
                case 5:
                    customer = _m.sent();
                    if (!((_j = customer.data) === null || _j === void 0 ? void 0 : _j.currencyCode)) return [3 /*break*/, 8];
                ...
                case 6:
                    ...
                    return [4 /*yield*/, client
                            ...
                            exchangeRate: (_l = (_k = currency.data) === null || _k === void 0 ? void 0 : _k.exchangeRate) !== null && _l !== void 0 ? _l : 1,
                            updatedBy: userId,
                            updatedAt: new Date().toISOString()
                        })
                            .in("id", ids)];
                case 7: return [2 /*return*/, _m.sent()];
                ...
                case 11:
                    currency = _m.sent();
                    if (!currency.data) return [3 /*break*/, 13];
                    return [4 /*yield*/, client
                            .from("salesOrder")
                            .update({
                            currencyCode: value,
                ...
                case 13: return [4 /*yield*/, client
                        ...
                        _e))
                        .in("id", ids)];
                case 14: return [2 /*return*/, _m.sent()];
                case 15: return [4 /*yield*/, client
                        ...
                        _f))
                        .in("id", ids)];
                case 16: return [2 /*return*/, _m.sent()];
                case 17: return [4 /*yield*/, client
                        .from("salesOrderPayment")
                        .update((_g = {},
                        _g[field] = value ? value : null,
                        _g.updatedBy = userId,
                        _g.updatedAt = new Date().toISOString(),
                        _g))
                        .in("id", ids)];
                case 18: return [2 /*return*/, _m.sent()];
                case 19: return [2 /*return*/, { error: { message: "Invalid field" }, data: null }];
            }
        });
    });
}
