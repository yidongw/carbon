...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyGroupId, orderId, salesOrder, formData, currencyCode, currency, update, _d, _e;
        var _f;
            ...
            switch (_g.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, lockedGuard_server_1.requireUnlocked)({
                            request: request,
                            isLocked: (0, sales_1.isSalesOrderLocked)((_f = salesOrder.data) === null || _f === void 0 ? void 0 : _f.status),
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, sales_1.updateSalesOrderExchangeRate)(client, {
                            id: orderId,
                ...
                case 7: return [2 /*return*/, _d.apply(void 0, _e.concat([_g.sent()]))];
            }
        });
    });
}
