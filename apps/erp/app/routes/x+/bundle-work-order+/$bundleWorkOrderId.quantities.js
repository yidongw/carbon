...
exports.default = BundleWorkOrderQuantitiesRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, bundleWorkOrderId, bundleWorkOrder, jobId, url, searchParams, search, _d, limit, offset, sorts, filters, operations, _e, _f, operationIds, listQueryArgs, _g, employeeQuantities, supplierQuantities, scrapReasons, _h, _j, _k, _l, merged;
        ...
        return __generator(this, function (_x) {
            switch (_x.label) {
                ...
                case 2:
                    bundleWorkOrder = _x.sent();
                    if (bundleWorkOrder.error || !((_m = bundleWorkOrder.data) === null || _m === void 0 ? void 0 : _m.jobId)) {
                ...
                case 3:
                    operations = _x.sent();
                    if (!operations.error) return [3 /*break*/, 5];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.bundleWorkOrderProcesses(bundleWorkOrderId)];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(operations.error, "Failed to fetch job operations"))];
                case 4: throw _e.apply(void 0, _f.concat([_x.sent()]));
                case 5:
                ...
                case 6:
                    ...
                    if (!employeeQuantities.error) return [3 /*break*/, 8];
                ...
                case 7: throw _h.apply(void 0, _j.concat([_x.sent()]));
                case 8:
                    if (!supplierQuantities.error) return [3 /*break*/, 10];
                ...
                case 9: throw _k.apply(void 0, _l.concat([_x.sent()]));
                case 10:
...
function BundleWorkOrderQuantitiesRoute() {
