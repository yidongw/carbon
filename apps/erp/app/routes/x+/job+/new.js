...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, companyId, userId, formData, validation, _d, _id, configStr, data, configuration, quantity, parsed, result, _e, _f;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    _c = _g.sent(), companyId = _c.companyId, userId = _c.userId;
                ...
                case 3:
                    ...
                    _d = validation.data, _id = _d.id, configStr = _d.configuration, data = __rest(_d, ["id", "configuration"]);
                    ...
                    return [4 /*yield*/, (0, production_1.insertJob)((0, client_server_1.getCarbonServiceRole)(), __assign(__assign({}, data), { jobId: data.jobId || undefined, quantity: quantity, configuration: configuration, companyId: companyId, createdBy: userId, customFields: (0, form_2.setCustomFields)(formData) }))];
                case 4:
                    result = _g.sent();
                    if (!(result.error || !result.data)) return [3 /*break*/, 6];
                    _e = react_router_1.redirect;
                    _f = [path_1.path.to.jobs];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(result.error, "Failed to insert job"))];
                case 5: throw _e.apply(void 0, _f.concat([_g.sent()]));
                case 6: throw (0, react_router_1.redirect)(path_1.path.to.job(result.data.id));
            }
        });
    });
}
function JobNewRoute() {
    var _a;
    ...
    return (<div className="max-w-4xl w-full p-2 sm:p-0 mx-auto mt-0 md:mt-8">
      <Jobs_1.JobForm initialValues={initialValues}/>
    </div>);
}
