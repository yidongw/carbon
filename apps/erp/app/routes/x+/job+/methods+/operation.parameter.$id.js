        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, production_1.upsertJobOperationParameter)(client, __assign(__assign({ id: id }, d), { companyId: companyId, updatedBy: userId, updatedAt: new Date().toISOString() }))];
                case 4:
                    update = _m.sent();
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(update.error, "Failed to update job operation parameter"))];
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Job operation parameter updated"))];
