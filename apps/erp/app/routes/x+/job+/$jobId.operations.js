...
exports.default = JobOperationsRoute;
...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, jobId, url, searchParams, search, _c, limit, offset, sorts, filters, job, _d, _e, operations, _f, _g;
        var _h, _j;
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 4: return [4 /*yield*/, (0, production_1.getJobOperations)(client, jobId, {
                        search: search,
                        limit: limit,
                        offset: offset,
                        sorts: sorts,
                ...
                case 7: return [2 /*return*/, {
                        count: (_h = operations.count) !== null && _h !== void 0 ? _h : 0,
                        operations: (_j = operations.data) !== null && _j !== void 0 ? _j : []
                    }];
            }
        });
    });
}
function JobOperationsRoute() {
    var _a = (0, react_router_1.useLoaderData)(), count = _a.count, operations = _a.operations;
    ...
    return (<react_1.VStack spacing={0} className="h-[calc(100dvh-99px)]">
      <Jobs_1.JobOperationsTable data={operations} count={count} showAssignee/>
    </react_1.VStack>);
}
