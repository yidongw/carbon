...
exports.default = NewStorageUnitRoute;
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, userId, formData, modal, validation, _d, id, rest, createStorageUnit, _e, _f, _g, _h, _j;
        var request = _b.request;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, inventory_1.upsertStorageUnit)(client, __assign(__assign({}, rest), { companyId: companyId, customFields: (0, form_2.setCustomFields)(formData), createdBy: userId }))];
                case 4:
                    createStorageUnit = _k.sent();
                    if (!createStorageUnit.error) return [3 /*break*/, 6];
                    _e = react_router_1.data;
                    _f = [{}];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(createStorageUnit.error, "Failed to insert storageUnit"))];
                case 5: return [2 /*return*/, _e.apply(void 0, _f.concat([_k.sent()]))];
                case 6:
                    if (!modal) return [3 /*break*/, 7];
                    _g = (0, react_router_1.data)(createStorageUnit, { status: 201 });
                    return [3 /*break*/, 9];
                case 7:
                    _h = react_router_1.redirect;
                    _j = ["".concat(path_1.path.to.storageUnits, "?").concat((0, path_1.getParams)(request))];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.success)("Storage unit created"))];
                case 8:
...
function NewStorageUnitRoute() {
    var _a, _b;
    var navigate = (0, react_router_1.useNavigate)();
    var searchParams = (0, react_router_1.useSearchParams)()[0];
    var defaults = (0, hooks_1.useUser)().defaults;
    var locationId = (_a = (searchParams.get("location") || defaults.locationId)) !== null && _a !== void 0 ? _a : "";
    var parentId = (_b = searchParams.get("parentId")) !== null && _b !== void 0 ? _b : undefined;
    var initialValues = {
        name: "",
    ...
    return (<inventory_1.StorageUnitForm initialValues={initialValues} locationId={locationId} onClose={function () { return navigate(-1); }}/>);
}
