...
exports.default = ItemsSettingsRoute;
...
exports.handle = {
    breadcrumb: (0, macro_1.msg)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Items"], ["Items"]))),
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, formData, intent, enabled, _d, result, result, hiddenSubmodules, result;
        var _e;
        var request = _b.request;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    _d = intent;
                    switch (_d) {
                        case "materialIds": return [3 /*break*/, 3];
                        case "materialUnits": return [3 /*break*/, 5];
                        case "hiddenSubmodules": return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 3: return [4 /*yield*/, (0, settings_1.updateMaterialGeneratedIdsSetting)(client, companyId, enabled)];
                case 4:
                    result = _f.sent();
                    if (result.error)
                        return [2 /*return*/, { success: false, message: result.error.message }];
                    return [2 /*return*/, { success: true, message: "Material IDs setting updated" }];
                case 5: return [4 /*yield*/, (0, settings_1.updateMetricSettings)(client, companyId, enabled)];
                case 6:
                    result = _f.sent();
                    if (result.error)
                        return [2 /*return*/, { success: false, message: result.error.message }];
                    return [2 /*return*/, { success: true, message: "Material units setting updated" }];
                case 7:
                    hiddenSubmodules = [];
                    try {
                        hiddenSubmodules = JSON.parse(String((_e = formData.get("hiddenSubmodules")) !== null && _e !== void 0 ? _e : "[]"));
                    }
                    catch (_g) {
...
function ItemsSettingsRoute() {
    var _a, _b, _c, _d, _e;
    var companySettings = (0, react_router_1.useLoaderData)().companySettings;
    var fetcher = (0, react_router_1.useFetcher)();
    var groups = (0, useItemsSubmodules_1.default)({ includeHidden: true }).groups;
    ...
    var handleMaterialIdsToggle = (0, react_2.useCallback)(function (checked) {
        fetcher.submit({ intent: "materialIds", enabled: String(checked) }, { method: "POST" });
    }, [fetcher]);
    var handleMetricToggle = (0, react_2.useCallback)(function (checked) {
        fetcher.submit({ intent: "materialUnits", enabled: String(checked) }, { method: "POST" });
    }, [fetcher]);
    return (<react_1.ScrollArea className="w-full h-[calc(100dvh-49px)]">
      <react_1.VStack spacing={4} className="py-12 px-4 max-w-[60rem] h-full mx-auto gap-4">
        <react_1.Heading size="h3">
          <macro_2.Trans>Items</macro_2.Trans>
        </react_1.Heading>
        <react_1.Card>
          <react_1.CardHeader>
            <react_1.CardTitle>
              <macro_2.Trans>Material IDs</macro_2.Trans>
            </react_1.CardTitle>
            ...
            <react_1.HStack className="justify-between items-center">
              <react_1.VStack className="items-start" spacing={1}>
                <span className="font-medium">
                  {companySettings.materialGeneratedIds ? (<macro_2.Trans>Generated IDs are enabled</macro_2.Trans>) : (<macro_2.Trans>Generated IDs are disabled</macro_2.Trans>)}
                </span>
                <span className="text-sm text-muted-foreground">
                  {companySettings.materialGeneratedIds ? (<macro_2.Trans>
              ...
              <react_1.Switch checked={(_c = companySettings.materialGeneratedIds) !== null && _c !== void 0 ? _c : false} onCheckedChange={handleMaterialIdsToggle} disabled={isToggling}/>
            </react_1.HStack>
          </react_1.CardContent>
        </react_1.Card>
        <react_1.Card>
          <react_1.CardHeader>
            <react_1.CardTitle>
              <macro_2.Trans>Metric</macro_2.Trans>
            </react_1.CardTitle>
            <react_1.CardDescription>
              <macro_2.Trans>Use metric system for default material dimensions.</macro_2.Trans>
            </react_1.CardDescription>
          </react_1.CardHeader>
          <react_1.CardContent>
            <react_1.HStack className="justify-between items-center">
              <react_1.VStack className="items-start" spacing={1}>
                <span className="font-medium">
                  {companySettings.useMetric ? (<macro_2.Trans>Metric units are enabled</macro_2.Trans>) : (<macro_2.Trans>Metric units are disabled</macro_2.Trans>)}
                </span>
                <span className="text-sm text-muted-foreground">
                  {companySettings.useMetric ? (<macro_2.Trans>Material dimensions use metric units.</macro_2.Trans>) : (<macro_2.Trans>
                      Enable to use metric units for material dimensions.
                    </macro_2.Trans>)}
                </span>
              </react_1.VStack>
              <react_1.Switch checked={(_d = companySettings.useMetric) !== null && _d !== void 0 ? _d : false} onCheckedChange={handleMetricToggle} disabled={isToggling}/>
            </react_1.HStack>
          </react_1.CardContent>
        </react_1.Card>
