...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, userId, formData, redirectTo, companies, _d, _e, companyId, matchedCompany, _f, _g, sessionCookie, companyIdCookie;
        var _h, _j, _k, _l;
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 3:
                    companies = _m.sent();
                    if (!companies.error) return [3 /*break*/, 5];
                ...
                case 5:
                    ...
                    if (!!matchedCompany) return [3 /*break*/, 7];
                ...
                case 8:
                    _m.sent();
                    _m.label = 9;
                case 9: return [4 /*yield*/, (0, session_server_1.updateCompanySession)(request, companyId, (_l = matchedCompany.companyGroupId) !== null && _l !== void 0 ? _l : "")];
                case 10:
                    sessionCookie = _m.sent();
                    companyIdCookie = (0, company_server_1.setCompanyId)(companyId);
                    throw (0, react_router_1.redirect)((0, auth_1.safeRedirect)(typeof redirectTo === "string" ? redirectTo : null, path_1.path.to.authenticatedRoot), {
                        headers: [
