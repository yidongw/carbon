...
exports.meta = meta;
var verifyValidator = zod_1.z.object({
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var ip, ratelimit, success, _c, _d, validation, _e, _f, _g, email, code, redirectTo, isCodeValid, _h, _j, existingUser, authSession_1, _k, _l, sessionCookie_1, temporaryPassword, user, _m, _o, authSession, _p, _q, sessionCookie, onboardingUrl;
        var _r;
        var request = _b.request;
        return __generator(this, function (_s) {
            switch (_s.label) {
                case 0:
                    ...
                    ip = (_r = request.headers.get("x-forwarded-for")) !== null && _r !== void 0 ? _r : "127.0.0.1";
                ...
                case 2: return [2 /*return*/, _c.apply(void 0, _d.concat([_s.sent()]))];
                case 3:
                    _f = (_e = (0, form_1.validator)(verifyValidator)).validate;
                    return [4 /*yield*/, request.formData()];
                case 4: return [4 /*yield*/, _f.apply(_e, [_s.sent()])];
                case 5:
                    validation = _s.sent();
                    if (validation.error) {
                        return [2 /*return*/, (0, auth_1.error)(validation.error, "Invalid verification code")];
                    }
                    _g = validation.data, email = _g.email, code = _g.code, redirectTo = _g.redirectTo;
                ...
                case 7: return [2 /*return*/, _h.apply(void 0, _j.concat([_s.sent()]))];
                case 8: return [4 /*yield*/, (0, users_server_1.getUserByEmail)(email)];
                case 9:
                    existingUser = _s.sent();
                    if (!(existingUser.data && existingUser.data.active)) return [3 /*break*/, 15];
                    return [4 /*yield*/, (0, auth_server_1.signInWithEmailViaAdmin)(email)];
                case 10:
                    authSession_1 = _s.sent();
                    if (!!authSession_1) return [3 /*break*/, 12];
                    _k = react_router_1.data;
                    _l = [(0, auth_1.error)(null, "Failed to sign in user")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to sign in user"))];
                case 11: return [2 /*return*/, _k.apply(void 0, _l.concat([_s.sent()]))];
                case 12: return [4 /*yield*/, (0, identity_server_1.linkIdentity)(authSession_1.userId, "email", email)];
                case 13:
                    _s.sent();
                    return [4 /*yield*/, (0, session_server_1.setAuthSession)(request, { authSession: authSession_1 })];
                case 14:
                    sessionCookie_1 = _s.sent();
                    return [2 /*return*/, (0, react_router_1.redirect)((0, auth_1.safeRedirect)(redirectTo, path_1.path.to.authenticatedRoot), {
                            headers: [["Set-Cookie", sessionCookie_1]]
                        })];
                case 15:
                    temporaryPassword = node_crypto_1.default.randomBytes(16).toString("hex");
                    return [4 /*yield*/, (0, auth_server_1.createEmailAuthAccount)(email, temporaryPassword)];
                case 16:
                    user = _s.sent();
                    if (!!user) return [3 /*break*/, 18];
                    _m = react_router_1.data;
                    _o = [(0, auth_1.error)(null, "Failed to create user account")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to create user account"))];
                case 17: return [2 /*return*/, _m.apply(void 0, _o.concat([_s.sent()]))];
                case 18: return [4 /*yield*/, (0, auth_server_1.signInWithEmail)(email, temporaryPassword)];
                case 19:
                    authSession = _s.sent();
                    if (!!authSession) return [3 /*break*/, 21];
                    _p = react_router_1.data;
                    _q = [(0, auth_1.error)(null, "Failed to sign in user")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to sign in user"))];
                case 20: return [2 /*return*/, _p.apply(void 0, _q.concat([_s.sent()]))];
                case 21: return [4 /*yield*/, (0, identity_server_1.linkIdentity)(authSession.userId, "email", email)];
                case 22:
                    _s.sent();
                ...
                case 23:
                    sessionCookie = _s.sent();
                    onboardingUrl = redirectTo || path_1.path.to.onboarding.root;
                    return [2 /*return*/, (0, react_router_1.redirect)(onboardingUrl, {
...
function VerifyRoute() {
    ...
    var email = (_a = searchParams.get("email")) !== null && _a !== void 0 ? _a : "";
    ...
    return (<>
      ...
      <div className="rounded-lg md:bg-card md:border md:border-border md:shadow-lg p-8 w-[380px]">
        <form_1.ValidatedForm fetcher={fetcher} validator={verifyValidator} defaultValues={{ email: email, redirectTo: redirectTo }} method="post">
          <form_1.Hidden name="email" value={email}/>
          ...
          <react_1.VStack spacing={4} className="items-center">
            ...
            <p className="text-muted-foreground tracking-tight text-sm text-center">
              <macro_1.Trans>We've sent a verification code to {email}</macro_1.Trans>
            </p>
            ...
            {((_c = fetcher.data) === null || _c === void 0 ? void 0 : _c.success) === false && ((_d = fetcher.data) === null || _d === void 0 ? void 0 : _d.message) && (<react_1.Alert variant="destructive">
                ...
                <react_1.AlertDescription>
                  {((_e = fetcher.data) === null || _e === void 0 ? void 0 : _e.message) && formatError(fetcher.data.message)}
                </react_1.AlertDescription>
              </react_1.Alert>)}
