...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, url, labelParam, lineIdParam, companySettings, labelSizeId, labelSize, items, template, company, logo, zplOutput;
        var _d;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    labelSizeId = labelParam || ((_d = companySettings.data) === null || _d === void 0 ? void 0 : _d.productLabelSize) || "label2x1";
                    labelSize = utils_1.labelSizes.find(function (size) { return size.id === labelSizeId; });
                    if (!labelSize) {
                        throw new Error("Invalid label size");
                    }
                    if (!labelSize.zpl) {
                        throw (0, react_router_1.redirect)(path_1.path.to.file.stockTransferLabelsPdf(id, {
                ...
                case 6:
                    logo = _e.sent();
                    zplOutput = items
                        .map(function (item) { return (0, zpl_1.generateProductLabelZPL)(item, labelSize, template, logo); })
                        .join("\n");
