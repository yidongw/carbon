...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, _d, company, companySettings, shipmentTracking, url, labelParam, lineIdParam, labelSizeId, labelSize, filteredTracking, itemEntityIds, trackedEntities, items, template, logo, stream, body, headers;
        var _e, _f, _g;
            ...
            switch (_h.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, inventory_1.getShipmentTracking)(client, id, companyId)
                        ])];
                case 2:
                    _d = _h.sent(), company = _d[0], companySettings = _d[1], shipmentTracking = _d[2];
                    if (company.error) {
                ...
                case 7:
                    ...
                    headers = new Headers({
                        ...
                        "Content-Disposition": "inline; filename=\"".concat(company.data.name, " - Shipment Labels.pdf\"")
                    });
