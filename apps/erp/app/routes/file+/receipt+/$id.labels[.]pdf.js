...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, _d, company, companySettings, receiptLineTracking, url, labelParam, lineIdParam, labelSizeId, labelSize, filteredTracking, items, template, logo, stream, body, headers;
        var _e, _f;
            ...
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, inventory_1.getReceiptTracking)(client, id, companyId)
                        ])];
                case 2:
                    _d = _g.sent(), company = _d[0], companySettings = _d[1], receiptLineTracking = _d[2];
                    if (company.error) {
                    ...
                    filteredTracking = receiptLineTracking.data;
                        ...
                        filteredTracking =
                            (_f = filteredTracking === null || filteredTracking === void 0 ? void 0 : filteredTracking.filter(function (tracking) {
                                return tracking.attributes &&
                                    tracking.attributes["Receipt Line"] ===
                                        lineIdParam;
                            })) !== null && _f !== void 0 ? _f : [];
                    }
                    ...
                    if (!Array.isArray(items) || items.length === 0) {
                        return [2 /*return*/, new Response("No items found for receipt ".concat(id).concat(lineIdParam ? " and line ".concat(lineIdParam) : ""), { status: 404 })];
                    }
                ...
                case 6:
                    ...
                    headers = new Headers({
                        ...
                        "Content-Disposition": "inline; filename=\"".concat(company.data.name, " - Receipt Labels.pdf\"")
                    });
