...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        function downloadFile() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.storage.from("private").download("".concat(path))];
                        case 1:
                            result = _a.sent();
                            if (result.error) {
        ...
        var client, path, fileType, contentType, fileData, headers;
        var _c;
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (!path.includes("models")) {
                        throw (0, auth_1.notFound)("Invalid path");
                    }
