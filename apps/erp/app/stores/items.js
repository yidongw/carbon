...
exports.useMaterials = exports.useServices = exports.useTools = exports.useStyles = exports.useParts = exports.useItems = void 0;
...
var $stylesStore = (0, nanostores_1.computed)($itemsStore, function (item) {
    return item.filter(function (i) { return i.type === "Style"; });
});
...
var useStyles = function () { return (0, react_1.useStore)($stylesStore); };
