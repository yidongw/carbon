...
exports.createWeChatAuthSession = createWeChatAuthSession;
 ...
 */
function createWeChatAuthSession(request, user) {
    return __awaiter(this, void 0, void 0, function () {
        var authSession, sessionCookie, companyIdCookie;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, auth_server_1.signInWithUserIdViaAdmin)(user.id)];
                case 1:
                    authSession = _a.sent();
                    if (!authSession)
