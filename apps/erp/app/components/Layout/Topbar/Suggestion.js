...
var Picker = react_2.default.lazy(function () { return Promise.resolve().then(function () { return require("@emoji-mart/react"); }); });
...
var Suggestion = function () {
    ...
    var _b = (0, react_2.useState)(""), suggestion = _b[0], setSuggestion = _b[1];
    var _c = (0, react_2.useState)(defaultEmoji), emoji = _c[0], setEmoji = _c[1];
    var _d = (0, react_2.useState)(false), emojiPickerOpen = _d[0], setEmojiPickerOpen = _d[1];
    var _e = (0, react_2.useState)(true), anonymous = _e[0], setAnonymous = _e[1];
    var mode = (0, react_1.useMode)();
    var pickerTheme = mode;
    var _f = (0, react_2.useState)(null), attachment = _f[0], setAttachment = _f[1];
    ...
    var uploadImage = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var file_1, fileExtension, storagePath, uploadToast, imageUpload;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    storagePath = "".concat(companyId, "/suggestions/").concat((0, nanoid_1.nanoid)(), ".").concat(fileExtension);
                    uploadToast = (0, upload_1.createUploadToast)({
                        id: "suggestion-".concat(storagePath, "-").concat(file_1.name),
    ...
    var onEmojiSelect = function (emojiData) {
        setEmoji(emojiData.native);
        setEmojiPickerOpen(false);
    };
    return (<react_1.Popover>
      <react_1.PopoverTrigger ref={popoverTriggerRef} asChild>
        <react_1.Button variant="secondary" className="hover:scale-100">
          <macro_1.Trans>Suggestion</macro_1.Trans>
        </react_1.Button>
      </react_1.PopoverTrigger>
      <react_1.PopoverContent align="end" className="w-[380px] ">
        <form_1.ValidatedForm method="post" action={path_1.path.to.newSuggestion} validator={shared_1.suggestionValidator} fetcher={fetcher}>
          <form_1.Hidden name="path" value={location.pathname}/>
          <form_1.Hidden name="emoji" value={emoji}/>
          <form_1.Hidden name="attachmentPath" value={(_a = attachment === null || attachment === void 0 ? void 0 : attachment.path) !== null && _a !== void 0 ? _a : ""}/>
          <form_1.Hidden name="userId" value={anonymous ? "" : user.id}/>
          <react_1.VStack spacing={2}>
            <react_1.VStack spacing={2} className="w-full">
              <form_1.TextAreaControlled name="suggestion" label="" value={suggestion} onChange={function (value) { return setSuggestion(value); }} placeholder={t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Ideas, suggestions or problems?"], ["Ideas, suggestions or problems?"])))}/>
              {attachment && (<react_1.Badge className="-mt-2 truncate" variant="secondary">
                  {attachment.name}
                  <react_1.BadgeCloseButton type="button" onClick={function () {
                setAttachment(null);
            }}/>
                </react_1.Badge>)}
            </react_1.VStack>
            <react_1.HStack className="w-full justify-between">
              <react_1.HStack spacing={2}>
                <react_1.Checkbox isChecked={anonymous} onCheckedChange={function (checked) { return setAnonymous(checked === true); }}/>
                <span className="text-sm">
                  <macro_1.Trans>Submit anonymously</macro_1.Trans>
                </span>
              </react_1.HStack>
              <react_1.Popover open={emojiPickerOpen} onOpenChange={setEmojiPickerOpen}>
                <react_1.PopoverTrigger asChild>
                  <button type="button" className="inline-flex items-center justify-center rounded-md h-10 w-10 text-2xl hover:bg-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 shrink-0">
                    {emoji}
                  </button>
                </react_1.PopoverTrigger>
                <react_1.PopoverContent className="w-auto p-0 border-0" align="end" sideOffset={8}>
                  <react_2.Suspense>
                    <Picker data={data_1.default} onEmojiSelect={onEmojiSelect} theme={pickerTheme} previewPosition="none" skinTonePosition="none" navPosition="bottom" perLine={8}/>
                  </react_2.Suspense>
            ...
            (_a = popoverTriggerRef.current) === null || _a === void 0 ? void 0 : _a.click();
              ...
              <react_1.HStack spacing={1}>
                <react_1.Button isDisabled={suggestion.length === 0} variant="secondary" onClick={function () { return setSuggestion(""); }}>
                ...
                <form_1.Submit isDisabled={suggestion.length < 3}>
