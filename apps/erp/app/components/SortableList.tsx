        ...
        >
          <LuPlus
            className={cn(
              ...
              isOverTarget ? "text-amber-500" : "text-foreground/80"
            )}
            strokeWidth={2.5}
          />
          <span
            className={cn(
              "text-sm font-medium tabular-nums leading-none tracking-tight",
              isOverTarget ? "text-amber-500" : "text-foreground"
            )}
          >
      ...
      {onAddPickup ? (
        ...
        >
          <LuPlus
            className={cn(
              "h-3.5 w-3.5 shrink-0",
              pickup > 0 ? "text-blue-600" : "text-foreground/80"
            )}
            strokeWidth={2.5}
          />
          <span
            className={cn(
              "text-sm font-medium tabular-nums leading-none tracking-tight",
              pickup > 0 ? "text-blue-600" : "text-muted-foreground"
            )}
          >
