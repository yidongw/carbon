            ...
            {draggableOrder.map((columnId) => {
              ...
              const toggleFeatured = () => {
                if (isFeatured) {
                  ...
                  const newFeatured = new Set([...featuredColumns, column.id]);
    ...
    >
      <HStack className="w-full">
        ...
        <IconButton
          ...
          icon={isPinned ? <LuPin className="text-primary" /> : <LuPinOff />}
          onClick={onTogglePin}
          variant="ghost"
        />
        ...
        <IconButton
          ...
          icon={
            isFeatured ? <LuStar className="text-primary" /> : <LuStarOff />
          }
