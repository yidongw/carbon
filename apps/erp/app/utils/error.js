...
exports.getEdgeFunctionErrorMessage = getEdgeFunctionErrorMessage;
/**
 ...
 */
function getEdgeFunctionErrorMessage(err, fallback) {
    return __awaiter(this, void 0, void 0, function () {
        var ctx, body, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ctx = err === null || err === void 0 ? void 0 : err.context;
                    if (!(ctx && typeof ctx.clone === "function")) return [3 /*break*/, 4];
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
