...
function makeDurations(operation) {
    ...
    switch (operation.laborUnit) {
        case "Total Hours":
            laborDuration = ((_w = operation.laborTime) !== null && _w !== void 0 ? _w : 0) * 3600000;
            break;
        case "Total Minutes":
            laborDuration = ((_x = operation.laborTime) !== null && _x !== void 0 ? _x : 0) * 60000;
            break;
        case "Hours/Piece":
            laborDuration =
    ...
    switch (operation.machineUnit) {
        case "Total Hours":
            machineDuration = ((_16 = operation.machineTime) !== null && _16 !== void 0 ? _16 : 0) * 3600000;
            break;
        case "Total Minutes":
            machineDuration = ((_17 = operation.machineTime) !== null && _17 !== void 0 ? _17 : 0) * 60000;
            break;
        case "Hours/Piece":
            machineDuration =
