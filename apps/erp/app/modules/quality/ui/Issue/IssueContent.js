...
exports.IssueContent = IssueContent;
...
function IssueContent(_a) {
    var _this = this;
    var id = _a.id, title = _a.title, subTitle = _a.subTitle, initialContent = _a.content, isDisabled = _a.isDisabled;
    ...
    var onUpdateContent = (0, react_1.useDebounce)(function (content) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (carbon === null || carbon === void 0 ? void 0 : carbon.from("nonConformance").update({
                        content: content,
                        updatedBy: userId
                    }).eq("id", id))];
                case 1:
    ...
    return (<>
      <react_1.Card>
        ...
        <react_1.CardContent>
          {permissions.can("update", "quality") && !isDisabled ? (<Editor_1.Editor initialValue={(content !== null && content !== void 0 ? content : {})} onUpload={onUploadImage} onChange={function (value) {
                setContent(value);
