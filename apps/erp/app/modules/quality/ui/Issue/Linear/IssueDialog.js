...
exports.LinearIssueDialog = void 0;
...
var LinearIssueDialog = function (_a) {
    var _b, _c;
    var task = _a.task;
    var t = (0, macro_1.useLingui)().t;
    var _d = (0, react_2.useState)("link"), tab = _d[0], setTab = _d[1];
    ...
    var linked = linear_1.LinearIssueSchema.safeParse(task.linearIssue).data;
    ...
    var onUnlink = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher.submit({ actionId: task.id }, { method: "DELETE", action: path_1.path.to.api.linearLinkExistingIssue })];
                case 1:
                    _a.sent();
                    revalidator.revalidate();
                    return [2 /*return*/];
    ...
    return (<react_1.Modal open={disclosure.isOpen} onOpenChange={function (open) {
      ...
      <react_1.ModalTrigger onClick={function () { return disclosure.onToggle(); }}>
        {linked ? (<react_1.Button leftIcon={<Icons_1.LinearIcon className={"size-4"}/>} variant="ghost" aria-label={t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Update Linear issue"], ["Update Linear issue"])))}>
            {linked.identifier}
          </react_1.Button>) : (<react_1.IconButton icon={<Icons_1.LinearIcon className={"size-4 grayscale"}/>} variant="ghost" aria-label={t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Connect Linear issue"], ["Connect Linear issue"])))}/>)}
      </react_1.ModalTrigger>
      <react_1.ModalContent size={"large"}>
        <react_1.Tabs value={tab} onValueChange={setTab} defaultValue="link">
          <react_1.ModalHeader className="mb-1 flex-row justify-between py-3">
            <div className="space-y-1">
              <react_1.ModalTitle>
                <macro_1.Trans>Link Linear Issue</macro_1.Trans>
              </react_1.ModalTitle>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Icons_1.LinearIssueStateBadge state={linked.state} className="size-3.5"/>
                      </div>
                    </div>

                    <div className="mt-2 text-sm text-muted-foreground flex justify-between items-center">
                      <span>
                        {((_b = linked.assignee) === null || _b === void 0 ? void 0 : _b.email)
                ? "Assigned to ".concat((_c = linked.assignee) === null || _c === void 0 ? void 0 : _c.email)
                : "Unassigned"}
                      </span>
...
exports.LinearIssueDialog = LinearIssueDialog;
