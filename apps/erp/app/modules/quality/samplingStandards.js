...
exports.SAMPLING_STANDARDS = exports.standardAqlValues = exports.inspectionSeverities = exports.inspectionLevels = exports.samplingPlanTypes = exports.samplingStandards = void 0;
exports.getCodeLetter = getCodeLetter;
exports.resolveSamplingPlan = resolveSamplingPlan;
exports.samplingStandards = ["ANSI_Z1_4", "ISO_2859_1"];
exports.samplingPlanTypes = ["All", "First", "Percentage", "AQL"];
exports.inspectionLevels = [
    "I",
    "II",
    "III",
    "S1",
...
exports.inspectionSeverities = ["Normal", "Tightened", "Reduced"];
exports.standardAqlValues = [
...
function getCodeLetter(standard, lotSize, level) {
    var _a;
    var rows = exports.SAMPLING_STANDARDS[standard].codeLetterTable;
    var row = rows.find(function (r) { return lotSize >= r.range.min && lotSize <= r.range.max; });
    return (_a = row === null || row === void 0 ? void 0 : row.levels[level]) !== null && _a !== void 0 ? _a : null;
}
function getSeverityBlock(standard, severity) {
    var data = exports.SAMPLING_STANDARDS[standard];
    switch (severity) {
        case "Tightened":
...
function resolveSamplingPlan(plan, lotSize, standard) {
    ...
    var letter = getCodeLetter(standard, safeLot, level);
    if (!letter) {
        return {
            sampleSize: safeLot,
            acceptance: 0,
    ...
    var cell = (_f = getSeverityBlock(standard, severity)[letter]) === null || _f === void 0 ? void 0 : _f[aql];
    if (!cell) {
        return {
            sampleSize: safeLot,
            acceptance: 0,
