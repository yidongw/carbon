...
var categoryGroups = [
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                label: "Prepayments",
                description: "Account for advance payments made before goods or services are received",
                accountType: "balance",
                badgeType: "Asset"
            }
        ]
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Accrual for inventory shipped but not yet invoiced to customer",
                accountType: "balance",
                badgeType: "Asset"
            }
        ]
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Contra-asset account for total depreciation of fixed assets",
                accountType: "balance",
                badgeType: "Asset"
            },
            {
    ...
    // --- Liabilities ---
    {
        ...
        description: "Configure default accounts for vendor and supplier transactions",
        fields: [
            {
            ...
            },
            {
                ...
                description: "Clearing account for goods received / invoice received matching",
                accountType: "balance",
                badgeType: "Liability"
            }
        ]
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Liability account for deferred taxes from accelerated depreciation",
                accountType: "balance",
                badgeType: "Liability"
            }
        ]
    ...
    // --- Equity ---
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Equity account for currency translation adjustments (CTA)",
                accountType: "balance",
                badgeType: "Equity"
            }
        ]
    ...
    // --- Expenses ---
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Expense account for non-inventory purchases (services, supplies)",
                accountType: "income",
                badgeType: "Expense"
            },
            {
                ...
                description: "Credit account when labor/machine time is absorbed into WIP",
                accountType: "income",
                badgeType: "Expense"
            },
            {
            ...
            },
            {
                ...
                description: "Variance between actual and standard BOM component consumption",
                accountType: "income",
                badgeType: "Expense"
            },
            {
                ...
                description: "Variance between actual and standard routing hours and rates",
                accountType: "income",
                badgeType: "Expense"
            },
            {
                ...
                description: "Variance between applied and actual manufacturing overhead",
                accountType: "income",
                badgeType: "Expense"
            },
            {
                ...
                description: "Fixed cost amortization variance when batch size differs from standard",
                accountType: "income",
                badgeType: "Expense"
            },
            {
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "Expense account for deferred tax adjustments on depreciation",
                accountType: "income",
                badgeType: "Expense"
            }
        ]
...
var AccountDefaultsForm = function (_a) {
    var balanceSheetAccounts = _a.balanceSheetAccounts, incomeStatementAccounts = _a.incomeStatementAccounts, initialValues = _a.initialValues;
    var permissions = (0, hooks_1.usePermissions)();
    var navigate = (0, react_router_1.useNavigate)();
    var onClose = function () { return navigate(-1); };
    var isDisabled = !permissions.can("update", "accounting");
    var accountOptions = (0, react_2.useMemo)(function () { return ({
        income: incomeStatementAccounts.map(function (c) { return ({
            value: c.id,
        ...
        balance: balanceSheetAccounts.map(function (c) { return ({
            value: c.id,
            label: (<div className="flex items-center gap-2">
            <span className="text-xs font-mono text-muted-foreground">
              {c.number}
    ...
    return (<form_1.ValidatedForm validator={accounting_models_1.defaultAccountValidator} method="post" action={path_1.path.to.accountingDefaults} defaultValues={initialValues} className="w-full">
      <Form_1.Hidden name="intent" value="all"/>
      <div className="rounded-lg border border-border bg-card">
        <div className="flex items-center justify-between border-b border-border p-6">
          <div>
            <h1 className="text-xl font-semibold text-foreground">
              <macro_1.Trans>Default Accounts</macro_1.Trans>
            </h1>
        ...
        <div className="flex flex-col gap-8 p-6">
          {categoryGroups.map(function (group) { return (<div key={group.id} className="border border-border rounded-lg">
              ...
              <div className="flex flex-col gap-3 p-4">
                {group.fields.map(function (field) { return (<div key={field.name} className="group rounded-lg border border-border p-4 transition-all hover:border-muted-foreground/30">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <react_1.Badge variant={badgeColors[field.badgeType]}>
                            {field.badgeType}
                          </react_1.Badge>
                        </div>
                        <p className="text-xs text-muted-foreground">
                      ...
                      <div className="flex-shrink-0 w-64">
                        <Form_1.Combobox name={field.name} options={accountOptions[field.accountType]} size="sm"/>
                      </div>
                    </div>
                  </div>); })}
              </div>
...
exports.default = AccountDefaultsForm;
