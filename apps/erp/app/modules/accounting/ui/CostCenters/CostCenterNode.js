...
exports.CostCenterNode = void 0;
var react_1 = require("@carbon/react");
var macro_1 = require("@lingui/react/macro");
var react_2 = require("@xyflow/react");
var react_3 = require("react");
var lu_1 = require("react-icons/lu");
function CostCenterNodeComponent(_a) {
    var _b;
    var data = _a.data;
    var t = (0, macro_1.useLingui)().t;
    var costCenter = data.costCenter, onEdit = data.onEdit, onDelete = data.onDelete, onAddChild = data.onAddChild;
    return (<div className="group relative">
      ...
      <div className="flex items-center gap-3 rounded-lg border border-border bg-card px-3 py-2.5 shadow-sm transition-shadow hover:shadow-md" style={{ minWidth: 170, maxWidth: 220 }}>
        <div className="flex size-9 shrink-0 items-center justify-center rounded-md bg-muted">
          <lu_1.LuCircleDollarSign className="size-4 text-muted-foreground"/>
        </div>
        ...
        <div className="flex flex-col gap-0.5 overflow-hidden min-w-0">
          ...
          {((_b = costCenter.owner) === null || _b === void 0 ? void 0 : _b.fullName) && (<span className="truncate text-xs text-muted-foreground leading-tight">
...
exports.CostCenterNode = (0, react_3.memo)(CostCenterNodeComponent);
