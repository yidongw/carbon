...
var ItemNotes = function (_a) {
    var id = _a.id, title = _a.title, subTitle = _a.subTitle, initialNotes = _a.notes;
    var _b = (0, hooks_1.useUser)(), userId = _b.id, companyId = _b.company.id;
    var carbon = (0, auth_1.useCarbon)().carbon;
    var permissions = (0, hooks_1.usePermissions)();
    var t = (0, macro_1.useLingui)().t;
    var _c = (0, react_2.useState)(initialNotes !== null && initialNotes !== void 0 ? initialNotes : {}), notes = _c[0], setInternalNotes = _c[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileName = "".concat(companyId, "/parts/notes/").concat((0, nanoid_1.nanoid)(), ".").concat(fileType);
    ...
    var onUpdateInternalNotes = (0, react_1.useDebounce)(function (content) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (carbon === null || carbon === void 0 ? void 0 : carbon.from("item").update({
                        notes: content,
    ...
    return (<>
      <react_1.Card>
        <react_1.CardHeader>
          ...
          <react_1.CardDescription>{subTitle}</react_1.CardDescription>
        </react_1.CardHeader>

        <react_1.CardContent>
          {permissions.can("update", "parts") ? (<Editor_1.Editor initialValue={(notes !== null && notes !== void 0 ? notes : {})} onUpload={onUploadImage} onChange={function (value) {
