...
exports.default = useCustomerParts;
var auth_1 = require("@carbon/auth");
var react_1 = require("react");
var hooks_1 = require("~/hooks");
function useCustomerParts() {
    var _this = this;
    var carbon = (0, auth_1.useCarbon)().carbon;
    var permissions = (0, hooks_1.usePermissions)();
    var canEdit = permissions.can("update", "parts");
    var canDelete = permissions.can("delete", "parts");
    var onCellEdit = (0, react_1.useCallback)(function (id, value, row) { return __awaiter(_this, void 0, void 0, function () {
        var _a;
