...
var ToolForm = function (_a) {
    ...
    (0, react_2.useEffect)(function () {
        ...
        if (fetcher.state === "loading" && ((_a = fetcher.data) === null || _a === void 0 ? void 0 : _a.data)) {
            ...
            react_1.toast.success(t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Created tool"], ["Created tool"]))));
        }
        else if (fetcher.state === "idle" && ((_b = fetcher.data) === null || _b === void 0 ? void 0 : _b.error)) {
            react_1.toast.error(t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Failed to create tool: ", ""], ["Failed to create tool: ", ""])), fetcher.data.error.message));
        }
    }, [fetcher.data, fetcher.state, onClose, type, t]);
    var _l = (0, hooks_1.useNextItemId)("Tool"), id = _l.id, onIdChange = _l.onIdChange, loading = _l.loading;
    ...
    var _o = (0, react_2.useState)((_d = initialValues.defaultMethodType) !== null && _d !== void 0 ? _d : "Purchase to Order"), defaultMethodType = _o[0], setDefaultMethodType = _o[1];
    ...
    return (<react_1.ModalCardProvider type={type}>
      <react_1.ModalCard onClose={onClose}>
        <react_1.ModalCardContent>
          <form_1.ValidatedForm action={isEditing ? undefined : path_1.path.to.newTool} method="post" validator={items_models_1.toolValidator} defaultValues={initialValues} fetcher={fetcher}>
            <react_1.ModalCardHeader>
              <react_1.ModalCardTitle>
                {isEditing ? (<macro_1.Trans>Tool Details</macro_1.Trans>) : (<macro_1.Trans>New Tool</macro_1.Trans>)}
              </react_1.ModalCardTitle>
            ...
            : "grid-cols-1 md:grid-cols-2")}>
                {isEditing ? (<Form_1.Input name="id" label={t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Tool ID"], ["Tool ID"])))} isReadOnly/>) : (<Form_1.InputControlled name="id" label={t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Tool ID"], ["Tool ID"])))} helperText={startsWithLetter(id)
                ? t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Use ... to get the next tool ID"], ["Use ... to get the next tool ID"]))) : undefined} value={id} onChange={onIdChange} isDisabled={loading} isUppercase autoFocus/>)}
            ...
            if ((newValue === null || newValue === void 0 ? void 0 : newValue.value) === "Buy") {
                ...
                <Form_1.DefaultMethodType name="defaultMethodType" label={t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Default Method Type"], ["Default Method Type"])))} replenishmentSystem={replenishmentSystem} value={defaultMethodType} onChange={function (newValue) { var _a; return setDefaultMethodType((_a = newValue === null || newValue === void 0 ? void 0 : newValue.value) !== null && _a !== void 0 ? _a : "Purchase to Order"); }}/>
                ...
                {!isEditing && (<Form_1.Number name="unitCost" label={t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Unit Cost"], ["Unit Cost"])))} formatOptions={{
                style: "currency",
                currency: baseCurrency
            }} minValue={0} isReadOnly={replenishmentSystem === "Make"}/>)}

                <ItemStorageFields_1.default />

                <Form_1.CustomFormFields table="tool" tags={initialValues.tags}/>
              </div>
              <div className="mt-4 w-full">
                <Form_1.TextArea name="description" label={t(templateObject_28 || (templateObject_28 = __makeTemplateObject(["Long Description"], ["Long Description"])))}/>
              </div>
            ...
            : "border-muted")}>
                  ...
                  {modelFile ? (<>
                      ...
                      <p className="text-xs text-muted-foreground group-hover:text-foreground">
                        {t(templateObject_29 || (templateObject_29 = __makeTemplateObject(["Supports ", " files"], ["Supports ", " files"])), utils_1.supportedModelTypes.join(", "))}
                      </p>
                    </react_1.Loading>)}
                </div>
              </react_1.VStack>
