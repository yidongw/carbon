...
var useStyleNavigation_1 = require("./useStyleNavigation");
function StyleTopbarLeft(_a) {
    var _b, _c;
    ...
    var readableId = (_c = (_b = routeData === null || routeData === void 0 ? void 0 : routeData.styleSummary) === null || _b === void 0 ? void 0 : _b.readableIdWithRevision) !== null && _c !== void 0 ? _c : "";
    return (<>
      <Layout_1.DetailTopbarContent>
        <Layout_1.DetailTopbarId to={path_1.path.to.style(itemId)}>{readableId}</Layout_1.DetailTopbarId>
...
var StyleHeader = function () {
    var t = (0, macro_1.useLingui)().t;
    var links = (0, useStyleNavigation_1.useStyleNavigation)();
    ...
    return (<>
      {leftSlotEl &&
            (0, react_dom_1.createPortal)(<StyleTopbarLeft itemId={itemId}/>, leftSlotEl)}
