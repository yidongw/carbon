...
var UnitOfMeasuresTable = (0, react_2.memo)(function (_a) {
    var data = _a.data, count = _a.count;
    var params = (0, hooks_1.useUrlParams)()[0];
    var navigate = (0, react_router_1.useNavigate)();
    var t = (0, macro_1.useLingui)().t;
    var permissions = (0, hooks_1.usePermissions)();
    var customColumns = (0, useCustomColumns_1.useCustomColumns)("unitOfMeasure");
    ...
    var renderContextMenu = (0, react_2.useCallback)(function (row) {
        return (<>
            <react_1.MenuItem disabled={!permissions.can("update", "parts")} onClick={function () {
                navigate("".concat(path_1.path.to.uom(row.id), "?").concat(params.toString()));
            }}>
              <react_1.MenuIcon icon={<lu_1.LuPencil />}/>
              Edit Unit of Measure
            </react_1.MenuItem>
            <react_1.MenuItem destructive disabled={!permissions.can("delete", "parts")} onClick={function () {
                navigate("".concat(path_1.path.to.deleteUom(row.id), "?").concat(params.toString()));
            }}>
