...
exports.useConsumableNavigation = useConsumableNavigation;
var macro_1 = require("@lingui/react/macro");
var lu_1 = require("react-icons/lu");
var react_router_1 = require("react-router");
var hooks_1 = require("~/hooks");
var path_1 = require("~/utils/path");
function useConsumableNavigation() {
    var _a, _b;
    ...
    if (!((_a = routeData === null || routeData === void 0 ? void 0 : routeData.consumableSummary) === null || _a === void 0 ? void 0 : _a.itemTrackingType))
        throw new Error("Could not find itemTrackingType in routeData");
    var itemTrackingType = routeData.consumableSummary.itemTrackingType;
    return [
        {
            name: t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Details"], ["Details"]))),
            to: path_1.path.to.consumableDetails(itemId),
            icon: lu_1.LuFileText,
            shortcut: "Command+Shift+d"
        },
        {
            name: t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Purchasing"], ["Purchasing"]))),
            to: path_1.path.to.consumablePurchasing(itemId),
        ...
        },
        {
            ...
            to: path_1.path.to.consumableCosting(itemId),
            role: ["employee"],
            permission: "purchasing",
            icon: lu_1.LuTags,
        ...
        },
        {
            ...
            to: path_1.path.to.consumablePlanning(itemId),
        ...
        },
        {
            ...
            to: path_1.path.to.consumableInventory(itemId),
            isDisabled: itemTrackingType === "Non-Inventory",
            role: ["employee", "supplier"],
            icon: lu_1.LuBox,
        ...
        },
        {
            ...
            to: path_1.path.to.consumableQuality(itemId),
            isDisabled: !((_b = routeData === null || routeData === void 0 ? void 0 : routeData.consumableSummary) === null || _b === void 0 ? void 0 : _b.requiresInspection),
            role: ["employee"],
            permission: "quality",
