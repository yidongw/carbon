...
var useConsumableNavigation_1 = require("./useConsumableNavigation");
function ConsumableTopbarLeft(_a) {
    var _b, _c;
    ...
    var readableId = (_c = (_b = routeData === null || routeData === void 0 ? void 0 : routeData.consumableSummary) === null || _b === void 0 ? void 0 : _b.readableIdWithRevision) !== null && _c !== void 0 ? _c : "";
    return (<>
      <Layout_1.DetailTopbarContent>
        <Layout_1.DetailTopbarId to={path_1.path.to.consumableDetails(itemId)}>
          {readableId}
        ...
        <react_1.DropdownMenu>
          ...
          <react_1.DropdownMenuContent>
            ...
            !permissions.is("employee")} destructive onClick={deleteModal.onOpen}>
              ...
              <macro_1.Trans>Delete Consumable</macro_1.Trans>
...
var ConsumableHeader = function () {
    var t = (0, macro_1.useLingui)().t;
    var links = (0, useConsumableNavigation_1.useConsumableNavigation)();
    ...
    return (<>
      {leftSlotEl &&
            (0, react_dom_1.createPortal)(<ConsumableTopbarLeft itemId={itemId}/>, leftSlotEl)}
...
exports.default = ConsumableHeader;
