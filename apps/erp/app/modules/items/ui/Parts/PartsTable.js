...
var PartsTable = (0, react_2.memo)(function (_a) {
    var _b;
    var data = _a.data, tags = _a.tags, count = _a.count, rawItemPostingGroups = _a.itemPostingGroups;
    ...
    var itemPostingGroups = (0, react_2.useMemo)(function () { return rawItemPostingGroups.map(function (g) { return ({ value: g.id, label: g.name }); }); }, [rawItemPostingGroups]);
    ...
    var customColumns = (0, useCustomColumns_1.useCustomColumns)("part");
    var columns = (0, react_2.useMemo)(function () {
        var defaultColumns = [
            {
                accessorKey: "id",
                header: t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Part ID"], ["Part ID"]))),
                cell: function (_a) {
                    var row = _a.row;
              ...
              <components_1.Hyperlink to={path_1.path.to.partDetails(row.original.id)} className="min-w-0">
            ...
            },
            {
                ...
                header: t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Template"], ["Template"]))),
            ...
            },
            {
                ...
                header: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Description"], ["Description"]))),
            ...
            },
            {
                ...
                header: t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Item Group"], ["Item Group"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "enum",
            ...
            {
                accessorKey: "tags",
                header: t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Tags"], ["Tags"]))),
                cell: function (_a) {
                    var row = _a.row;
                    return (<InlineEditor_1.TagsCell row={row.original} table="part" availableTags={tags}/>);
                },
                meta: {
                    filter: {
                        type: "static",
            ...
            {
                accessorKey: "active",
                header: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Active"], ["Active"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "boolean",
                    field: "active",
                    update: ITEM_UPDATE,
                ...
                meta: {
                    filter: {
                        type: "static",
                        options: [
                            { value: "true", label: t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Active"], ["Active"]))) },
                            { value: "false", label: t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Inactive"], ["Inactive"]))) }
                        ]
                    },
                    pluralHeader: t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Active Statuses"], ["Active Statuses"]))),
                    icon: <lu_1.LuCheck />
                }
            },
            {
                id: "createdBy",
                header: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Created By"], ["Created By"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Created At"], ["Created At"]))),
            ...
            {
                id: "updatedBy",
                header: t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Updated By"], ["Updated By"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Updated At"], ["Updated At"]))),
                cell: function (item) { return formatDate(item.getValue()); },
                meta: {
                    icon: <lu_1.LuCalendar />
                }
    ...
    var renderContextMenu = (0, react_2.useMemo)(function () {
        return function (row) {
            ...
            return (<>
            <react_1.MenuItem onClick={function () { return navigate(path_1.path.to.part(row.id)); }}>
              <react_1.MenuIcon icon={<lu_1.LuPencil />}/>
              <macro_1.Trans>Edit Part</macro_1.Trans>
            </react_1.MenuItem>
            {revisions && revisions.length > 1 && (<react_1.MenuSub>
                ...
                <react_1.MenuSubContent>
                  {revisions.map(function (revision) { return (<react_1.MenuItem key={revision.id} onClick={function () { return navigate(path_1.path.to.part(revision.id)); }}>
                      <react_1.MenuIcon icon={<lu_1.LuTag />}/>
                      {t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Revision ", ""], ["Revision ", ""])), revision.revision)}
                    </react_1.MenuItem>); })}
                </react_1.MenuSubContent>
              </react_1.MenuSub>)}
            <react_1.MenuItem destructive disabled={!permissions.can("delete", "parts")} onClick={function () {
              ...
              <macro_1.Trans>Delete Part</macro_1.Trans>
            </react_1.MenuItem>
          </>);
        };
    ...
    return (<>
        <components_1.Table count={count} columns={columns} data={data} defaultColumnPinning={{
            ...
            {
                table: "part",
                label: t(templateObject_28 || (templateObject_28 = __makeTemplateObject(["Parts"], ["Parts"])))
            }
                ...
                <components_1.New label={t(templateObject_29 || (templateObject_29 = __makeTemplateObject(["Part"], ["Part"])))} to={path_1.path.to.newPart}/>
              </div>)} renderActions={renderActions} renderContextMenu={renderContextMenu} getRowHref={function (row) {
            return row.id ? path_1.path.to.partDetails(row.id) : undefined;
        }} title={t(templateObject_30 || (templateObject_30 = __makeTemplateObject(["Parts"], ["Parts"])))} table="part" withSavedView withSelectableRows/>
        {selectedItem && selectedItem.id && (<Modals_1.ConfirmDelete action={path_1.path.to.deleteItem(selectedItem.id)} isOpen={deleteItemModal.isOpen} name={selectedItem.readableIdWithRevision} text={t(templateObject_31 || (templateObject_31 = __makeTemplateObject(["Are you sure you want to delete ", "? This cannot be undone."], ["Are you sure you want to delete ", "? This cannot be undone."])), selectedItem.readableIdWithRevision)} onCancel={function () {
