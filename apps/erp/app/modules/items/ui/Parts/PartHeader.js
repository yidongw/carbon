...
var usePartNavigation_1 = require("./usePartNavigation");
function PartTopbarLeft(_a) {
    var _b, _c;
    ...
    var readableId = (_c = (_b = routeData === null || routeData === void 0 ? void 0 : routeData.partSummary) === null || _b === void 0 ? void 0 : _b.readableIdWithRevision) !== null && _c !== void 0 ? _c : "";
    return (<>
      <Layout_1.DetailTopbarContent>
        <Layout_1.DetailTopbarId to={path_1.path.to.partDetails(itemId)}>
          {readableId}
...
var PartHeader = function () {
    var t = (0, macro_1.useLingui)().t;
    var links = (0, usePartNavigation_1.usePartNavigation)();
    ...
    return (<>
      {leftSlotEl &&
            (0, react_dom_1.createPortal)(<PartTopbarLeft itemId={itemId}/>, leftSlotEl)}
