...
var MaterialsTable = (0, react_2.memo)(function (_a) {
    var _b, _c;
    ...
    var customColumns = (0, useCustomColumns_1.useCustomColumns)("material");
    ...
    var columns = (0, react_2.useMemo)(function () {
        var defaultColumns = [
            {
                accessorKey: "id",
                header: t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Material ID"], ["Material ID"]))),
                cell: function (_a) {
                    var row = _a.row;
                    return (<react_1.HStack className="py-1 min-w-[200px] truncate">
            <components_1.ItemThumbnail size="md" thumbnailPath={row.original.thumbnailPath} type="Material"/>
            <components_1.Hyperlink to={path_1.path.to.material(row.original.id)}>
            ...
            },
            {
                ...
                header: t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Substance"], ["Substance"]))),
                cell: function (_a) {
                    var row = _a.row;
                    return (<Enumerable_1.Enumerable value={row.original.materialSubstance}/>);
                },
                meta: {
                    filter: {
                        type: "fetcher",
                        endpoint: path_1.path.to.api.materialSubstances,
            ...
            },
            {
                ...
                header: t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Shape"], ["Shape"]))),
                cell: function (_a) {
                    var row = _a.row;
                    return <Enumerable_1.Enumerable value={row.original.materialForm}/>;
                },
                meta: {
                    filter: {
                        type: "fetcher",
                        endpoint: path_1.path.to.api.materialForms,
                        transform: function (data) {
                            var _a;
                            return (_a = data === null || data === void 0 ? void 0 : data.map(function (_a) {
                                var id = _a.id, name = _a.name;
            ...
            {
                accessorKey: "finish",
                header: t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Finish"], ["Finish"]))),
            ...
            {
                accessorKey: "grade",
                header: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Grade"], ["Grade"]))),
                cell: function (item) { return item.getValue(); },
                meta: {
                    icon: <lu_1.LuStar />,
                    filter: {
            ...
            },
            {
                ...
                header: t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Dimension"], ["Dimension"]))),
                cell: function (item) { return item.getValue(); },
                meta: {
                    icon: <lu_1.LuExpand />,
                    filter: {
            ...
            },
            {
                ...
                header: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Item Group"], ["Item Group"]))),
            ...
            },
            {
                ...
                header: t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Tracking"], ["Tracking"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "enum",
            ...
            },
            {
                ...
                header: t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Unit of Measure"], ["Unit of Measure"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "picker",
                    field: "unitOfMeasureCode",
                    update: ITEM_UPDATE,
                    value: function (r) { return r.unitOfMeasureCode; },
                    options: unitsOfMeasure.map(function (u) { return ({
                        value: u.value,
                        label: u.label
                    }); }),
                    fallbackLabel: function (r) { return r.unitOfMeasure; }
                }),
                meta: {
                    filter: {
                        type: "static",
                        options: unitsOfMeasure.map(function (unit) { return ({
                            value: unit.value,
                            label: <Enumerable_1.Enumerable value={unit.label}/>
                        }); })
                    },
                    icon: <lu_1.LuRuler />
                }
            },
            {
                ...
                header: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Default Method"], ["Default Method"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "enum",
            ...
            },
            {
                ...
                cell: function (_a) {
                    var row = _a.row;
                    return (<InlineEditor_1.TagsCell row={row.original} table="material" availableTags={tags}/>);
                },
                meta: {
                    filter: {
                        type: "static",
            ...
            {
                accessorKey: "active",
                header: t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Active"], ["Active"]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "boolean",
                    field: "active",
                    update: ITEM_UPDATE,
                ...
                meta: {
                    filter: {
                        type: "static",
                        options: [
                            { value: "true", label: t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Active"], ["Active"]))) },
                            { value: "false", label: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Inactive"], ["Inactive"]))) }
                        ]
                    },
                    pluralHeader: t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Active Statuses"], ["Active Statuses"]))),
                    icon: <lu_1.LuCheck />
                }
            },
            {
                id: "createdBy",
                header: t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Created By"], ["Created By"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Created At"], ["Created At"]))),
            ...
            {
                id: "updatedBy",
                header: t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Updated By"], ["Updated By"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_28 || (templateObject_28 = __makeTemplateObject(["Updated At"], ["Updated At"]))),
                cell: function (item) { return formatDate(item.getValue()); },
                meta: {
                    icon: <lu_1.LuCalendar />
                }
    ...
    var renderContextMenu = (0, react_2.useMemo)(function () {
        return function (row) {
            ...
            return (<>
          <react_1.MenuItem onClick={function () { return navigate(path_1.path.to.material(row.id)); }}>
            <react_1.MenuIcon icon={<lu_1.LuPencil />}/>
            <macro_1.Trans>Edit Material</macro_1.Trans>
          </react_1.MenuItem>
          {revisions && revisions.length > 1 && (<react_1.MenuSub>
              ...
              <react_1.MenuSubContent>
                {revisions.map(function (revision) { return (<react_1.MenuItem key={revision.id} onClick={function () { return navigate(path_1.path.to.material(revision.id)); }}>
                    <react_1.MenuIcon icon={<lu_1.LuTag />}/>
                    <macro_1.Trans>Revision {revision.revision}</macro_1.Trans>
                  </react_1.MenuItem>); })}
              </react_1.MenuSubContent>
            </react_1.MenuSub>)}
    ...
    return (<>
      <components_1.Table count={count} columns={columns} data={data} defaultColumnPinning={{
            ...
            {
                table: "material",
                label: t(templateObject_29 || (templateObject_29 = __makeTemplateObject(["Materials"], ["Materials"])))
            }
              ...
              <components_1.New label={t(templateObject_30 || (templateObject_30 = __makeTemplateObject(["Material"], ["Material"])))} to={path_1.path.to.newMaterial}/>
            </div>)} renderActions={renderActions} renderContextMenu={renderContextMenu} title={t(templateObject_31 || (templateObject_31 = __makeTemplateObject(["Materials"], ["Materials"])))} table="material" withSavedView withSelectableRows/>
      {selectedItem && selectedItem.id && (<Modals_1.ConfirmDelete action={path_1.path.to.deleteItem(selectedItem.id)} isOpen={deleteItemModal.isOpen} name={selectedItem.readableIdWithRevision} text={t(templateObject_32 || (templateObject_32 = __makeTemplateObject(["Are you sure you want to delete ", "? This cannot be undone."], ["Are you sure you want to delete ", "? This cannot be undone."])), selectedItem.readableIdWithRevision)} onCancel={function () {
...
exports.default = MaterialsTable;
