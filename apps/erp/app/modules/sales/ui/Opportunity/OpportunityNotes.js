...
var OpportunityNotes = function (_a) {
    var id = _a.id, table = _a.table, title = _a.title, isReadOnlyProp = _a.isReadOnly, initialInternalNotes = _a.internalNotes, initialExternalNotes = _a.externalNotes;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileName = "".concat(companyId, "/opportunity/").concat(id, "/").concat((0, nanoid_1.nanoid)(), ".").concat(fileType);
...
exports.default = OpportunityNotes;
