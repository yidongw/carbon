...
var OpportunityLineNotes = function (_a) {
    var id = _a.id, table = _a.table, title = _a.title, subTitle = _a.subTitle, isReadOnlyProp = _a.isReadOnly, initialInternalNotes = _a.internalNotes, initialExternalNotes = _a.externalNotes;
    var _b = (0, hooks_1.useUser)(), userId = _b.id, companyId = _b.company.id;
    var carbon = (0, auth_1.useCarbon)().carbon;
    var permissions = (0, hooks_1.usePermissions)();
    var isEmployee = permissions.is("employee");
    var t = (0, macro_1.useLingui)().t;
    var canEdit = !isReadOnlyProp && permissions.can("update", "sales");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileName = "".concat(companyId, "/opportunity-line/").concat(id, "/").concat((0, nanoid_1.nanoid)(), ".").concat(fileType);
        ...
        <react_1.Tabs value={tab} onValueChange={setTab}>
          ...
          <react_1.CardContent>
            <react_1.TabsContent value="internal">
              {canEdit ? (<Editor_1.Editor initialValue={(internalNotes !== null && internalNotes !== void 0 ? internalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
            ...
            <react_1.TabsContent value="external">
              {canEdit ? (<Editor_1.Editor initialValue={(externalNotes !== null && externalNotes !== void 0 ? externalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
...
exports.default = OpportunityLineNotes;
