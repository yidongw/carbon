...
var NoQuoteReasonForm = function (_a) {
    ...
    (0, react_2.useEffect)(function () {
        ...
        if (fetcher.state === "loading" && ((_a = fetcher.data) === null || _a === void 0 ? void 0 : _a.data)) {
            ...
            react_1.toast.success(t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Created no quote reason"], ["Created no quote reason"]))));
        }
        else if (fetcher.state === "idle" && ((_b = fetcher.data) === null || _b === void 0 ? void 0 : _b.error)) {
            react_1.toast.error(t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Failed to create no quote reason: ", ""], ["Failed to create no quote reason: ", ""])), fetcher.data.error.message));
        }
    ...
    return (<react_1.ModalDrawerProvider type={type}>
      <react_1.ModalDrawer open={open} onOpenChange={function (open) {
        ...
        <react_1.ModalDrawerContent>
          <form_1.ValidatedForm validator={sales_models_1.noQuoteReasonValidator} method="post" action={isEditing
            ? path_1.path.to.noQuoteReason(initialValues.id)
            : path_1.path.to.newNoQuoteReason} defaultValues={initialValues} fetcher={fetcher} className="flex flex-col h-full">
            ...
            <react_1.ModalDrawerBody>
              ...
              <react_1.VStack spacing={4}>
                <Form_1.Input name="name" label={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["No Quote Reason"], ["No Quote Reason"])))}/>
                <Form_1.CustomFormFields table="noQuoteReason"/>
              </react_1.VStack>
            </react_1.ModalDrawerBody>
...
exports.default = NoQuoteReasonForm;
