...
var CustomerTaxForm = function (_a) {
    var _b, _c;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    uploadToast = (0, upload_1.createUploadToast)({
                        id: "customer-tax-".concat(fileName, "-").concat(file.name),
    ...
    return (<form_1.ValidatedForm method="post" validator={sales_models_1.customerTaxValidator} defaultValues={initialValues}>
      <react_1.Card>
        <react_1.CardHeader>
        ...
        <react_1.CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-4 w-full">
            ...
            <div className="col-span-3">
              <Form_1.Boolean name="taxExempt" label="Tax Exempt" onChange={function (value) { return setTaxExempt(value); }}/>
            </div>
            {taxExempt && (<>
...
exports.default = CustomerTaxForm;
