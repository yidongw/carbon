...
var CustomerLocationForm = function (_a) {
    ...
    return (<react_1.ModalDrawerProvider type={type}>
      <react_1.ModalDrawer open={open} onOpenChange={function (open) {
        ...
        <react_1.ModalDrawerContent>
          <form_1.ValidatedForm validator={sales_models_1.customerLocationValidator} method="post" action={isEditing
            ? path_1.path.to.customerLocation(customerId, initialValues.id)
            : path_1.path.to.newCustomerLocation(customerId)} defaultValues={initialValues} fetcher={fetcher} onSubmit={function () {
            if (type === "modal") {
                onClose === null || onClose === void 0 ? void 0 : onClose();
            }
            ...
            <react_1.ModalDrawerBody>
              ...
              <react_1.VStack spacing={4}>
                ...
                <Form_1.AddressAutocomplete />
                <Form_1.CustomFormFields table="customerLocation"/>
              </react_1.VStack>
            </react_1.ModalDrawerBody>
...
exports.default = CustomerLocationForm;
