...
var SalesRFQProperties = function () {
    ...
    return (<react_1.VStack spacing={4} className="w-full min-w-0 bg-card h-full overflow-y-auto overflow-x-hidden overscroll-contain scrollbar-thin scrollbar-track-transparent scrollbar-thumb-accent px-4 py-2 text-sm">
      <react_1.VStack spacing={4}>
        <react_1.HStack className="w-full justify-between">
          ...
          <react_1.HStack spacing={1}>
            ...
            return (0, string_1.copyToClipboard)(window.location.origin + path_1.path.to.salesRfqDetails(rfqId));
        }}>
        ...
        <span className="text-sm">{(_c = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _c === void 0 ? void 0 : _c.rfqId}</span>
      </react_1.VStack>

      <components_1.Assignee id={rfqId} table="salesRfq" value={assignee !== null && assignee !== void 0 ? assignee : ""} variant="inline" isReadOnly={!canUpdate}/>

      <form_1.ValidatedForm defaultValues={{ customerId: (_d = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _d === void 0 ? void 0 : _d.customerId }} validator={zod_1.z.object({
      ...
      <form_1.ValidatedForm defaultValues={{
            customerReference: (_f = (_e = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _e === void 0 ? void 0 : _e.customerReference) !== null && _f !== void 0 ? _f : undefined
        }} validator={zod_1.z.object({
            customerReference: zod_form_data_1.zfd.text(zod_1.z.string().optional())
        })} className="w-full">
        <form_1.InputControlled name="customerReference" label={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Customer RFQ"], ["Customer RFQ"])))} value={(_h = (_g = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _g === void 0 ? void 0 : _g.customerReference) !== null && _h !== void 0 ? _h : ""} size="sm" inline isReadOnly={isDisabled} onBlur={function (e) {
            onUpdate("customerReference", e.target.value);
        }}/>
      </form_1.ValidatedForm>

      <form_1.ValidatedForm defaultValues={{
            customerLocationId: (_k = (_j = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _j === void 0 ? void 0 : _j.customerLocationId) !== null && _k !== void 0 ? _k : ""
        }} validator={zod_1.z.object({
            customerLocationId: zod_form_data_1.zfd.text(zod_1.z.string().optional())
        })} className="w-full">
        <Form_1.CustomerLocation name="customerLocationId" customer={(_m = (_l = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _l === void 0 ? void 0 : _l.customerId) !== null && _m !== void 0 ? _m : ""} inline isReadOnly={isDisabled} onChange={function (customerLocation) {
      ...
      <form_1.ValidatedForm defaultValues={{
            customerContactId: (_p = (_o = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _o === void 0 ? void 0 : _o.customerContactId) !== null && _p !== void 0 ? _p : ""
        }} validator={zod_1.z.object({
            customerContactId: zod_form_data_1.zfd.text(zod_1.z.string().optional())
        })} className="w-full">
        <Form_1.CustomerContact name="customerContactId" customer={(_r = (_q = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _q === void 0 ? void 0 : _q.customerId) !== null && _r !== void 0 ? _r : ""} inline label={t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Purchasing Contact"], ["Purchasing Contact"])))} isReadOnly={isDisabled} onChange={function (customerContact) {
      ...
      <form_1.ValidatedForm defaultValues={{
            customerEngineeringContactId: (_t = (_s = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _s === void 0 ? void 0 : _s.customerEngineeringContactId) !== null && _t !== void 0 ? _t : ""
        }} validator={zod_1.z.object({
            customerEngineeringContactId: zod_form_data_1.zfd.text(zod_1.z.string().optional())
        })} className="w-full">
        <Form_1.CustomerContact name="customerEngineeringContactId" customer={(_v = (_u = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _u === void 0 ? void 0 : _u.customerId) !== null && _v !== void 0 ? _v : ""} inline label={t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Engineering Contact"], ["Engineering Contact"])))} isReadOnly={isDisabled} onChange={function (customerEngineeringContact) {
      ...
      <form_1.ValidatedForm defaultValues={{
            rfqDate: (_x = (_w = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _w === void 0 ? void 0 : _w.rfqDate) !== null && _x !== void 0 ? _x : ""
        }} validator={zod_1.z.object({
            rfqDate: zod_1.z.string().min(1, { message: "RFQ Date is required" })
        })} className="w-full">
        <form_1.DatePicker name="rfqDate" label={t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["RFQ Date"], ["RFQ Date"])))} inline onChange={function (date) {
            onUpdate("rfqDate", date);
        }}/>
      </form_1.ValidatedForm>

      <form_1.ValidatedForm defaultValues={{
            expirationDate: (_z = (_y = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _y === void 0 ? void 0 : _y.expirationDate) !== null && _z !== void 0 ? _z : ""
        }} validator={zod_1.z.object({
            expirationDate: zod_form_data_1.zfd.text(zod_1.z.string().optional())
        })} className="w-full">
        <form_1.DatePicker name="expirationDate" label={t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Expiration Date"], ["Expiration Date"])))} inline onChange={function (date) {
            onUpdate("expirationDate", date);
        }}/>
      </form_1.ValidatedForm>

      <form_1.ValidatedForm defaultValues={{ locationId: (_0 = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _0 === void 0 ? void 0 : _0.locationId }} validator={zod_1.z.object({
            locationId: zod_1.z.string().min(1, { message: "Location is required" })
        })} className="w-full">
        <Form_1.Location label={t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["RFQ Location"], ["RFQ Location"])))} name="locationId" inline isReadOnly={isDisabled} onChange={function (value) {
            if (value === null || value === void 0 ? void 0 : value.value) {
      ...
      <form_1.ValidatedForm defaultValues={{ salesPersonId: (_1 = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _1 === void 0 ? void 0 : _1.salesPersonId }} validator={zod_1.z.object({
            salesPersonId: zod_1.z
                .string()
      ...
      <CustomFormInlineFields_1.default customFields={((_3 = (_2 = routeData === null || routeData === void 0 ? void 0 : routeData.rfqSummary) === null || _2 === void 0 ? void 0 : _2.customFields) !== null && _3 !== void 0 ? _3 : {})} table="salesRfq" tags={[]} onUpdate={onUpdateCustomFields}/>
    </react_1.VStack>);
};
exports.default = SalesRFQProperties;
