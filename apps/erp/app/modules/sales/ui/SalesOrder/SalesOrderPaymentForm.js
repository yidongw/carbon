...
var SalesOrderPaymentForm = function (_a) {
    var _b;
    ...
    var isDisabled = !permissions.can("update", "sales") || isLocked;
    return (<react_1.Card>
      <form_1.ValidatedForm method="post" action={path_1.path.to.salesOrderPayment(initialValues.id)} validator={sales_models_1.salesOrderPaymentValidator} defaultValues={initialValues} fetcher={fetcher} isDisabled={isLocked}>
        <react_1.CardHeader>
          <react_1.CardTitle>
...
exports.default = SalesOrderPaymentForm;
