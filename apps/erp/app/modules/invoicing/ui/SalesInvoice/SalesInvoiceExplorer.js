...
exports.default = SalesInvoiceExplorer;
...
var DeleteSalesInvoiceLine_1 = require("./DeleteSalesInvoiceLine");
var SalesInvoiceLineForm_1 = require("./SalesInvoiceLineForm");
function SalesInvoiceExplorer() {
    ...
    var salesInvoiceData = (0, hooks_1.useRouteData)(path_1.path.to.salesInvoice(invoiceId));
    var permissions = (0, hooks_1.usePermissions)();
    var salesInvoiceLineInitialValues = {
        invoiceId: invoiceId,
        invoiceLineType: "Item",
        quantity: 1,
        locationId: (_c = (_b = (_a = salesInvoiceData === null || salesInvoiceData === void 0 ? void 0 : salesInvoiceData.salesInvoice) === null || _a === void 0 ? void 0 : _a.locationId) !== null && _b !== void 0 ? _b : defaults.locationId) !== null && _c !== void 0 ? _c : "",
        unitOfMeasureCode: "",
        taxPercent: 0,
        unitPrice: 0,
        shippingCost: 0,
        ...
        taxAmount: 0,
        exchangeRate: (_e = (_d = salesInvoiceData === null || salesInvoiceData === void 0 ? void 0 : salesInvoiceData.salesInvoice) === null || _d === void 0 ? void 0 : _d.exchangeRate) !== null && _e !== void 0 ? _e : 1
    };
    var newSalesInvoiceLineDisclosure = (0, react_1.useDisclosure)();
    var deleteLineDisclosure = (0, react_1.useDisclosure)();
    var _j = (0, react_2.useState)(null), deleteLine = _j[0], setDeleteLine = _j[1];
    var isLocked = (0, invoicing_models_1.isSalesInvoiceLocked)((_f = salesInvoiceData === null || salesInvoiceData === void 0 ? void 0 : salesInvoiceData.salesInvoice) === null || _f === void 0 ? void 0 : _f.status);
    var isDisabled = isLocked
        ? true
        : ((_g = salesInvoiceData === null || salesInvoiceData === void 0 ? void 0 : salesInvoiceData.salesInvoice) === null || _g === void 0 ? void 0 : _g.status) !== "Draft";
    ...
    var lines = (_h = salesInvoiceData === null || salesInvoiceData === void 0 ? void 0 : salesInvoiceData.salesInvoiceLines) !== null && _h !== void 0 ? _h : [];
    ...
    var editMode = (0, LineReorder_1.useLineOrderEditMode)({
        actionPath: path_1.path.to.salesInvoiceLineOrder(invoiceId),
        lines: lines
    });
    return (<>
      <react_1.VStack className="w-full h-[calc(100dvh-99px)] justify-between">
        <react_1.VStack className="flex-1 overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-accent" spacing={0}>
          {lines.length > 0 ? (editMode.isEditing ? (<LineReorder_1.ReorderableLineList lines={editMode.draft} activeLine={editMode.activeLine} onDragStart={editMode.handleDragStart} onDragEnd={editMode.handleDragEnd} renderRow={function (line, dragHandle) { return (<SalesInvoiceLineBody line={line} dragHandle={dragHandle}/>); }} renderOverlay={function (line) { return (<SalesInvoiceLineBody line={line} isOverlay/>); }}/>) : (lines.map(function (line) { return (<SalesInvoiceLineItem key={line.id} isDisabled={isDisabled} line={line} onDelete={onDeleteLine}/>); }))) : (<components_1.Empty>
              {permissions.can("update", "sales") && (<react_1.Button isDisabled={isDisabled} leftIcon={<lu_1.LuCirclePlus />} variant="secondary" onClick={newSalesInvoiceLineDisclosure.onOpen}>
          ...
          {editMode.isEditing ? (<LineReorder_1.ReorderEditBar isSaving={editMode.isSaving} isDirty={editMode.isDirty} onSave={editMode.save} onCancel={editMode.cancelEditMode}/>) : (<>
              <react_1.Tooltip>
                <react_1.TooltipTrigger className="flex-1">
                  <react_1.Button ref={newButtonRef} className="w-full" isDisabled={isDisabled || !permissions.can("update", "sales")} leftIcon={<lu_1.LuCirclePlus />} variant="secondary" onClick={newSalesInvoiceLineDisclosure.onOpen}>
                    <macro_1.Trans>Add Line Item</macro_1.Trans>
                  </react_1.Button>
      ...
      {newSalesInvoiceLineDisclosure.isOpen && (<SalesInvoiceLineForm_1.default 
        // @ts-ignore
        initialValues={salesInvoiceLineInitialValues} type="modal" onClose={newSalesInvoiceLineDisclosure.onClose}/>)}
      {deleteLineDisclosure.isOpen && (<DeleteSalesInvoiceLine_1.default line={deleteLine} onCancel={onDeleteCancel}/>)}
    </>);
}
function SalesInvoiceLineBody(_a) {
    var _b;
      ...
      <react_1.HStack spacing={2} className="flex-grow min-w-0 p-2 pr-10">
        ...
        <react_1.VStack spacing={0} className="min-w-0">
          <span className="font-semibold line-clamp-1">
            {(_b = (0, utils_1.getItemReadableId)(items, line.itemId)) !== null && _b !== void 0 ? _b : ""}
          </span>
...
function SalesInvoiceLineItem(_a) {
    var _b, _c;
    ...
    var isSelected = location.pathname === path_1.path.to.salesInvoiceLine(invoiceId, line.id);
    return (<react_1.VStack spacing={0} className="border-b">
      <react_router_1.Link to={path_1.path.to.salesInvoiceLine(invoiceId, line.id)} prefetch="intent" className="w-full">
        <react_1.HStack className={(0, react_1.cn)("group w-full p-2 items-center hover:bg-accent/30 cursor-pointer relative", "border-b border-border", isSelected && "bg-accent/60 hover:bg-accent/50")}>
          ...
          <div className="absolute right-2">
            ...
            onDelete(line);
                ...
                {/* @ts-expect-error */}
                {shared_1.methodItemType.includes((_c = line.invoiceLineType) !== null && _c !== void 0 ? _c : "") && (<react_1.DropdownMenuItem asChild onClick={function (e) { return e.stopPropagation(); }}>
