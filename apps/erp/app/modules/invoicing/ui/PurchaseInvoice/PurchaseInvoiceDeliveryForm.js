...
var PurchaseInvoiceDeliveryForm = (0, react_2.forwardRef)(function (_a, ref) {
    var _b;
    ...
    var isEditable = !(0, invoicing_1.isPurchaseInvoiceLocked)((_b = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _b === void 0 ? void 0 : _b.status);
    ...
    return (<react_1.Card ref={cardRef} isCollapsible defaultCollapsed={defaultCollapsed} isCollapsed={isCollapsed} onCollapsedChange={setIsCollapsed}>
      <form_1.ValidatedForm method="post" action={path_1.path.to.purchaseInvoiceDelivery(invoiceId)} validator={invoicing_1.purchaseInvoiceDeliveryValidator} defaultValues={initialValues} fetcher={fetcher} isDisabled={!isEditable}>
        <react_1.CardHeader>
          <react_1.CardTitle>
        ...
        <react_1.CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-4 w-full">
            ...
            <Form_1.CustomFormFields table="purchaseInvoiceDelivery"/>
          </div>
        </react_1.CardContent>
        <react_1.CardFooter>
          <Form_1.Submit isDisabled={!permissions.can("update", "invoicing")}>
...
exports.default = PurchaseInvoiceDeliveryForm;
