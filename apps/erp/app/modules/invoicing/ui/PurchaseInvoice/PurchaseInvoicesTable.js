...
var PURCHASE_INVOICE_UPDATE = {
    action: path_1.path.to.bulkUpdatePurchaseInvoice,
    idKey: "ids"
};
var PurchaseInvoicesTable = (0, react_2.memo)(function (_a) {
    var data = _a.data, count = _a.count;
    (0, hooks_1.useRealtime)("purchaseInvoice", "id=in.(".concat(data.map(function (d) { return d.id; }).join(","), ")"));
    var t = (0, macro_1.useLingui)().t;
    var permissions = (0, hooks_1.usePermissions)();
    var navigate = (0, react_router_1.useNavigate)();
    var currencyFormatter = (0, hooks_1.useCurrencyFormatter)();
    var formatDate = (0, hooks_1.useDateFormatter)().formatDate;
    var _b = (0, react_2.useState)(null), selectedPurchaseInvoice = _b[0], setSelectedPurchaseInvoice = _b[1];
    var closePurchaseInvoiceModal = (0, react_1.useDisclosure)();
    ...
    var customColumns = (0, useCustomColumns_1.useCustomColumns)("purchaseInvoice");
        ...
        var defaultColumns = [
            {
              ...
              <components_1.Hyperlink to={path_1.path.to.purchaseInvoiceDetails(row.original.id)}>
            ...
            },
            {
                ...
                header: t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Invoice Supplier"], ["Invoice Supplier"]))),
                cell: function (_a) {
                    var row = _a.row;
                    return (<components_1.SupplierAvatar supplierId={row.original.invoiceSupplierId}/>);
                },
                meta: {
                    filter: {
                        type: "static",
            ...
            },
            {
                ...
                header: t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Supplier Ref."], ["Supplier Ref."]))),
                cell: (0, InlineEditor_1.editableCell)({
                    kind: "text",
            ...
            },
            {
                ...
                cell: function (item) {
                    ...
                    return <invoicing_1.PurchaseInvoicingStatus status={status}/>;
                },
                meta: {
                    filter: {
                        type: "static",
                        options: invoicing_1.purchaseInvoiceStatusType.map(function (status) { return ({
                            value: status,
                            label: <invoicing_1.PurchaseInvoicingStatus status={status}/>
                        }); })
                    },
            ...
            },
            {
                ...
                header: t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Order Total"], ["Order Total"]))),
            ...
            },
            {
                ...
                cell: function (_a) {
                    var _b, _c;
                    var row = _a.row;
                    return (<components_1.Assignee id={(_b = row.original.id) !== null && _b !== void 0 ? _b : ""} table="purchaseInvoice" value={(_c = row.original.assignee) !== null && _c !== void 0 ? _c : ""} variant="button" size="sm"/>);
                },
                meta: {
                    filter: {
                        type: "static",
    ...
    var renderContextMenu = (0, react_2.useMemo)(function () {
        return function (row) { return (<>
          <react_1.MenuItem disabled={!permissions.can("view", "invoicing")} onClick={function () { return navigate(path_1.path.to.purchaseInvoice(row.id)); }}>
    ...
    return (<>
        <components_1.Table count={count} columns={columns} data={data} defaultColumnPinning={{
            ...
            updatedAt: false,
            updatedBy: false
        }} primaryAction={permissions.can("create", "invoicing") && (<components_1.New label={t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Purchase Invoice"], ["Purchase Invoice"])))} to={path_1.path.to.newPurchaseInvoice}/>)} renderContextMenu={renderContextMenu} title={t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Purchase Invoices"], ["Purchase Invoices"])))} table="purchaseInvoice" withSavedView/>

        {selectedPurchaseInvoice && selectedPurchaseInvoice.id && (<Modals_1.ConfirmDelete action={path_1.path.to.deletePurchaseInvoice(selectedPurchaseInvoice.id)} isOpen={closePurchaseInvoiceModal.isOpen} name={selectedPurchaseInvoice.invoiceId} text={t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Are you sure you want to permanently delete ", "?"], ["Are you sure you want to permanently delete ", "?"])), selectedPurchaseInvoice.invoiceId)} onCancel={function () {
...
exports.default = PurchaseInvoicesTable;
