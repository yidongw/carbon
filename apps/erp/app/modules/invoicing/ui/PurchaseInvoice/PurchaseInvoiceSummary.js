...
var LineItems = function (_a) {
    var currencyCode = _a.currencyCode, presentationCurrencyFormatter = _a.presentationCurrencyFormatter, formatter = _a.formatter, locale = _a.locale, purchaseInvoiceLines = _a.purchaseInvoiceLines, shouldConvertCurrency = _a.shouldConvertCurrency;
    ...
    return (<react_1.VStack spacing={8} className="w-full overflow-hidden">
      {purchaseInvoiceLines.map(function (line) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1;
            if (!line.id)
                return null;
            var isGlAccount = line.invoiceLineType === "G/L Account";
            var isFixedAsset = line.invoiceLineType === "Fixed Asset";
            ...
            var lineTotal = ((_a = line.unitPrice) !== null && _a !== void 0 ? _a : 0) * ((_b = line.quantity) !== null && _b !== void 0 ? _b : 0);
            var supplierLineTotal = ((_c = line.supplierUnitPrice) !== null && _c !== void 0 ? _c : 0) * ((_d = line.quantity) !== null && _d !== void 0 ? _d : 0);
                    ...
                    <react_1.VStack spacing={0} className="flex-shrink-0 min-w-0 w-auto">
                      <react_1.HStack spacing={2} className="flex min-w-0 flex-shrink-0">
                        ...
                        <react_1.Button asChild variant="link" size="sm" className="text-muted-foreground flex-shrink-0">
                          <react_router_1.Link to={path_1.path.to.purchaseInvoiceLine(invoiceId, line.id)}>
                ...
                type={(_l = line.methodType) !== null && _l !== void 0 ? _l : "Pull from Inventory"}/>
                    ...
                    return uom.value === line.purchaseUnitOfMeasureCode;
                        ...
                        {((_p = line.taxPercent) !== null && _p !== void 0 ? _p : 0) > 0 ? (<react_1.Badge variant="red">
                            <macro_1.Trans>
                              {percentFormatter.format((_q = line.taxPercent) !== null && _q !== void 0 ? _q : 0)}{" "}
                              Tax
                            </macro_1.Trans>
                          </react_1.Badge>) : null}
                      </div>
                  ...
                  <react_1.Tbody>
                    ...
                    return uom.value === line.purchaseUnitOfMeasureCode;
                          ...
                          {line.conversionFactor !== 1 && (<span className="text-muted-foreground text-xs">
                              {((_s = line.quantity) !== null && _s !== void 0 ? _s : 0) *
                    ...
                    <react_1.Tr>
                      ...
                      <react_1.Td className="text-right">
                        <react_1.VStack spacing={0}>
                          <span>
                            {formatter.format((_x = line.shippingCost) !== null && _x !== void 0 ? _x : 0)}
                          </span>
                          {shouldConvertCurrency && (<span className="text-muted-foreground text-xs">
                              {presentationCurrencyFormatter.format((_y = line.supplierShippingCost) !== null && _y !== void 0 ? _y : 0)}
                            </span>)}
                        </react_1.VStack>
                      </react_1.Td>
                    </react_1.Tr>
                    ...
                    <react_1.Tr key="tax" className="border-b border-border">
                      <react_1.Td>
                        <macro_1.Trans>
                          Tax ({percentFormatter.format((_z = line.taxPercent) !== null && _z !== void 0 ? _z : 0)})
                        </macro_1.Trans>
                      </react_1.Td>
                      <react_1.Td className="text-right">
                        <react_1.VStack spacing={0}>
                          <span>{formatter.format((_0 = line.taxAmount) !== null && _0 !== void 0 ? _0 : 0)}</span>
                          {shouldConvertCurrency && (<span className="text-muted-foreground text-xs">
                              {presentationCurrencyFormatter.format((_1 = line.supplierTaxAmount) !== null && _1 !== void 0 ? _1 : 0)}
                            </span>)}
                        </react_1.VStack>
                      </react_1.Td>
                    </react_1.Tr>
...
var PurchaseInvoiceSummary = function (_a) {
    ...
    var shouldConvertCurrency = ((_b = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _b === void 0 ? void 0 : _b.currencyCode) !== (company === null || company === void 0 ? void 0 : company.baseCurrencyCode);
    ...
    var presentationCurrencyFormatter = (0, hooks_1.useCurrencyFormatter)({
        currency: (_e = (_d = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _d === void 0 ? void 0 : _d.currencyCode) !== null && _e !== void 0 ? _e : "USD"
    });
    var isEditable = !(0, invoicing_models_1.isPurchaseInvoiceLocked)((_f = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _f === void 0 ? void 0 : _f.status);
    // Calculate totals
    var subtotal = (_h = (_g = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceLines) === null || _g === void 0 ? void 0 : _g.reduce(function (acc, line) {
        var _a, _b, _c;
        var lineTotal = ((_a = line.unitPrice) !== null && _a !== void 0 ? _a : 0) * ((_b = line.quantity) !== null && _b !== void 0 ? _b : 0) + ((_c = line.shippingCost) !== null && _c !== void 0 ? _c : 0);
        return acc + lineTotal;
    }, 0)) !== null && _h !== void 0 ? _h : 0;
    var supplierSubtotal = (_k = (_j = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceLines) === null || _j === void 0 ? void 0 : _j.reduce(function (acc, line) {
        var _a, _b, _c;
        var lineTotal = ((_a = line.supplierUnitPrice) !== null && _a !== void 0 ? _a : 0) * ((_b = line.quantity) !== null && _b !== void 0 ? _b : 0) +
            ((_c = line.supplierShippingCost) !== null && _c !== void 0 ? _c : 0);
        return acc + lineTotal;
    }, 0)) !== null && _k !== void 0 ? _k : 0;
    var tax = (_m = (_l = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceLines) === null || _l === void 0 ? void 0 : _l.reduce(function (acc, line) {
        var _a;
        return acc + ((_a = line.taxAmount) !== null && _a !== void 0 ? _a : 0);
    }, 0)) !== null && _m !== void 0 ? _m : 0;
    var supplierTax = (_p = (_o = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceLines) === null || _o === void 0 ? void 0 : _o.reduce(function (acc, line) {
        var _a;
        return acc + ((_a = line.supplierTaxAmount) !== null && _a !== void 0 ? _a : 0);
    }, 0)) !== null && _p !== void 0 ? _p : 0;
    var shippingCost = ((_r = (_q = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceDelivery) === null || _q === void 0 ? void 0 : _q.supplierShippingCost) !== null && _r !== void 0 ? _r : 0) *
        ((_t = (_s = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _s === void 0 ? void 0 : _s.exchangeRate) !== null && _t !== void 0 ? _t : 1);
    var supplierShippingCost = (_v = (_u = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoiceDelivery) === null || _u === void 0 ? void 0 : _u.supplierShippingCost) !== null && _v !== void 0 ? _v : 0;
      ...
      <react_1.CardHeader>
        <react_1.HStack className="justify-between items-center">
          <div className="flex flex-col gap-1">
            <react_1.CardTitle>{routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice.invoiceId}</react_1.CardTitle>
            <react_1.CardDescription>
              <macro_1.Trans>Purchase Invoice</macro_1.Trans>
            </react_1.CardDescription>
          </div>
          <div className="flex flex-col gap-1 items-end">
            <components_1.SupplierAvatar supplierId={(_w = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice.supplierId) !== null && _w !== void 0 ? _w : null}/>
            {((_x = routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice) === null || _x === void 0 ? void 0 : _x.dateDue) && (<span className="text-muted-foreground text-sm">
                <macro_1.Trans>
                  Due {formatDate(routeData === null || routeData === void 0 ? void 0 : routeData.purchaseInvoice.dateDue)}
                </macro_1.Trans>
              </span>)}
          </div>
        </react_1.HStack>
...
exports.default = PurchaseInvoiceSummary;
