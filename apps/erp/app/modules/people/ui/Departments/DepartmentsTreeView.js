...
exports.DepartmentsTreeView = DepartmentsTreeView;
var react_1 = require("@xyflow/react");
var react_2 = require("react");
require("@xyflow/react/dist/style.css");
var layout_utils_1 = require("~/modules/settings/ui/Companies/layout-utils");
var DepartmentNode_1 = require("./DepartmentNode");
var nodeTypes = {
    department: DepartmentNode_1.DepartmentNode
};
function DepartmentsTreeView(_a) {
    ...
    var _b = (0, react_2.useMemo)(function () {
        var nodes = departments.map(function (department) { return ({
            id: department.id,
            type: "department",
            position: { x: 0, y: 0 },
            draggable: false,
        ...
        var edges = departments
            .filter(function (d) { return d.parentDepartmentId !== null; })
            .map(function (department) { return ({
            id: "".concat(department.parentDepartmentId, "-").concat(department.id),
    ...
    }, [departments, onEdit, onDelete, onAddChild]), initialNodes = _b.initialNodes, initialEdges = _b.initialEdges;
