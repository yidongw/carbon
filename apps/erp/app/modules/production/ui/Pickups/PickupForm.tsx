...
export const PickupForm = ({
  ...
  const onDismiss = onDismissProp ?? (() => navigate(path.to.pickups));
  ...
  const { hasOperationSelected, hasActorSelected, areDetailFieldsDisabled } =
        ...
        <VStack spacing={4}>
          ...
          {hasConfigurationParameters ? (
            <QuantityWithConfigTable
              ...
              hasConfigurationParameters
              onOpenConfigTable={hasActorSelected ? openConfigTable : undefined}
