...
var JobMaterialForm = function (_a) {
    ...
    var _l = (0, react_router_1.useParams)(), jobId = _l.jobId, materialId = _l.materialId;
    if (!jobId)
        throw new Error("jobId not found");
    if (!materialId)
        throw new Error("materialId not found");
    var jobData = (0, hooks_1.useRouteData)(path_1.path.to.job(jobId));
    var _m = (0, react_2.useState)(initialValues.itemType), itemType = _m[0], setItemType = _m[1];
    var _o = (0, react_2.useState)({
    ...
    }), itemData = _o[0], setItemData = _o[1];
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all([
                            carbon
                                .from("item")
                                .select("name, readableIdWithRevision, type, unitOfMeasureCode, defaultMethodType, replenishmentSystem")
                                .eq("id", itemId)
                                .single(),
                            carbon.from("itemCost").select("unitCost").eq("itemId", itemId).single()
                        ])];
                case 1:
                    _a = _c.sent(), item = _a[0], itemCost = _a[1];
                    if (item.error) {
    ...
    var _p = (0, hooks_1.useUrlParams)(), setSearchParams = _p[1];
    // biome-ignore lint/correctness/useExhaustiveDependencies: suppressed due to migration
    (0, react_2.useEffect)(function () {
        var _a;
        var newPath = path_1.path.to.jobMakeMethod(jobId, initialValues.jobMakeMethodId);
    ...
    var isDisabled = (0, production_models_1.isJobLocked)((_h = jobData === null || jobData === void 0 ? void 0 : jobData.job) === null || _h === void 0 ? void 0 : _h.status);
    var items = (0, stores_1.useItems)()[0];
    var itemReadableId = (0, utils_1.getItemReadableId)(items, itemData.itemId);
    return (<react_1.Card>
      <form_1.ValidatedForm method="post" action={path_1.path.to.jobMaterial(jobId, initialValues === null || initialValues === void 0 ? void 0 : initialValues.id)} defaultValues={initialValues} fetcher={fetcher} validator={production_models_1.jobMaterialValidator}>
        <react_1.CardHeader>
        ...
        <react_1.CardContent>
          ...
          <react_1.VStack className="pt-4">
            <div className="grid w-full gap-x-8 gap-y-4 grid-cols-1 lg:grid-cols-3">
              <Form_1.Item name="itemId" label={itemType} type={itemType} includeInactive locationId={(_k = (_j = jobData === null || jobData === void 0 ? void 0 : jobData.job) === null || _j === void 0 ? void 0 : _j.locationId) !== null && _k !== void 0 ? _k : undefined} onChange={function (value) {
            ...
            setItemData(function (d) { return (__assign(__assign({}, d), { description: newValue })); });
              ...
              <Form_1.Select name="jobOperationId" label={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Operation"], ["Operation"])))} isClearable options={operations.map(function (o) { return ({
            value: o.id,
            label: o.description
        }); })}/>
              ...
              <Form_1.Number name="quantity" label={t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Quantity per Parent"], ["Quantity per Parent"])))}/>
        ...
        <react_1.CardFooter>
          <Form_1.Submit isDisabled={isDisabled || !permissions.can("update", "production")}>
            Save
          </Form_1.Submit>
        </react_1.CardFooter>
...
exports.default = JobMaterialForm;
