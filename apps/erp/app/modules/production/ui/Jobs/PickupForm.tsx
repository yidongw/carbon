...
const PickupForm = ({
  ...
  const seededFormJobId =
    jobIdProp?.trim() || initialValues.jobId?.trim() || "";

  const [, setActorKind] = useState<(typeof productionActorKinds)[number]>(
    () =>
    ...
    <>
      ...
      >
        ...
        <DrawerFooter>
          <HStack>
            <Submit
              isDisabled={isDisabled || quantity === 0 || !effectiveOperationId}
