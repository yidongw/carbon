...
var JobNotes = function (_a) {
    var id = _a.id, title = _a.title, subTitle = _a.subTitle, initialNotes = _a.notes, isReadOnlyProp = _a.isReadOnly;
    ...
    var onUpdateInternalNotes = (0, react_1.useDebounce)(function (content) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (carbon === null || carbon === void 0 ? void 0 : carbon.from("job").update({
                        notes: content,
    ...
    return (<>
      <react_1.Card>
        ...
        <react_1.CardContent>
          {!isReadOnlyProp && permissions.can("update", "production") ? (<Editor_1.Editor initialValue={(notes !== null && notes !== void 0 ? notes : {})} onUpload={onUploadImage} onChange={function (value) {
