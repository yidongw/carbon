...
import { SupplierQuantityReportReporter } from "./SupplierQuantityReportReporter";

export function SupplierQuantityReportCardHeader({
  supplierId,
  createdBy,
  summary,
  timestamp,
    ...
    <>
      <div className="flex flex-col gap-2 sm:hidden">
        <HStack className="items-center justify-between gap-2">
          <SupplierQuantityReportReporter
