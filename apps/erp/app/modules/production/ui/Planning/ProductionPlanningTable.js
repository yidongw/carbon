...
var ProductionPlanningOrderDrawer_1 = require("./ProductionPlanningOrderDrawer");
var ProductionPlanningTable = function (_a) {
    var _b;
    ...
    (0, react_2.useEffect)(function () {
        ...
        if (((_a = bulkUpdateFetcher.data) === null || _a === void 0 ? void 0 : _a.success) === false &&
            ((_b = bulkUpdateFetcher === null || bulkUpdateFetcher === void 0 ? void 0 : bulkUpdateFetcher.data) === null || _b === void 0 ? void 0 : _b.message)) {
    ...
    }, [(_b = bulkUpdateFetcher.data) === null || _b === void 0 ? void 0 : _b.success]);
    ...
    var onBulkUpdate = (0, react_2.useCallback)(function (selectedRows, action) {
        var payload = {
            ...
            items: selectedRows
                ...
                .map(function (row) {
                var ordersWithPeriods = (ordersMap[row.id] || []).map(function (order) {
                    var _a;
    ...
    var _e = (0, react_2.useState)(new Map()), ordersByItemId = _e[0], setOrdersByItemId = _e[1];
    ...
    (0, react_2.useEffect)(function () {
        startTransition(function () {
            ...
            data.forEach(function (item) {
                ordersByItemId.set(item.id, (0, ItemReorderPolicy_1.getProductionOrdersFromPlanning)(item, periods));
            });
    ...
    var columns = (0, react_2.useMemo)(function () {
        var periodColumns = periods.map(function (period, index) {
            ...
            return {
              ...
              <div>{isCurrentWeek ? "Present Week" : "Week ".concat(weekNumber)}</div>
        ...
        return __spreadArray(__spreadArray([
            {
                ...
                header: t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Part ID"], ["Part ID"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Reorder Policy"], ["Reorder Policy"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                header: t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["On Hand"], ["On Hand"]))),
                cell: function (_a) {
                    var row = _a.row;
        ...
        ], periodColumns, true), [
            {
                ...
                header: t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Qty to Order"], ["Qty to Order"]))),
                cell: function (_a) {
                    var row = _a.row;
                    var value = row.original.quantityToOrder;
                    if (value === undefined || value === 0)
                        return "-";
                    return (<span className="font-medium">{numberFormatter.format(value)}</span>);
                },
                meta: {
            ...
            {
                accessorKey: "type",
                header: t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Type"], ["Type"]))),
                cell: function (_a) {
                    var row = _a.row;
            ...
            },
            {
                ...
                cell: function (_a) {
                    ...
                    var isBlocked = row.original.manufacturingBlocked;
    ...
    return (<react_1.Loading isLoading={isPending}>
      <components_1.Table count={count} columns={columns} data={data} defaultColumnVisibility={defaultColumnVisibility} defaultColumnPinning={defaultColumnPinning} primaryAction={<div className="flex items-center gap-2">
          ...
          </div>} renderActions={renderActions} title={t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Planning"], ["Planning"])))} table="production-planning" withSavedView withSelectableRows/>

      {selectedItem && (<ProductionPlanningOrderDrawer_1.ProductionPlanningOrderDrawer locationId={locationId} row={selectedItem} orders={selectedItem.id
                ? ordersMap[selectedItem.id] ||
                    (0, ItemReorderPolicy_1.getProductionOrdersFromPlanning)(selectedItem, periods)
                : []} setOrders={setOrders} periods={periods} isOpen={!!selectedItem} onClose={function () { return setSelectedItem(null); }}/>)}
    </react_1.Loading>);
};
exports.default = ProductionPlanningTable;
function getLocationPath(locationId) {
    return "".concat(path_1.path.to.productionPlanning, "?location=").concat(locationId);
}
