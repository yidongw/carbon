...
describe("validateProductionQuantityLines", () => {
  it("accepts lines without variantQuantities", () => {
  ...
  it("rejects when variants quantity total does not match quantity", () => {
    const result = validateProductionQuantityLines([
      {
        type: "Production",
        quantity: 10,
  ...
  it("accepts multiple lines when each line variantQuantities matches its quantity", () => {
    const result = validateProductionQuantityLines([
      {
        type: "Production",
        quantity: 13,
