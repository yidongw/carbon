...
> Run the full Carbon stack locally with the crbn CLI, in isolated per-worktree environments.
...
Your local settings live in the generated `.env.local`. See `docs/platform/self-hosting/environment-variables` for the full configuration surface, and `docs/platform/self-hosting` to run Carbon on your own infrastructure.
