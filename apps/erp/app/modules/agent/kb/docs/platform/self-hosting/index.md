...
Self-hosted Carbon runs under **AGPLv3**: run a modified copy over a network and you have to publish your changes. Keeping modifications private, using Enterprise features, running in production without open-sourcing your changes, or offering Carbon as a hosted service requires a commercial license. See `docs/platform/licensing`.
