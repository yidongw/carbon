...
var ShipmentNotes = function (_a) {
    var id = _a.id, initialInternalNotes = _a.internalNotes, initialExternalNotes = _a.externalNotes;
    var _b = (0, hooks_1.useUser)(), userId = _b.id, companyId = _b.company.id;
    var carbon = (0, auth_1.useCarbon)().carbon;
    var t = (0, macro_1.useLingui)().t;
    var permissions = (0, hooks_1.usePermissions)();
    var _c = (0, react_2.useState)("internal"), tab = _c[0], setTab = _c[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileName = "".concat(companyId, "/inventory/").concat(id, "/").concat((0, nanoid_1.nanoid)(), ".").concat(fileType);
    ...
    var onUpdateExternalNotes = (0, react_1.useDebounce)(function (content) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (carbon === null || carbon === void 0 ? void 0 : carbon.from("shipment").update({
      ...
      <react_1.Card>
        <react_1.Tabs value={tab} onValueChange={setTab}>
          <react_1.HStack className="w-full justify-between">
            <react_1.CardHeader>
              <react_1.CardTitle>
                <macro_1.Trans>Shipping Notes</macro_1.Trans>
              </react_1.CardTitle>
              <react_1.CardDescription>
                {tab === "internal" ? t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Internal Notes"], ["Internal Notes"]))) : t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["External Notes"], ["External Notes"])))}
              </react_1.CardDescription>
            </react_1.CardHeader>
            <react_1.CardAction>
              <react_1.TabsList>
          ...
          <react_1.CardContent>
            <react_1.TabsContent value="internal">
              {permissions.can("update", "inventory") ? (<Editor_1.Editor initialValue={(internalNotes !== null && internalNotes !== void 0 ? internalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
            ...
            <react_1.TabsContent value="external">
              {permissions.can("update", "inventory") ? (<Editor_1.Editor initialValue={(externalNotes !== null && externalNotes !== void 0 ? externalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
