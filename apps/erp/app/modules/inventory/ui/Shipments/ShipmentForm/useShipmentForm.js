...
exports.default = useShipmentForm;
var auth_1 = require("@carbon/auth");
var react_1 = require("react");
var react_router_1 = require("react-router");
var hooks_1 = require("~/hooks");
function useShipmentForm(_a) {
    var _b, _c, _d, _e;
    ...
    var _h = (0, react_1.useState)((_d = initialValues.customerId) !== null && _d !== void 0 ? _d : null), customerId = _h[0], setCustomerId = _h[1];
    ...
    var _k = (0, react_1.useState)((_e = initialValues.sourceDocument) !== null && _e !== void 0 ? _e : "Sales Order"), sourceDocument = _k[0], setSourceDocument = _k[1];
    var fetchSourceDocuments = (0, react_1.useCallback)(function () {
        if (!carbon || !user.company.id)
            return;
        switch (sourceDocument) {
            case "Sales Order":
                carbon === null || carbon === void 0 ? void 0 : carbon.from("salesOrder").select("id, salesOrderId").eq("companyId", user.company.id).in("status", ["To Ship", "To Ship and Invoice", "Draft"]).then(function (response) {
                    if (response.error) {
            ...
            case "Outbound Transfer":
                carbon === null || carbon === void 0 ? void 0 : carbon.from("warehouseTransfer").select("id, transferId").eq("companyId", user.company.id).or("status.eq.To Ship and Receive, status.eq.To Ship").then(function (response) {
                    if (response.error) {
                        setError(response.error.message);
                    }
                    else {
