...
var ReceiptVoidModal = function (_a) {
    ...
    return (<react_1.Modal open={true} onOpenChange={function (open) {
      ...
      <react_1.ModalContent>
        <react_1.ModalHeader>
          <react_1.ModalTitle>
            <macro_1.Trans>Void Receipt</macro_1.Trans>
          </react_1.ModalTitle>
        ...
        <react_1.ModalBody>
          <react_1.Alert variant="destructive">
            ...
            <react_1.AlertDescription>
              <macro_1.Trans>Voiding this receipt will:</macro_1.Trans>
              <ul className="list-disc pl-4 mt-2 space-y-1">
                <li>
                  <macro_1.Trans>Reverse all inventory adjustments</macro_1.Trans>
                </li>
                <li>
                  <macro_1.Trans>Reverse the related journal entries</macro_1.Trans>
                </li>
                <li>
                  <macro_1.Trans>Restore tracked entities to available</macro_1.Trans>
                </li>
                <li>
        ...
        <react_1.ModalFooter>
          <react_1.HStack>
            ...
            <fetcher.Form action={path_1.path.to.receiptVoid(receiptId)} method="post" onSubmit={function () {
...
exports.default = ReceiptVoidModal;
