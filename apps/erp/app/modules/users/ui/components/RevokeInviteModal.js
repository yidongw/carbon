...
var RevokeInviteModal = function (_a) {
    ...
    return (<react_1.Modal open={isOpen} onOpenChange={function (open) {
      ...
      <react_1.ModalContent>
        <react_1.ModalHeader>
          <react_1.ModalTitle>
            {isSingleUser ? (<macro_1.Trans>Revoke Invite</macro_1.Trans>) : (<macro_1.Trans>Revoke Invites</macro_1.Trans>)}
          </react_1.ModalTitle>
        </react_1.ModalHeader>
        ...
        <react_1.ModalFooter>
          <react_1.HStack>
            ...
            <form_1.ValidatedForm method="post" action={path_1.path.to.revokeInvite} validator={users_1.revokeInviteValidator} onSuccess={onClose} fetcher={fetcher}>
              ...
              <react_1.Button variant="destructive" type="submit">
                <macro_1.Trans>Revoke</macro_1.Trans>
              </react_1.Button>
...
exports.default = RevokeInviteModal;
