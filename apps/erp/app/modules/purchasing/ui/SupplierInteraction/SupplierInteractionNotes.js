...
var SupplierInteractionNotes = function (_a) {
    var id = _a.id, table = _a.table, title = _a.title, isReadOnly = _a.isReadOnly, initialInternalNotes = _a.internalNotes, initialExternalNotes = _a.externalNotes;
      ...
      <react_1.Card>
        <react_1.Tabs value={tab} onValueChange={setTab}>
          <react_1.HStack className="w-full justify-between">
            ...
            <react_1.CardAction>
              {["purchaseOrder"].includes(table) && isEmployee && (<react_1.TabsList>
          ...
          <react_1.CardContent>
            <react_1.TabsContent value="internal">
              {!isReadOnly && permissions.can("update", "sales") ? (<Editor_1.Editor initialValue={(internalNotes !== null && internalNotes !== void 0 ? internalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
            ...
            {["purchaseOrder", "purchaseInvoice"].includes(table) && (<react_1.TabsContent value="external">
                {!isReadOnly && permissions.can("update", "sales") ? (<Editor_1.Editor initialValue={(externalNotes !== null && externalNotes !== void 0 ? externalNotes : {})} onUpload={onUploadImage} onChange={function (value) {
...
exports.default = SupplierInteractionNotes;
