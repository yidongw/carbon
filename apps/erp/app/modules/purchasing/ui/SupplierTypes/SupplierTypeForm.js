...
var SupplierTypeForm = function (_a) {
    ...
    (0, react_2.useEffect)(function () {
        ...
        if (fetcher.state === "loading" && ((_a = fetcher.data) === null || _a === void 0 ? void 0 : _a.data)) {
            ...
            react_1.toast.success("Created supplier type");
        }
        else if (fetcher.state === "idle" && ((_b = fetcher.data) === null || _b === void 0 ? void 0 : _b.error)) {
            react_1.toast.error("Failed to create supplier type: ".concat(fetcher.data.error.message));
        }
    ...
    return (<react_1.ModalDrawerProvider type={type}>
      <react_1.ModalDrawer open={open} onOpenChange={function (open) {
        ...
        <react_1.ModalDrawerContent>
          <form_1.ValidatedForm validator={purchasing_1.supplierTypeValidator} method="post" action={isEditing
            ? path_1.path.to.supplierType(initialValues.id)
            : path_1.path.to.newSupplierType} defaultValues={initialValues} fetcher={fetcher} className="flex flex-col h-full">
            ...
            <react_1.ModalDrawerBody>
              ...
              <react_1.VStack spacing={4}>
                <Form_1.Input name="name" label={t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Supplier Type"], ["Supplier Type"])))}/>
                <Form_1.CustomFormFields table="supplierType"/>
              </react_1.VStack>
            </react_1.ModalDrawerBody>
...
exports.default = SupplierTypeForm;
