...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var ip, ratelimit, success, _c, _d, validation, _e, _f, email, user, magicLink, _g, _h, _j, _k;
        var _l;
        var request = _b.request;
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    ip = (_l = request.headers.get("x-forwarded-for")) !== null && _l !== void 0 ? _l : "127.0.0.1";
                ...
                case 4: return [4 /*yield*/, _f.apply(_e, [_m.sent()])];
                case 5:
                    validation = _m.sent();
                    if (validation.error) {
                ...
                case 6:
                    user = _m.sent();
                    if (!(user.data && user.data.active)) return [3 /*break*/, 10];
                    return [4 /*yield*/, (0, auth_server_1.sendMagicLink)(email)];
                case 7:
                    magicLink = _m.sent();
                    if (!!magicLink) return [3 /*break*/, 9];
                    _g = react_router_1.data;
                    _h = [(0, auth_1.error)(magicLink, "Failed to send magic link")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(magicLink, "Failed to send magic link"))];
                case 8: return [2 /*return*/, _g.apply(void 0, _h.concat([_m.sent()]))];
                case 9: return [3 /*break*/, 12];
                case 10:
                    _j = react_router_1.data;
                    _k = [(0, auth_1.error)(user, "User record not found")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(user.error, "User record not found"))];
                case 11: return [2 /*return*/, _j.apply(void 0, _k.concat([_m.sent()]))];
