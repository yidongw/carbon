...
function getHighlighter() {
    if (!highlighterPromise) {
        highlighterPromise = (0, shiki_1.createHighlighter)({
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    highlighter = _b.sent();
                    return [2 /*return*/, highlighter.codeToHtml(code, {
                            lang: (_a = LANG[key]) !== null && _a !== void 0 ? _a : "bash",
