...
var containerVariants = (0, class_variance_authority_1.cva)("relative flex-shrink-0 overflow-hidden rounded-lg bg-gradient-to-bl from-muted to-muted/40", {
    variants: {
        size: {
            sm: "size-7",
            md: "size-9",
...
var ItemThumbnail = function (_a) {
    var thumbnailPath = _a.thumbnailPath, type = _a.type, _b = _a.size, size = _b === void 0 ? "md" : _b, onClick = _a.onClick;
    var _c = (0, react_2.useState)(1), coverScale = _c[0], setCoverScale = _c[1];
    return thumbnailPath ? (<div className={(0, react_1.cn)(containerVariants({ size: size }), onClick && "cursor-pointer")} onClick={onClick}>
