...
function ShortPickModal(_a) {
    ...
    return (<react_1.Modal open onOpenChange={function (open) { return !open && onClose(); }}>
      <react_1.ModalContent>
        <form_1.ValidatedForm method="post" action={path_1.path.to.pickingLineQuantity(pickingListId)} validator={models_1.pickQuantityValidator} defaultValues={{
          ...
          <react_1.ModalBody>
            ...
            <form_1.NumberControlled name="quantity" label={t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Picked quantity"], ["Picked quantity"])))} value={quantity} onChange={setQuantity} minValue={0} maxValue={quantityToPick} size="lg"/>
          </react_1.ModalBody>
          <react_1.ModalFooter>
            <react_1.Button variant="secondary" size="lg" onClick={onClose}>
              <macro_1.Trans>Cancel</macro_1.Trans>
            </react_1.Button>
            <react_1.Button type="submit" size="lg" isLoading={isSubmitting}>
