...
var Feedback = function () {
    ...
    var uploadImage = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var file, fileExtension, imageUpload;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, carbon.storage
                            .from("feedback")
                            .upload("".concat((0, nanoid_1.nanoid)(), ".").concat(fileExtension), file, {
    ...
    return (<react_1.Popover>
      ...
      <react_1.PopoverContent className="w-[380px] ">
        <form_1.ValidatedForm method="post" action={path_1.path.to.feedback} validator={models_1.feedbackValidator} fetcher={fetcher} onSubmit={function () {
            setFeedback("");
            setAttachment(null);
        }}>
          ...
          <react_1.VStack spacing={4}>
            <react_1.VStack spacing={2}>
              <form_1.TextAreaControlled name="feedback" label="" value={feedback} onChange={function (value) { return setFeedback(value); }} placeholder={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Ideas, suggestions or problems with this page?"], ["Ideas, suggestions or problems with this page?"])))}/>
            ...
            (_a = popoverTriggerRef.current) === null || _a === void 0 ? void 0 : _a.click();
              ...
              <react_1.HStack spacing={1}>
                ...
                <react_1.File accept="image/*" aria-label={t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Attach File"], ["Attach File"])))} className="px-2" isDisabled={!!attachment} variant="secondary" onChange={uploadImage}>
                  <lu_1.LuImage />
                </react_1.File>
                <form_1.Submit isDisabled={feedback.length < 3}>
