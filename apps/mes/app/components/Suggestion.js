...
var Suggestion = function () {
    ...
    var popoverTriggerRef = (0, react_3.useRef)(null);
    var _b = (0, react_3.useState)(""), suggestion = _b[0], setSuggestion = _b[1];
    var _c = (0, react_3.useState)("💡"), emoji = _c[0], setEmoji = _c[1];
    var _d = (0, react_3.useState)(false), emojiPickerOpen = _d[0], setEmojiPickerOpen = _d[1];
    var _e = (0, react_3.useState)(true), anonymous = _e[0], setAnonymous = _e[1];
    var mode = (0, react_1.useMode)();
    var pickerTheme = mode;
    var _f = (0, react_3.useState)(null), attachment = _f[0], setAttachment = _f[1];
    ...
    var uploadImage = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var file, fileExtension, fileName, imageUpload;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    fileName = "".concat(companyId, "/suggestions/").concat((0, nanoid_1.nanoid)(), ".").concat(fileExtension);
    ...
    return (<react_1.Popover>
      <react_1.PopoverTrigger ref={popoverTriggerRef} asChild>
        <react_1.SidebarMenuButton tooltip={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Suggestion"], ["Suggestion"])))}>
          <lu_1.LuMailbox />
          <span>
      ...
      <react_1.PopoverContent className="w-[380px] ">
        <form_1.ValidatedForm method="post" action={path_1.path.to.suggestion} validator={models_1.suggestionValidator} fetcher={fetcher}>
