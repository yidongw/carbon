...
function useUser() {
    ...
    if ((data === null || data === void 0 ? void 0 : data.company) &&
        ...
        isUser(data.user)) {
        return __assign(__assign({}, data.user), { email: (_a = data.user.email) !== null && _a !== void 0 ? _a : "", id: (_b = data.effectiveUserId) !== null && _b !== void 0 ? _b : data.user.id, company: data.company });
    }
