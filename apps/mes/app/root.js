...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, AUTH_PROVIDERS, CARBON_EDITION, CARBON_API_URL, CONTROLLED_ENVIRONMENT, ERP_URL, MES_URL, NODE_ENV, POSTHOG_API_HOST, POSTHOG_PROJECT_PUBLIC_KEY, SUPABASE_URL, SUPABASE_ANON_KEY, VERCEL_ENV, VERCEL_URL, preferences, appLanguage, linguiCatalog;
        var _d;
        var request = _b.request, context = _b.context;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _c = (0, auth_1.getBrowserEnv)(), AUTH_PROVIDERS = _c.AUTH_PROVIDERS, CARBON_EDITION = _c.CARBON_EDITION, CARBON_API_URL = _c.CARBON_API_URL, CONTROLLED_ENVIRONMENT = _c.CONTROLLED_ENVIRONMENT, ERP_URL = _c.ERP_URL, MES_URL = _c.MES_URL, NODE_ENV = _c.NODE_ENV, POSTHOG_API_HOST = _c.POSTHOG_API_HOST, POSTHOG_PROJECT_PUBLIC_KEY = _c.POSTHOG_PROJECT_PUBLIC_KEY, SUPABASE_URL = _c.SUPABASE_URL, SUPABASE_ANON_KEY = _c.SUPABASE_ANON_KEY, VERCEL_ENV = _c.VERCEL_ENV, VERCEL_URL = _c.VERCEL_URL;
