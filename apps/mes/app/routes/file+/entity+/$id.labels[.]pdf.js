...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, _d, companySettings, trackedEntity, url, labelParam, labelSizeId, labelSize, item, items, template, company, logo, stream, body, headers;
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 2:
                    ...
                    if (labelSize.zpl) {
                        throw (0, react_router_1.redirect)(path_1.path.to.file.trackedEntityLabelZpl(id, {
