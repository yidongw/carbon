...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, client, companyId, id, _d, companySettings, trackedEntities, url, labelParam, trackedEntityIdParam, labelSizeId, labelSize, filteredTracking, items, template, company, logo, zplCommands, zplOutput, headers;
        var _e, _f;
            ...
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, operations_service_1.getTrackedEntitiesByMakeMethodId)(client, id)
                        ])];
                case 2:
                    ...
                    if (!labelSize.zpl) {
                        throw (0, react_router_1.redirect)(path_1.path.to.file.operationLabelsPdf(id, {
