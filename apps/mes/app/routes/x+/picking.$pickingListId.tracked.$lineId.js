        ...
        return __generator(this, function (_s) {
            switch (_s.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, inventory_service_1.getAvailableTrackedEntities)(client, {
                            itemId: line.itemId,
                            companyId: companyId,
                ...
                case 5:
                    entities = _d;
                    return [4 /*yield*/, (0, inventory_service_1.getCompanySettings)(client, companyId)];
                case 6:
                    settings = _s.sent();
                    ...
                    return [4 /*yield*/, (0, inventory_service_1.getPickOrder)(client, {
                            itemId: line.itemId,
                            locationId: locationId,
                            companyId: companyId
                        })];
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var userId, effectiveUserId, serviceRole, lineId, formData, trackedEntityId, fromStorageUnitId, quantity, unpick, result;
        var _c, _d, _e, _f;
        var context = _b.context, request = _b.request, params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    effectiveUserId = (_d = (_c = context.get(context_1.userContext)) === null || _c === void 0 ? void 0 : _c.effectiveUserId) !== null && _d !== void 0 ? _d : userId;
                ...
                case 2:
                    ...
                    quantity = Number((_e = formData.get("quantity")) !== null && _e !== void 0 ? _e : 0);
                    unpick = formData.get("unpick") === "true";
                    if (!trackedEntityId) {
                        return [2 /*return*/, { success: false, message: "Missing tracked entity" }];
                    }
                    return [4 /*yield*/, (0, picking_service_1.setPickingListLineTrackedEntity)(serviceRole, {
                    ...
                    if (result.error) {
                        return [2 /*return*/, {
                                ...
                                message: typeof result.error === "string"
                                    ? result.error
                                    : ((_f = result.error.message) !== null && _f !== void 0 ? _f : "Failed to pick line")
                            }];
                    }
