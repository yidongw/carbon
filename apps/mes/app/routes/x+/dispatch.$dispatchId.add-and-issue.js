...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _c, userId, companyId, dispatchId, json, validation, _d, itemId, unitOfMeasureCode, quantity, children, totalQuantity, serviceRole, issue, issue;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    serviceRole = _e.sent();
                    if (!(children && children.length > 0)) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, serviceRole.functions.invoke("issue", {
                        body: {
