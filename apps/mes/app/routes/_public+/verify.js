...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var ip, ratelimit, success, _c, _d, validation, _e, _f, _g, email, code, redirectTo, isCodeValid, _h, _j, existingUser, _k, _l, authSession, _m, _o, sessionCookie;
        var _p;
        var request = _b.request;
        return __generator(this, function (_q) {
            switch (_q.label) {
                case 0:
                    ...
                    ip = (_p = request.headers.get("x-forwarded-for")) !== null && _p !== void 0 ? _p : "127.0.0.1";
                ...
                case 2: return [2 /*return*/, _c.apply(void 0, _d.concat([_q.sent()]))];
                case 3:
                    _f = (_e = (0, form_1.validator)(verifyValidator)).validate;
                    return [4 /*yield*/, request.formData()];
                case 4: return [4 /*yield*/, _f.apply(_e, [_q.sent()])];
                case 5:
                    validation = _q.sent();
                    if (validation.error) {
                ...
                case 7: return [2 /*return*/, _h.apply(void 0, _j.concat([_q.sent()]))];
                case 8: return [4 /*yield*/, (0, users_server_1.getUserByEmail)(email)];
                case 9:
                    existingUser = _q.sent();
                    if (!(!existingUser.data || !existingUser.data.active)) return [3 /*break*/, 11];
                    _k = react_router_1.data;
                    _l = [(0, auth_1.error)(null, "User not found")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "User not found"))];
                case 10: return [2 /*return*/, _k.apply(void 0, _l.concat([_q.sent()]))];
                case 11: return [4 /*yield*/, (0, auth_server_1.signInWithEmailViaAdmin)(email)];
                case 12:
                    authSession = _q.sent();
                    if (!!authSession) return [3 /*break*/, 14];
                    _m = react_router_1.data;
                    _o = [(0, auth_1.error)(null, "Failed to sign in user")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to sign in user"))];
                case 13: return [2 /*return*/, _m.apply(void 0, _o.concat([_q.sent()]))];
                case 14: return [4 /*yield*/, (0, session_server_1.setAuthSession)(request, { authSession: authSession })];
                case 15:
                    sessionCookie = _q.sent();
