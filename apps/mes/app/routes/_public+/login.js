...
function loader(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var hasOutlookAuth, hasGoogleAuth, hasPasskeyAuth, hasPhoneAuth, authSession, cookieHeaders;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    hasPhoneAuth = (0, auth_1.isAuthProviderEnabled)("phone");
                ...
                case 3:
                    ...
                    return [2 /*return*/, (0, react_router_1.data)({
                            ...
                            hasWeChatAuth: (0, auth_1.isAuthProviderEnabled)("wechat"),
...
function action(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var ip, ratelimit, success, _c, _d, formData, validation, _e, email, redirectTo, user, authSession, sessionCookie, magicLink, _f, _g, pkceHeader, verificationSent, _h, _j;
        var _k, _l;
        var request = _b.request;
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    ip = (_k = request.headers.get("x-forwarded-for")) !== null && _k !== void 0 ? _k : "127.0.0.1";
                ...
                case 2: return [2 /*return*/, _c.apply(void 0, _d.concat([_m.sent()]))];
                case 3: return [4 /*yield*/, request.formData()];
                case 4:
                    formData = _m.sent();
                    return [4 /*yield*/, (0, form_1.validator)(auth_1.magicLinkValidator).validate(formData)];
                case 5:
                    validation = _m.sent();
                    if (validation.error) {
                        return [2 /*return*/, (0, auth_1.error)(validation.error, "Invalid email address")];
                    }
                    _e = validation.data, email = _e.email, redirectTo = _e.redirectTo;
                    return [4 /*yield*/, (0, users_server_1.getUserByEmail)(email)];
                case 6:
                    user = _m.sent();
                    if (!((0, auth_1.isBypassEmail)(email) && ((_l = user.data) === null || _l === void 0 ? void 0 : _l.active))) return [3 /*break*/, 9];
                    return [4 /*yield*/, (0, auth_server_1.signInWithBypassEmail)(email)];
                case 7:
                    authSession = _m.sent();
                    if (!authSession) return [3 /*break*/, 9];
                ...
                case 9:
                    if (!(user.data && user.data.active)) return [3 /*break*/, 16];
                    if (!(auth_1.LOGIN_METHOD === "magic-link")) return [3 /*break*/, 14];
                    return [4 /*yield*/, (0, auth_server_1.sendMagicLink)(email, redirectTo)];
                case 10:
                    magicLink = _m.sent();
                    if (!magicLink.error) return [3 /*break*/, 12];
                    _f = react_router_1.data;
                    _g = [(0, auth_1.error)(null, "Failed to send magic link")];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to send magic link"))];
                case 11: return [2 /*return*/, _f.apply(void 0, _g.concat([_m.sent()]))];
                case 12: return [4 /*yield*/, (0, session_server_1.setPkceCookie)(magicLink.pkceEntry)];
                case 13:
                    pkceHeader = _m.sent();
                    return [2 /*return*/, (0, react_router_1.data)({ success: true, mode: "login" }, { headers: [["Set-Cookie", pkceHeader]] })];
                case 14: return [4 /*yield*/, (0, verification_server_1.sendVerificationCode)(email)];
                case 15:
                    verificationSent = _m.sent();
                    if (!verificationSent) {
                ...
                case 16:
                    ...
                    _j = [{ success: false, message: "Invalid email/password combination" }];
                    return [4 /*yield*/, (0, session_server_1.flash)(request, (0, auth_1.error)(null, "Failed to sign in"))];
                case 17: return [2 /*return*/, _h.apply(void 0, _j.concat([_m.sent()]))];
            }
        });
    });
}
function LoginRoute() {
    ...
    var _j = (0, react_router_1.useLoaderData)(), hasOutlookAuth = _j.hasOutlookAuth, hasGoogleAuth = _j.hasGoogleAuth, hasPasskeyAuth = _j.hasPasskeyAuth, hasPhoneAuth = _j.hasPhoneAuth, hasWeChatAuth = _j.hasWeChatAuth, isWeChatBrowser = _j.isWeChatBrowser;
    var showWeChatButton = isWeChatBrowser && hasWeChatAuth;
    ...
    var _k = (0, react_2.useState)("login"), mode = _k[0], setMode = _k[1];
    var _l = (0, react_2.useState)(""), verifyEmail = _l[0], setVerifyEmail = _l[1];
    ...
    (0, react_2.useEffect)(function () {
        ...
        if (((_a = phoneFetcher.data) === null || _a === void 0 ? void 0 : _a.success) && phoneFetcher.data.phone) {
            var qs = redirectTo
                ? "&redirectTo=".concat(encodeURIComponent(redirectTo))
                : "";
            window.location.href = "/verify-phone?phone=".concat(encodeURIComponent(phoneFetcher.data.phone)).concat(qs);
        }
    }, [phoneFetcher.data, redirectTo]);
    (0, react_2.useEffect)(function () {
        var _a;
        if (((_a = fetcher.data) === null || _a === void 0 ? void 0 : _a.success) && fetcher.data.mode === "verify") {
            var email = fetcher.data.email;
            if (email) {
                setMode("verify");
                ...
                var qs = redirectTo
                    ? "&redirectTo=".concat(encodeURIComponent(redirectTo))
                    : "";
                window.location.href = "/verify?email=".concat(encodeURIComponent(email)).concat(qs);
            }
        }
    }, [fetcher.data, redirectTo]);
    var _o = (0, react_2.useState)(false), passkeySupported = _o[0], setPasskeySupported = _o[1];
    var _p = (0, react_2.useState)(false), passkeyLoading = _p[0], setPasskeyLoading = _p[1];
    ...
    var onSignInWithWeChat = function () {
        window.location.href = "/auth/wechat".concat(redirectTo ? "?redirectTo=".concat(encodeURIComponent(redirectTo)) : "");
    };
    return (<>
      <div className="flex justify-center mb-8">
        <img src={auth_1.CONTROLLED_ENVIRONMENT ? "/flag.png" : "/carbon-mark-light.svg"} alt={t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Carbon Logo"], ["Carbon Logo"])))} className="w-24 dark:hidden"/>
        <img src={auth_1.CONTROLLED_ENVIRONMENT ? "/flag.png" : "/carbon-mark-dark.svg"} alt={t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Carbon Logo"], ["Carbon Logo"])))} className="w-24 hidden dark:block"/>
      </div>
      <div className="rounded-lg md:bg-card md:border md:border-border md:shadow-lg p-8 w-[380px]">
        {((_b = fetcher.data) === null || _b === void 0 ? void 0 : _b.success) === true && ((_c = fetcher.data) === null || _c === void 0 ? void 0 : _c.mode) === "login" ? (<>
            ...
            <p className="text-muted-foreground tracking-tight text-sm text-center">
              <macro_1.Trans>We've sent a verification code to {verifyEmail}</macro_1.Trans>
            </p>
            ...
            {showWeChatButton && (<react_1.Button type="button" size="lg" className="w-full" onClick={onSignInWithWeChat} isDisabled={fetcher.state !== "idle" || passkeyLoading} variant="secondary" leftIcon={<si_1.SiWechat className="w-4 h-4" style={{ color: "#07C160" }}/>}>
                <macro_1.Trans>Continue with WeChat</macro_1.Trans>
              </react_1.Button>)}
            ...
            {(hasGoogleAuth ||
                hasOutlookAuth ||
                showWeChatButton ||
                (hasPasskeyAuth && passkeySupported)) && (<div className="py-3 w-full">
                <react_1.Separator />
              </div>)}

            {hasPhoneAuth && (<div className="flex w-full items-center gap-1 rounded-xl bg-muted p-1">
                {[
                    { key: "phone", label: <macro_1.Trans>Phone</macro_1.Trans> },
                    { key: "email", label: <macro_1.Trans>Email</macro_1.Trans> }
                ].map(function (tab) { return (<button key={tab.key} type="button" disabled={fetcher.state !== "idle" ||
            ...
            {loginMethod === "phone" && hasPhoneAuth ? (<form_1.ValidatedForm fetcher={phoneFetcher} validator={auth_1.phoneLoginValidator} defaultValues={{ redirectTo: redirectTo }} method="post" action="/api/send-phone-code" className="w-full">
                ...
                <react_1.VStack spacing={2}>
                  ...
                  <form_1.Input name="phone" label="" prefix="+86" placeholder={t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Phone Number"], ["Phone Number"])))}/>

                  <form_1.Submit isDisabled={phoneFetcher.state !== "idle"} isLoading={phoneFetcher.state === "submitting"} size="lg" className="w-full" withBlocker={false} variant="secondary">
                    <macro_1.Trans>Sign in with Phone</macro_1.Trans>
                  </form_1.Submit>
                </react_1.VStack>
              </form_1.ValidatedForm>) : (<form_1.ValidatedForm fetcher={fetcher} validator={auth_1.magicLinkValidator} defaultValues={{ redirectTo: redirectTo }} method="post" className="w-full">
                <form_1.Hidden name="redirectTo" value={redirectTo} type="hidden"/>
                <react_1.VStack spacing={2}>
                  {((_f = fetcher.data) === null || _f === void 0 ? void 0 : _f.success) === false && ((_g = fetcher.data) === null || _g === void 0 ? void 0 : _g.message) && (<react_1.Alert variant="destructive">
                      <lu_1.LuCircleAlert className="w-4 h-4"/>
                      <react_1.AlertTitle>
                        <macro_1.Trans>Authentication Error</macro_1.Trans>
                      </react_1.AlertTitle>
                      <react_1.AlertDescription>
                        {(_h = fetcher.data) === null || _h === void 0 ? void 0 : _h.message}
                      </react_1.AlertDescription>
                    </react_1.Alert>)}

                  <form_1.Input name="email" label="" placeholder={t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Email Address"], ["Email Address"])))} autoComplete={hasPasskeyAuth ? "email webauthn" : "email"}/>

                  <form_1.Submit isDisabled={fetcher.state !== "idle"} isLoading={fetcher.state === "submitting"} size="lg" className="w-full" withBlocker={false} variant="secondary">
