...
var TextAreaControlled = (0, react_2.forwardRef)(function (_a, ref) {
    var _b;
    var name = _a.name, label = _a.label, characterLimit = _a.characterLimit, isOptional = _a.isOptional, isRequired = _a.isRequired, isDisabledProp = _a.isDisabled, helperText = _a.helperText, value = _a.value, className = _a.className, onChange = _a.onChange, rest = __rest(_a, ["name", "label", "characterLimit", "isOptional", "isRequired", "isDisabled", "helperText", "value", "className", "onChange"]);
    ...
    var characterCount = (_b = controlValue === null || controlValue === void 0 ? void 0 : controlValue.length) !== null && _b !== void 0 ? _b : 0;
    ...
    return (<react_1.FormControl isInvalid={!!error} isRequired={isRequired} className={className}>
        {label && (<react_1.FormLabel htmlFor={name} isOptional={resolvedIsOptional}>
            {label}
          </react_1.FormLabel>)}
        <react_1.Textarea ref={ref} {...getInputProps(__assign({ id: name }, rest))} value={controlValue} onChange={handleChange} maxLength={characterLimit} disabled={disabled} readOnly={readOnly}/>
