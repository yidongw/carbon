...
var Number = (0, react_2.forwardRef)(function (_a, ref) {
    var name = _a.name, label = _a.label, size = _a.size, isConfigured = _a.isConfigured, isOptional = _a.isOptional, isRequired = _a.isRequired, isReadOnlyProp = _a.isReadOnly, isDisabledProp = _a.isDisabled, helperText = _a.helperText, value = _a.value, onChange = _a.onChange, onConfigure = _a.onConfigure, adornment = _a.adornment, _b = _a.inline, inline = _b === void 0 ? false : _b, onBlur = _a.onBlur, rest = __rest(_a, ["name", "label", "size", "isConfigured", "isOptional", "isRequired", "isReadOnly", "isDisabled", "helperText", "value", "onChange", "onConfigure", "adornment", "inline", "onBlur"]);
    ...
    var _e = (0, react_2.useState)(inline), inlineMode = _e[0], setInlineMode = _e[1];
    ...
    return inlineMode ? (<react_1.VStack>
        ...
        <react_1.HStack spacing={0} className="w-full justify-between">
          {value !== undefined && (<span className="flex flex-grow line-clamp-1 items-center">
              {value}
            </span>)}
          <react_1.IconButton icon={value !== undefined && !isNaN(value) ? (<lu_1.LuSettings2 />) : (<lu_1.LuPlus />)} aria-label={value !== undefined && !isNaN(value) ? "Edit" : "Add"} size="sm" variant="secondary" isDisabled={isReadOnly || isDisabled} onClick={function () { return setInlineMode(false); }}/>
        </react_1.HStack>
      </react_1.VStack>) : (<react_1.FormControl isInvalid={!!error} isRequired={isRequired} isDisabled={isDisabled} isReadOnly={isReadOnly}>
        {label && (<react_1.FormLabel htmlFor={name} isOptional={resolvedIsOptional} isConfigured={isConfigured} onConfigure={onConfigure}>
            {label}
          </react_1.FormLabel>)}
        <react_1.NumberField {...getInputProps(__assign({ id: name }, rest))} value={controlValue} onChange={handleChange} isDisabled={isDisabled} onBlur={function (e) { return __awaiter(void 0, void 0, void 0, function () {
            var result;
          ...
          <react_1.NumberInputGroup className="relative">
            <react_1.NumberInput isReadOnly={isReadOnly} isDisabled={isDisabled} size={size} className={adornment
            ? (0, react_1.cn)("pr-10", isDisabled &&
                "text-foreground disabled:opacity-100 disabled:text-foreground")
            : undefined}/>
            {!isReadOnly &&
            (adornment !== null && adornment !== void 0 ? adornment : (<react_1.NumberInputStepper>
