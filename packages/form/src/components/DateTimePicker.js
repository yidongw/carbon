...
var DateTimePicker = function (_a) {
    var name = _a.name, label = _a.label, size = _a.size, _b = _a.isDisabled, isDisabledProp = _b === void 0 ? false : _b, minValue = _a.minValue, maxValue = _a.maxValue, _c = _a.inline, inline = _c === void 0 ? false : _c, helperText = _a.helperText, onChange = _a.onChange;
    ...
    var _e = (0, react_2.useState)(defaultValue
        ? (0, date_1.toCalendarDateTime)((0, date_1.parseAbsolute)(defaultValue, (0, date_1.getLocalTimeZone)()))
            ...
            switch (_a.label) {
                case 0:
                    (0, react_dom_1.flushSync)(function () {
                        setDate((0, date_1.toCalendarDateTime)(newDate));
                    });
                ...
                case 1:
                    ...
                    if (result.error) {
                        ...
                        onChange === null || onChange === void 0 ? void 0 : onChange((0, date_1.toCalendarDateTime)(newDate));
                    }
                    return [3 /*break*/, 3];
                case 2:
                    validateField();
    ...
    var utcValue = date
        ? (0, date_1.toZoned)(date, (0, date_1.getLocalTimeZone)()).toAbsoluteString()
        : "";
    var DateTimePickerPreview = (<span className="flex flex-grow line-clamp-1 items-center">
      {(0, utils_1.formatDateTime)(utcValue, locale)}
    </span>);
    return (<react_1.FormControl isInvalid={!!error}>
      ...
      <react_1.DateTimePicker value={date} onChange={handleChange} isDisabled={isDisabled} size={size} minValue={minValue} maxValue={maxValue} inline={inline ? DateTimePickerPreview : undefined} helperText={helperText}/>
