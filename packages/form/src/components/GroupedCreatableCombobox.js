...
var GroupedCreatableCombobox = (0, react_2.forwardRef)(function (_a, ref) {
    ...
    var flatOptions = props.groups.flatMap(function (group) { return group.options; });
    ...
    (0, react_2.useEffect)(function () {
        if (autoSelectSingleOption && flatOptions.length === 1 && !value) {
    ...
    var onChange = function (nextValue) {
        var _a, _b, _c;
        if (nextValue) {
            (_a = props === null || props === void 0 ? void 0 : props.onChange) === null || _a === void 0 ? void 0 : _a.call(props, (_b = flatOptions.find(function (o) { return o.value === nextValue; })) !== null && _b !== void 0 ? _b : null);
        }
        else {
    ...
    return (<react_1.FormControl isInvalid={!!error} isRequired={isRequired}>
        ...
        <react_1.GroupedCreatableCombobox ref={ref} {...props} value={value === null || value === void 0 ? void 0 : value.replace(/"/g, '\\"')} isClearable={isClearable !== null && isClearable !== void 0 ? isClearable : (resolvedIsOptional && !isReadOnly)} isReadOnly={isReadOnly} className="w-full" onChange={function (newValue) {
            var _a;
...
exports.default = GroupedCreatableCombobox;
