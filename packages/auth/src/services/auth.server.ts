...
export async function seedBypassUser(email: string): Promise<void> {
  ...
  const sampleItems = [
    ...
    { readableId: "CABLE-PWR-01", name: "Power Cable 18AWG", description: "Stranded copper power cable", type: "Part", replenishmentSystem: "Buy", itemTrackingType: "Inventory", uom: "FOOT" },
    ...
    { readableId: "CUTTING-FLUID", name: "CNC Cutting Fluid", description: "Water-soluble cutting fluid", type: "Consumable", replenishmentSystem: "Buy", itemTrackingType: "Inventory", uom: "GL" },
