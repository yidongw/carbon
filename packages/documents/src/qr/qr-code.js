...
function generateQRCode(text, size, color) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_1.default.toBuffer(__assign({ bcid: "qrcode", text: text, scale: 2, height: size, width: size }, (color && { barcolor: color })))];
                case 1:
                    buffer = _a.sent();
...
function generateQRCodeBuffer(text, size, color) {
    return __awaiter(this, void 0, void 0, function () {
        var buffer;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function generateQRCodeSync(text, size) {
    ...
    throw new Error("Synchronous QR code generation not supported. Use async version or inline implementation.");
}
