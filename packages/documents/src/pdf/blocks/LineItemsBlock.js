...
function LineItemsBlock(_a) {
    ...
    var tw = (0, tw_1.useTw)();
    var salesInvoiceLines = data.salesInvoiceLines, thumbnails = data.thumbnails, numberFormatter = data.numberFormatter, theme = data.theme;
    ...
    return (<renderer_1.View>
      ...
      {salesInvoiceLines.map(function (line) {
            ...
            var lineTaxAmount = (0, sales_invoice_1.getLineTaxableSubtotal)(line) * lineTaxPercent;
            ...
            <renderer_1.View wrap={false} style={[
              ...
              <renderer_1.View style={tw("w-1/2 pr-2")}>
                ...
                <renderer_1.Text style={__assign(__assign({}, tw("text-[9px] text-gray-600 mt-0.5")), overflow)}>
                  {(0, sales_invoice_1.getLineDescriptionDetails)(line)}
                </renderer_1.Text>
                {opts.showThumbnails &&
                    thumbnails &&
                    line.id &&
                ...
                {line.invoiceLineType !== "Comment" && totalTaxAndFees > 0 && (<renderer_1.View style={tw("mt-1")}>
              ...
              <renderer_1.Text style={tw("w-1/6 text-center text-gray-600")}>
                {line.invoiceLineType === "Comment"
                    ? ""
                    : "".concat(line.quantity, " ").concat((_e = line.unitOfMeasureCode) !== null && _e !== void 0 ? _e : "EA")}
              </renderer_1.Text>
              <renderer_1.Text style={tw("w-1/6 text-center text-gray-600")}>
                {line.invoiceLineType === "Comment"
                    ? ""
              ...
              <renderer_1.Text style={tw("w-1/6 text-center text-gray-800 font-medium")}>
                {line.invoiceLineType === "Comment"
                    ? ""
                    : numberFormatter.format((0, sales_invoice_1.getLineTotal)(line))}
              </renderer_1.Text>
            </renderer_1.View>
