...
function SummaryBlock(_a) {
    ...
    var tw = (0, tw_1.useTw)();
    var salesOrderLines = data.salesOrderLines, salesOrder = data.salesOrder, currencyCode = data.currencyCode, numberFormatter = data.numberFormatter;
    ...
    return (<renderer_1.View style={tw("mb-4")}>
      <renderer_1.View style={[
        ...
        <renderer_1.Text style={tw("w-1/6 text-center text-gray-800")}>
          {numberFormatter.format(salesOrderLines.reduce(function (sum, line) { var _a, _b; return sum + ((_a = line.saleQuantity) !== null && _a !== void 0 ? _a : 0) * ((_b = line.convertedUnitPrice) !== null && _b !== void 0 ? _b : 0); }, 0))}
        </renderer_1.Text>
      </renderer_1.View>

      {salesOrderLines.some(function (line) {
            var _a, _b;
          ...
          <renderer_1.Text style={tw("w-1/6 text-center text-gray-800")}>
            {numberFormatter.format(salesOrderLines.reduce(function (sum, line) {
                var _a, _b;
                return sum +
      ...
      {(function () {
            var _a, _b;
            var lineShipping = salesOrderLines.reduce(function (sum, line) { var _a; return sum + ((_a = line.convertedShippingCost) !== null && _a !== void 0 ? _a : 0); }, 0);
            var orderShipping = ((_a = salesOrder.shippingCost) !== null && _a !== void 0 ? _a : 0) * ((_b = salesOrder.exchangeRate) !== null && _b !== void 0 ? _b : 1);
            var totalShipping = lineShipping + orderShipping;
      ...
      {salesOrderLines.some(function (line) { var _a; return ((_a = line.taxPercent) !== null && _a !== void 0 ? _a : 0) > 0; }) && (<renderer_1.View style={[
                tw("flex flex-row py-1.5 px-3 text-[9px]"),
                { backgroundColor: "rgba(249, 250, 251, 0.6)" }
            ]}>
          <renderer_1.Text style={tw("w-5/6 text-right pr-3 text-gray-600")}>
          ...
          <renderer_1.Text style={tw("w-1/6 text-center text-gray-800")}>
            {numberFormatter.format(salesOrderLines.reduce(function (sum, line) {
                ...
                return sum + (0, sales_order_1.getLineTaxableSubtotal)(line) * taxPercent;
            }, 0))}
          </renderer_1.Text>
        </renderer_1.View>)}
      ...
      <renderer_1.View style={tw("flex flex-row py-2 px-3 text-[9px]")}>
        ...
        <renderer_1.Text style={tw("w-1/6 text-center text-gray-800 font-bold")}>
          {numberFormatter.format((0, sales_order_1.getTotal)(salesOrderLines, salesOrder))}
        </renderer_1.Text>
      </renderer_1.View>
    </renderer_1.View>);
}
