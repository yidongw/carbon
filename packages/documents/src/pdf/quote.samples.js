...
exports.SAMPLE_QUOTE = {
    ...
    quoteLines: [
        ...
        },
        {
            ...
            id: "line-3",
            status: "Active",
            itemReadableId: "ASSEMBLY-HOUSING-ANODIZED-LONG-PART-NUMBER-FOR-OVERFLOW-0001",
            description: "Fully machined precision aluminium housing assembly with anodized finish, integrated mounting flange, and laser-etched serial marking — used to verify line-item text wrap versus truncate behaviour",
            quantity: [2],
            unitPricePrecision: 2,
            taxPercent: 0.06,
            additionalCharges: {},
