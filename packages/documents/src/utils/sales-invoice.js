...
function getLineDescription(line) {
    var _a, _b;
    switch (line === null || line === void 0 ? void 0 : line.invoiceLineType) {
        case "Fixed Asset":
...
function getLineDescriptionDetails(line) {
    ...
    switch (line === null || line === void 0 ? void 0 : line.invoiceLineType) {
        ...
        case "Comment":
        default:
            return (_a = line === null || line === void 0 ? void 0 : line.description) !== null && _a !== void 0 ? _a : "";
    }
}
function getLineSubtotal(line) {
    var _a, _b, _c;
    if ((line === null || line === void 0 ? void 0 : line.quantity) && (line === null || line === void 0 ? void 0 : line.convertedUnitPrice)) {
        return (line.quantity * line.convertedUnitPrice +
...
function getTotal(lines, salesInvoice, salesInvoiceShipment) {
    var _a, _b;
    var total = 0;
    ...
    return (total +
        ((_a = salesInvoiceShipment.shippingCost) !== null && _a !== void 0 ? _a : 0) * ((_b = salesInvoice.exchangeRate) !== null && _b !== void 0 ? _b : 1));
}
