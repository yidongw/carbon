...
import StorageRuleViolationModal from "./violation-modal";
 ...
 */
export type StorageRuleViolationPayload = {
...
type UseStorageRuleViolationsOptions = {
...
type UseStorageRuleViolationsResult<T> = {
 ...
 */
export function useStorageRuleViolations<T = unknown>({
  action,
  onSuccess
}: UseStorageRuleViolationsOptions): UseStorageRuleViolationsResult<T> {
  ...
  const [staged, setStaged] = useState<StorageRuleViolationPayload | undefined>(
    undefined
  );
  ...
  const data = fetcher.data as StorageRuleViolationPayload | undefined;
