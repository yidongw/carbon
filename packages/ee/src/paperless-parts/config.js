...
exports.PaperlessParts = void 0;
var react_1 = require("@carbon/react");
var utils_1 = require("@carbon/utils");
var zod_1 = require("zod");
var zod_form_data_1 = require("zod-form-data");
var fns_1 = require("../fns");
exports.PaperlessParts = (0, fns_1.defineIntegration)({
    name: "Paperless Parts",
    id: "paperless-parts",
    active: true,
    category: "Estimating & Quoting",
    logo: Logo,
    description: "Paperless Parts is an estimating and quoting platform that uses advanced geometric interrogation to generate accurate estimates for sheet metal fabrication, CNC machining, and more. This integration will sync data from Paperless Parts to Carbon.",
    ...
    schema: zod_1.z.object({
        ...
        methodType: zod_1.z.enum(["Purchase to Order", "Pull from Inventory"]),
        trackingType: zod_1.z.enum(["Inventory", "Non-Inventory", "Batch"]),
        billOfProcessBlackList: zod_1.z.array(zod_1.z.string()).optional(),
        usePaperlessOrderNumber: zod_form_data_1.zfd.checkbox()
    })
});
function SetupInstructions(_a) {
    var companyId = _a.companyId;
    var webhookUrl = utils_1.isBrowser
        ? "".concat(window.location.origin, "/api/webhook/paperless-parts/").concat(companyId)
        : "";
    return (<>
    ...
    return (<svg {...props} xmlns="http://www.w3.org/2000/svg" width="558.86" height="74.71" viewBox="0 0 558.86 74.71" fill="none" className={(0, react_1.cn)("text-foreground", props.className)}>
      <g xmlns="http://www.w3.org/2000/svg">
        <g>
          ...
          <path fill="currentColor" d="M343.62,52.86l-3.76-9.23H322.47l-3.76,9.23h-9.23l17.63-41.43h8.35l17.62,41.43ZM331.17,22.3,325.7,35.64h10.93Z"/>
          <path fill="currentColor" d="M383.46,52.86l-8.81-13.17h-7.11V52.86h-9.05V11.72h18.8q7.35,0,11.43,3.59t4.08,10v.11a12.92,12.92,0,0,1-2.43,8.14A14.18,14.18,0,0,1,384,38.17L394,52.86Zm.18-27.09a5.26,5.26,0,0,0-1.88-4.41,8.32,8.32,0,0,0-5.23-1.47h-9V31.7h9.16a7.57,7.57,0,0,0,5.15-1.58,5.4,5.4,0,0,0,1.79-4.24Z"/>
          <path fill="currentColor" d="M419.3,20.07V52.86h-9.05V20.07H397.74V11.72h34.08v8.35Z"/>
          <path fill="currentColor" d="M466.44,46.13a11.07,11.07,0,0,1-3.1,4,13.87,13.87,0,0,1-4.74,2.47,20.44,20.44,0,0,1-6.1.85,27.37,27.37,0,0,1-9.22-1.61,24.52,24.52,0,0,1-8.23-5l5.35-6.4a26.67,26.67,0,0,0,5.79,3.64,15.45,15.45,0,0,0,6.49,1.35,7.88,7.88,0,0,0,4.38-1,3.24,3.24,0,0,0,1.55-2.85v-.11a3.65,3.65,0,0,0-.32-1.56,3.28,3.28,0,0,0-1.24-1.26,12.39,12.39,0,0,0-2.53-1.18c-1.08-.39-2.49-.8-4.21-1.23a50.49,50.49,0,0,1-5.66-1.71,15.78,15.78,0,0,1-4.3-2.32,9.33,9.33,0,0,1-2.74-3.44,11.88,11.88,0,0,1-1-5.11v-.12a11.93,11.93,0,0,1,1.05-5.08,11.52,11.52,0,0,1,2.95-3.91A13.29,13.29,0,0,1,445.17,12a18.1,18.1,0,0,1,5.8-.88,24.65,24.65,0,0,1,8.32,1.35,23.83,23.83,0,0,1,7,3.88l-4.7,6.81a30.39,30.39,0,0,0-5.4-3,13.94,13.94,0,0,0-5.29-1.08,6.36,6.36,0,0,0-4,1,3.1,3.1,0,0,0-1.32,2.55v.12a3.74,3.74,0,0,0,.38,1.73,3.49,3.49,0,0,0,1.39,1.32A12.29,12.29,0,0,0,450.08,27c1.15.35,2.62.77,4.39,1.24A40.2,40.2,0,0,1,460,30.09a15.42,15.42,0,0,1,4.13,2.46,9.43,9.43,0,0,1,2.53,3.38,11.48,11.48,0,0,1,.85,4.64v.12A12.89,12.89,0,0,1,466.44,46.13Z"/>
        </g>
      </g>
    </svg>);
}
