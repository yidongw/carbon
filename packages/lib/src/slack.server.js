...
var SlackClient = /** @class */ (function () {
    ...
    SlackClient.prototype.sendMessage = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var appUrl, error_1;
            var channel = _b.channel, text = _b.text, blocks = _b.blocks;
...
function getSlackClient(token) {
    var _a, _b;
    return new SlackClient((_b = (_a = token !== null && token !== void 0 ? token : process.env.SLACK_BOT_TOKEN) !== null && _a !== void 0 ? _a : env_1.SLACK_BOT_TOKEN) !== null && _b !== void 0 ? _b : "");
}
