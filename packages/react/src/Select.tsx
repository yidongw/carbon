...
const selectTriggerVariants = cva(
  "bg-transparent text-foreground flex w-full items-center justify-between whitespace-nowrap rounded-md border border-input ring-offset-background data-[placeholder]:text-muted-foreground ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
  {
    variants: {
      size: {
...
>(({ className, children, position = "popper", onCloseAutoFocus, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      onCloseAutoFocus={preventOverlayCloseAutoFocus(onCloseAutoFocus)}
      className={cn(
