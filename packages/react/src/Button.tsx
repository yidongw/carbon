  ...
  ],
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-background hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 dark:hover:text-accent-foreground shadow-button-base",
        solid:
