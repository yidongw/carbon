  ...
  ],
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-background text-foreground hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:text-muted-foreground dark:border-input dark:hover:bg-input/50 dark:hover:text-foreground shadow-button-base",
        solid:
