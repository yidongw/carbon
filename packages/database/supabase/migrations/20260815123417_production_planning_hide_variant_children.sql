-- Hide variant child SKUs from production planning. Family demand/supply/on-hand
-- already rolls up to the Style/attribute parent; Make is on the parent mix grid.
