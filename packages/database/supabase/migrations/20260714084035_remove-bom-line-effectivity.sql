-- =====================================================================
-- Remove BOM-line effectivity (methodMaterial.effectiveFrom / effectiveTo)
-- =====================================================================
-- Reverts the BOM line-item effectivity feature added in
-- 20260618171234_material-supersession.sql: the "valid from / valid to" date
-- window on bill-of-materials lines is removed entirely. Item supersession
-- (successorEffectivityDate on itemSupersession) is a separate mechanism and is
-- NOT touched here.
--
-- get_method_tree is recreated first (verbatim minus the two effectivity
-- columns) so the function never references the dropped columns.
...
-- Drop the effectivity columns and their range check.
ALTER TABLE "methodMaterial"
  DROP CONSTRAINT IF EXISTS "methodMaterial_effective_range_check";
