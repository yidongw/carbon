...
exports.companySeedData = exports.groups = exports.defaultLocation = exports.fiscalYearSettings = exports.fixedAssetClasses = exports.accountDefaults = exports.accounts = exports.currencies = exports.sequences = exports.nonConformanceRequiredActions = exports.nonConformanceTypes = exports.failureModes = exports.gaugeTypes = exports.unitOfMeasures = exports.paymentTerms = exports.scrapReasons = exports.customerStatuses = exports.supplierStatuses = exports.dimensions = void 0;
exports.getGroupId = getGroupId;
exports.defaultApprovalRules = defaultApprovalRules;
exports.dimensions = [
...
exports.supplierStatuses = [
    "Active",
    "Inactive",
    "Pending",
    "Rejected"
];
exports.customerStatuses = [
    "Active",
    "Inactive",
    "Lead",
    "On Hold",
...
exports.scrapReasons = ["Defective", "Damaged", "Quality"];
...
exports.nonConformanceRequiredActions = [
    { name: "Corrective Action", systemType: "Corrective", createdBy: "system" },
    { name: "Preventive Action", systemType: "Preventive", createdBy: "system" },
    { name: "Containment Action", systemType: "Containment", createdBy: "system" },
    { name: "Verification", systemType: "Verification", createdBy: "system" },
    { name: "Customer Communication", systemType: "Communication", createdBy: "system" },
 ...
 */
function getGroupId(idPrefix, companyId) {
    var companyIdPart = "".concat(companyId.substring(0, 4), "-").concat(companyId.substring(4, 8), "-").concat(companyId.substring(8, 20));
    return "".concat(idPrefix, "-").concat(companyIdPart);
}
/** Default approval rules for new companies — Admin employee-type group can approve all types. */
function defaultApprovalRules(companyId, adminEmployeeTypeId, createdBy) {
    var types = [
        "purchaseOrder",
        "qualityDocument",
        "supplier",
    ...
    return types.map(function (documentType) { return ({
 ...
 */
exports.companySeedData = {
    dimensions: exports.dimensions,
    customerStatuses: exports.customerStatuses,
    scrapReasons: exports.scrapReasons,
    paymentTerms: exports.paymentTerms,
    unitOfMeasures: exports.unitOfMeasures,
    gaugeTypes: exports.gaugeTypes,
    failureModes: exports.failureModes,
    nonConformanceTypes: exports.nonConformanceTypes,
    nonConformanceRequiredActions: exports.nonConformanceRequiredActions,
    sequences: exports.sequences,
    currencies: exports.currencies,
    accounts: exports.accounts,
    accountDefaults: exports.accountDefaults,
    fiscalYearSettings: exports.fiscalYearSettings,
