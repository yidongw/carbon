...
function getSupplierPayment(db, supplierId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db
...
function getSupplierShipping(db, supplierId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db
...
function insertSupplierInteraction(db, companyId, supplierId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db
                        .insertInto("supplierInteraction")
                        .values({ companyId: companyId, supplierId: supplierId })
                        .returning(["id"])
                        .executeTakeFirst()];
                case 1: return [2 /*return*/, _a.sent()];
            }
...
function deletePurchaseOrder(db, purchaseOrderId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db
...
function deletePurchaseOrderLine(db, purchaseOrderLineId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db
