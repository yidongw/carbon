...
exports.getNextRevisionSequence = getNextRevisionSequence;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    derivedPrefix = (0, utils_ts_1.interpolateSequenceDate)(prefix);
                    derivedSuffix = (0, utils_ts_1.interpolateSequenceDate)(suffix);
                    return [4 /*yield*/, trx
...
function getNextRevisionSequence(trx, tableName, sequenceColumn, sequenceValue, companyId) {
    return __awaiter(this, void 0, void 0, function () {
        var relatedSequences;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, trx
                        ...
                        .execute()];
                case 1:
                    relatedSequences = _b.sent();
                    if (relatedSequences.length === 0 || !("revisionId" in relatedSequences[0])) {
                        return [2 /*return*/, 1];
                    }
                    return [2 /*return*/, ((_a = relatedSequences[0].revisionId) !== null && _a !== void 0 ? _a : 0) + 1];
            }
        });
    });
}
