...
export type WorkCenterDef = {
  key: string;
  name: string;
  description: string;
  laborRate: number;
  machineRate: number;
  processes: string[]; // stable process keys
};
...
export type SupplierDef = {
  ...
  name: string;
  readableId: string;
  typeKey: string; // always English — matches supplier type name
  contact: {
    firstName: string;
    lastName: string;
    email: string;
...
export type SeedLocale = {
  ...
  shippingMethods: Array<{ name: string; carrier: string }>;
  processes: ProcessDef[];
  workCenters: WorkCenterDef[];
  items: ItemDef[];
  postingGroups: Array<{ name: string; description: string }>;
  abilities: string[];
  shifts: ShiftDef[];
  ...
  garmentOps: {
    tshirtCutDesc: string;
    tshirtSewDesc: string;
    tshirtPressDesc: string;
    tshirtQiDesc: string;
    jacketCutDesc: string;
    jacketSewDesc: string;
    jacketHardwareDesc: string;
    jacketQiDesc: string;
  };
  mesItems: Array<{ readableId: string; name: string; description: string }>;
};
...
export function getSeedLocale(language: string | undefined): SeedLocale {
