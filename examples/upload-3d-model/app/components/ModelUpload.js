...
var ModelUpload = function (_a) {
    ...
    var _b = (0, react_dropzone_1.useDropzone)({
        ...
        onDropAccepted: function (acceptedFiles) {
            ...
            var fileSizeLimit = fileSizeLimitMb * 1024 * 1024;
            ...
            if (file.size > fileSizeLimit) {
                react_1.toast.error("File size too big (max. ".concat(fileSizeLimitMb, " MB)"));
                return;
            }
            onFileChange(file);
        },
        onDropRejected: function (fileRejections) {
            ...
            if (errors[0].code === "file-too-large") {
                message = "File size too big (max. ".concat(fileSizeLimitMb, " MB)");
            }
