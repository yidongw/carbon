...
description: How a released Revision or New Part phases over, the cutover fields you tune per item, and how MRP and Get Method honor supersession downstream.
---

For every **Revision** and **New Part** affected item, release auto-writes a <Term>supersession</Term> from
...
<Cards>
  ...
  <Card title="Change types" href="/docs/reference/change-orders/change-types">
    Which change types write a supersession, and which don't.
  </Card>
</Cards>
