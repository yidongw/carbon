...
var supabaseAdmin = (0, supabase_js_1.createClient)(process.env.PROD_SUPABASE_URL, process.env.PROD_SUPABASE_SERVICE_ROLE_KEY, {
    auth: {
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var users, userIds, commaSeparatedIds, fs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                commaSeparatedIds = userIds.join(", ");
